...
using Manager.IntegrationTest.ConsoleHost.Properties;
using Manager.IntegrationTest.ConsoleHost.Tasks;
using Microsoft.Owin.Hosting;
using Owin;
using Configuration = Manager.IntegrationTest.ConsoleHost.Models.Configuration;
