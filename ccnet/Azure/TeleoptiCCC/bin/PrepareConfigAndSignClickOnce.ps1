...
Try
{
	...
	Add-Content "$fullPathsettingsFile" "`$(TOGGLE_FILE)|bin/FeatureFlags/released.toggles.txt"
	Add-Content "$fullPathsettingsFile" "`$(TOGGLE_URL)|https://$DataSourceName.teleopticloud.com/Web/ToggleHandler/IsEnabled"
    Add-Content "$fullPathsettingsFile" "`$(WindowsClaimProvider)|"
    Add-Content "$fullPathsettingsFile" "`$(TeleoptiClaimProvider)|<add identifier=`"urn:Teleopti`" displayName=`"Teleopti application`" url=`"https://$DataSourceName.teleopticloud.com/Web/sso/`" protocolHandler=`"OpenIdHandler`" />"
