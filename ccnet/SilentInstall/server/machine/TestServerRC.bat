...
SET DB_ANALYTICS=%COMPUTERNAME%_TeleoptiWFMAnalytics
SET DB_CCC7=%COMPUTERNAME%_TeleoptiWFM
SET DB_CCCAGG=%COMPUTERNAME%_TeleoptiWFMAgg
...
::Pm Stuff
SET PM_INSTALL=True
SET AS_DATABASE=%COMPUTERNAME%_TeleoptiWFMAnalytics
