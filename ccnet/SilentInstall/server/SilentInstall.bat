...
ECHO.
if "%TempFile%"=="" (
start /wait MSIExec /i "%msipath%" ADDLOCAL="%ADDLOCAL%" CLICKONCE_CLIENT_URL="%CLICKONCE_CLIENT_URL%" CLICKONCE_MYTIME_URL="%CLICKONCE_MYTIME_URL%" CLICKONCE_SIGN_METHOD="TEMP" INSTALLDIR="%INSTALLDIR%" MATRIX_WEB_SITE_URL="%MATRIX_WEB_SITE_URL%" SQL_SERVER_NAME="%SQL_SERVER_NAME%" SQL_SERVER_AUTH="NT" SQL_SERVER_USER="" SQL_SERVER_PASS="" WISE_SQL_CONN_STR="%WISE_SQL_CONN_STR%" SQL_USER_AUTH="%SQL_USER_AUTH%" SQL_USER_NAME="%SQL_USER_NAME%" SQL_USER_PASSWORD="%SQL_USER_PASSWORD%" SQL_AUTH_STRING="%SQL_AUTH_STRING%" MYPASSWORD="%MYPASSWORD%" MYUSERNAME="%MYUSERNAME%" DB_WINGROUP="%DB_WINGROUP%" DB_ANALYTICS="%DB_ANALYTICS%" DB_ANALYTICS_STAGE="%DB_ANALYTICS_STAGE%" DB_CCC7="%DB_CCC7%" DB_CCCAGG="%DB_CCCAGG%" DB_MESSAGING="%DB_MESSAGING%" DNS_ALIAS="%DNS_ALIAS%" AGENT_SERVICE="%AGENT_SERVICE%" SITEPATH="%SITEPATH%" SDK_CRED_PROT="Ntlm" SDK_SSL_MEX_BINDING="%SDK_SSL_MEX_BINDING%" SDK_SSL_SECURITY_MODE="%SDK_SSL_SECURITY_MODE%" HTTPGETENABLED="%HTTPGETENABLED%" HTTPSGETENABLED="%HTTPSGETENABLED%" CONTEXT_HELP_URL="%CONTEXT_HELP_URL%" WEB_BROKER="%WEB_BROKER%" SERVICEBUSENABLED="true" IIS_AUTH="%IIS_AUTH%" AS_DATABASE="%AS_DATABASE%" AS_SERVER_NAME="%AS_SERVER_NAME%" PM_ANONYMOUS_DOMAINUSER="%PM_ANONYMOUS_DOMAINUSER%" PM_ANONYMOUS_PWD="%PM_ANONYMOUS_PWD%" PM_AUTH_MODE="%PM_AUTH_MODE%" PM_PROCESS_CUBE="%PM_PROCESS_CUBE%" PM_ASMX="%PM_ASMX%" PM_INSTALL="%PM_INSTALL%" RTA_SERVICE="%RTA_SERVICE%" PM_SERVICE="%PM_SERVICE%" ETLUSERNAME="%ETLUSERNAME%" ETLPASSWORD="%ETLPASSWORD%" /qn /l* "%logfile%"
set msierror=%ERRORLEVEL%
) else (
ECHO MSIExec /i "%msipath%" ADDLOCAL="%ADDLOCAL%" CLICKONCE_CLIENT_URL="%CLICKONCE_CLIENT_URL%" CLICKONCE_MYTIME_URL="%CLICKONCE_MYTIME_URL%" CLICKONCE_SIGN_METHOD="TEMP" INSTALLDIR="%INSTALLDIR%" MATRIX_WEB_SITE_URL="%MATRIX_WEB_SITE_URL%" SQL_SERVER_NAME="%SQL_SERVER_NAME%" SQL_SERVER_AUTH="NT" SQL_SERVER_USER="" SQL_SERVER_PASS="" WISE_SQL_CONN_STR="%WISE_SQL_CONN_STR%" SQL_USER_AUTH="%SQL_USER_AUTH%" SQL_USER_NAME="%SQL_USER_NAME%" SQL_USER_PASSWORD="%SQL_USER_PASSWORD%" SQL_AUTH_STRING="%SQL_AUTH_STRING%" MYPASSWORD="%MYPASSWORD%" MYUSERNAME="%MYUSERNAME%" DB_WINGROUP="%DB_WINGROUP%" DB_ANALYTICS="%DB_ANALYTICS%" DB_ANALYTICS_STAGE="%DB_ANALYTICS_STAGE%" DB_CCC7="%DB_CCC7%" DB_CCCAGG="%DB_CCCAGG%" DB_MESSAGING="%DB_MESSAGING%" DNS_ALIAS="%DNS_ALIAS%" AGENT_SERVICE="%AGENT_SERVICE%" SITEPATH="%SITEPATH%" SDK_CRED_PROT="Ntlm" SDK_SSL_MEX_BINDING="%SDK_SSL_MEX_BINDING%" SDK_SSL_SECURITY_MODE="%SDK_SSL_SECURITY_MODE%" HTTPGETENABLED="%HTTPGETENABLED%" HTTPSGETENABLED="%HTTPSGETENABLED%" CONTEXT_HELP_URL="%CONTEXT_HELP_URL%" WEB_BROKER="%WEB_BROKER%" SERVICEBUSENABLED="true" IIS_AUTH="%IIS_AUTH%" AS_DATABASE="%AS_DATABASE%" AS_SERVER_NAME="%AS_SERVER_NAME%" PM_ANONYMOUS_DOMAINUSER="%PM_ANONYMOUS_DOMAINUSER%" PM_ANONYMOUS_PWD="%PM_ANONYMOUS_PWD%" PM_AUTH_MODE="%PM_AUTH_MODE%" PM_PROCESS_CUBE="%PM_PROCESS_CUBE%" PM_ASMX="%PM_ASMX%" PM_INSTALL="%PM_INSTALL%" PM_SERVICE="%PM_SERVICE%" RTA_SERVICE="%RTA_SERVICE%" ETLUSERNAME="%ETLUSERNAME%" ETLPASSWORD="%ETLPASSWORD%" /qn /l* "%logfile%" > "%TempFile%"
)
