...
SET CLICKONCE_CLIENT_URL=%DNS_ALIAS%TeleoptiWFM/Client/
SET CLICKONCE_MYTIME_URL=%DNS_ALIAS%TeleoptiWFM/MyTime/
SET MATRIX_WEB_SITE_URL=%DNS_ALIAS%TeleoptiWFM/Analytics
...
SET AGENT_SERVICE=%DNS_ALIAS%TeleoptiWFM/SDK/TeleoptiCccSdkService.svc
SET RTA_SERVICE=%DNS_ALIAS%TeleoptiWFM/RTA/TeleoptiRtaService.svc
SET WEB_BROKER=%DNS_ALIAS%TeleoptiWFM/broker/
SET WEB_BROKER_BACKPLANE=%DNS_ALIAS%TeleoptiWFM/Broker.backplane/backplane
...
SET PM_SERVICE=%DNS_ALIAS%TeleoptiWFM/PmService/PmService.svc
) ELSE (
