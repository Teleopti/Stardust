...
PAUSE
::Test
"%CCNetWorkingDirectory%\packages\NUnit.Runners.2.6.0.12051\tools\nunit-console.exe" /output=c:\WebTest.xml "%CCNetWorkingDirectory%\Teleopti.Ccc.Web\Teleopti.Ccc.WebBehaviorTest\bin\%configuration%\Teleopti.Ccc.WebBehaviorTest.dll"
