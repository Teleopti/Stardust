...
cscript "%CCNetWorkDir%\ccnet\ETLNightlyBuild\replace.vbs" "Integrated Security" "User Id=%AppSqlLogin%;Password=%AppSqlPwd%" "%TargetDir%\Teleopti.Analytics.Etl.ServiceHost.exe.config"
cscript "%CCNetWorkDir%\ccnet\ETLNightlyBuild\replace.vbs" "Integrated Security" "User Id=%AppSqlLogin%;Password=%AppSqlPwd%" "%TargetDir%\TeleoptiCCC7.nhib.xml"