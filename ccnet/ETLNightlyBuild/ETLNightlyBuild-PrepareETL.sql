...
BEGIN
	...
	BEGIN
		...
		SELECT top 1 @ErrorMessage = CAST(error_exception_message as varchar(100)) + CAST(error_exception_stacktrace as varchar(400)) FROM [mart].[etl_jobstep_error] order by jobstep_error_id desc
