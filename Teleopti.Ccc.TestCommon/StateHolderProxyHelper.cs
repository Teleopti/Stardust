...
namespace Teleopti.Ccc.TestCommon
{
    ...
    public static class StateHolderProxyHelper
    {
			...
			)
		{
			...
			MessageBrokerContainerDontUse.Configure(null, new IConnectionKeepAliveStrategy[] { }, MessageFilterManager.Instance, new NewtonsoftJsonSerializer(), new NewtonsoftJsonDeserializer());
