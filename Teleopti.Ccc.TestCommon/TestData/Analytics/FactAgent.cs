...
namespace Teleopti.Ccc.TestCommon.TestData.Analytics
{
	public class FactAgent : IAnalyticsDataSetup
	{
		...
		public FactAgent(int dateId, int intervalId, int acdLoginId, int readyTimeS, int loggedInTimeS, int notReadyTimeS, int idleTimeS, int directOutboundCalls, int directOutboundTalkTimeS, int directIncomingCalls, int directIncomingCallsTalkTimeS, int adminTimeS)
		{
			_dateId = dateId;
		...
		public void Apply(SqlConnection connection, CultureInfo userCulture, CultureInfo analyticsDataCulture)
		{
			...
			{
				table.AddFactAgent(_dateId, _intervalId, _acdLoginId, _readyTimeS, _loggedInTimeS,
