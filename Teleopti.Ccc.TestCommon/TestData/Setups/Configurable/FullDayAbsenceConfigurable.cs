...
namespace Teleopti.Ccc.TestCommon.TestData.Setups.Configurable
{
	public class FullDayAbsenceConfigurable : IUserDataSetup
	{
		...
		public void Apply(ICurrentUnitOfWork unitOfWork, IPerson person, CultureInfo cultureInfo)
		{
			...
			var commandConverter = new AbsenceCommandConverter(new ThisCurrentScenario(scenario), PersonRepository.DONT_USE_CTOR(unitOfWork, null, null), AbsenceRepository.DONT_USE_CTOR(unitOfWork), scheduleRepository, UserTimeZone.Make());
