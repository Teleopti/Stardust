...
namespace Teleopti.Ccc.TestCommon
{
	...
	{
		public FakeScheduleRange(IScheduleDictionary owner, IScheduleParameters parameters)
		...
		{
			get { return CalculatedContractTimeHolder; }
			set { CalculatedContractTimeHolder = value; }
		}

		TimeSpan? IScheduleRange.CalculatedTargetTimeHolder { get; set; }
		int? IScheduleRange.CalculatedTargetScheduleDaysOff { get; set; }
