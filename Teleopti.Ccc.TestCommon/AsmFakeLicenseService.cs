...
{
	public class AsmFakeLicenseService : ILicenseService
	{
		public AsmFakeLicenseService(bool asmEnabled)
		{
			...
			TeleoptiCccAgentScheduleMessengerEnabled = asmEnabled;
			...
			TeleoptiWFMOvertimeRequestsEnabled = true;
