...
namespace Teleopti.Ccc.TestCommon.FakeData
{
    public static class ScheduleMatrixProFactory
    {
        public static ScheduleMatrixPro Create(DateOnlyPeriod period, IPerson person)
        {
            ...
            return Create(period, scheduleDictionary, person, person.VirtualSchedulePeriod(period.StartDate));
        }

        public static ScheduleMatrixPro Create(DateOnlyPeriod period, IScheduleDictionary schedules, IPerson person, IVirtualSchedulePeriod schedulePeriod)
        {
            IFullWeekOuterWeekPeriodCreator periodCreator = new FullWeekOuterWeekPeriodCreator(period, person);
            return new ScheduleMatrixPro(schedules, periodCreator, schedulePeriod);
        }
    }
}
