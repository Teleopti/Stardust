...
{
	public class PersistScheduleChanges
	{
		private readonly IScheduleStorage _scheduleStorage;
		private readonly ICurrentUnitOfWork _currentUnitOfWork;

		public PersistScheduleChanges(IScheduleStorage scheduleStorage, ICurrentUnitOfWork currentUnitOfWork)
		{
			_scheduleStorage = scheduleStorage;
			_currentUnitOfWork = currentUnitOfWork;
		}
		
		public void Execute(IDifferenceCollection<IPersistableScheduleData> scheduleChanges,
			IUnvalidatedScheduleRangeUpdate stateInMemoryUpdater)
		{
