...
{
	//will be removed when #36409 is fixed. rolled back this one until we are in a more "stable state" regarding scheduling
	public class CurrentUnitOfWorkScheduleRangePersister_TEMP : IScheduleRangePersister
	{
		...
		public CurrentUnitOfWorkScheduleRangePersister_TEMP(
