...
namespace DotNetOpenAuth.OpenId.Provider {
	...
	internal abstract class HostProcessedRequest : Request, IHostProcessedRequest {
		...
		/// </summary>
		public ProtocolVersion RelyingPartyVersion => Protocol.Lookup(this.RequestMessage.Version).ProtocolVersion;
		...
		/// </summary>
		public bool Immediate => this.RequestMessage.Immediate;

		/// <summary>
		/// Gets the URL the consumer site claims to use as its 'base' address.
		/// </summary>
		public Realm Realm => this.RequestMessage.Realm;
		...
		/// </summary>
		internal bool HasRealmDiscoveryBeenPerformed => realmDiscoveryResult.HasValue;

		/// <summary>
		/// Gets the negative response.
		/// </summary>
		protected NegativeAssertionResponse NegativeResponse => negativeResponse;

		/// <summary>
		/// Gets the original request message.
		/// </summary>
		/// <value>This may be null in the case of an unrecognizable message.</value>
		protected new SignedResponseRequest RequestMessage => (SignedResponseRequest)base.RequestMessage;
