...
namespace DotNetOpenAuth.OpenId.Provider {
	...
	internal class AuthenticationRequest : HostProcessedRequest, IAuthenticationRequest {
		...
		/// </summary>
		public override bool IsResponseReady => IsAuthenticated.HasValue &&
		...
		public Identifier LocalIdentifier {
			get {
				return positiveResponse.LocalIdentifier;
			}
		...
		/// </summary>
		protected new CheckIdRequest RequestMessage => (CheckIdRequest)base.RequestMessage;
