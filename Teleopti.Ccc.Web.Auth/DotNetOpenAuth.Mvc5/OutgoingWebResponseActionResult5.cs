//-----------------------------------------------------------------------
// <copyright file="OutgoingWebResponseActionResult5.cs" company="Outercurve Foundation">
...
namespace DotNetOpenAuth.Messaging {
	...
	/// </summary>
	internal class OutgoingWebResponseActionResult5 : ActionResult {
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="OutgoingWebResponseActionResult5"/> class.
		/// </summary>
		/// <param name="response">The response.</param>
		internal OutgoingWebResponseActionResult5(OutgoingWebResponse response) {
