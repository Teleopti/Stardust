...
namespace Teleopti.Ccc.DomainTest.Forecasting
{
    ...
    public class DaylightSavingTimeHelperTest
    {
        ...
        {
            var currentDate = new DateOnly(2012, 10, 1);
            var timeZone = new CccTimeZoneInfo(TimeZoneInfo.FindSystemTimeZoneById("China Standard Time"));
            ...
            currentDate = new DateOnly(2012, 10, 28);
            ...
            currentDate = new DateOnly(2012, 10, 21);
            timeZone = new CccTimeZoneInfo(TimeZoneInfo.FindSystemTimeZoneById("E. South America Standard Time"));
            startTime = DaylightSavingTimeHelper.GetUtcStartTimeOfOneDay(currentDate, timeZone);
            endTime = DaylightSavingTimeHelper.GetUtcEndTimeOfOneDay(currentDate, timeZone);
            ...
            currentDate = new DateOnly(2012, 3, 25);
            timeZone = new CccTimeZoneInfo(TimeZoneInfo.FindSystemTimeZoneById("W. Europe Standard Time"));
            startTime = DaylightSavingTimeHelper.GetUtcStartTimeOfOneDay(currentDate, timeZone);
            endTime = DaylightSavingTimeHelper.GetUtcEndTimeOfOneDay(currentDate, timeZone);
            ...
            currentDate = new DateOnly(2012, 2, 25);
            timeZone = new CccTimeZoneInfo(TimeZoneInfo.FindSystemTimeZoneById("E. South America Standard Time"));
            startTime = DaylightSavingTimeHelper.GetUtcStartTimeOfOneDay(currentDate, timeZone);
            endTime = DaylightSavingTimeHelper.GetUtcEndTimeOfOneDay(currentDate, timeZone);
