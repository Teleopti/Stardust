...
namespace Teleopti.Ccc.DomainTest.Forecasting.Angel
{
	public class QuickForecasterSkillWithMultipleWorkloadsTest
	{
		...
		public void ShouldCalculateSumOfTasksFromAllWorkloadsOnOneSkill()
		{
			...
			var quickForecasterWorkload = new QuickForecasterWorkload(new HistoricalData(dailyStatistics, validatedVolumeDayRepository), new FutureData(),new ForecastMethod(new IndexVolumes()), new ForecastingTargetMerger(), new ForecastingMeasurer());
