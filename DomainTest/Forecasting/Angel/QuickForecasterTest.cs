...
namespace Teleopti.Ccc.DomainTest.Forecasting.Angel
{
	public class QuickForecasterTest
	{
		...
		public void ShouldForecastForWorkload()
		{
			...
			quickForecasterWorkload.Stub(x =>
				x.Execute(
					Arg<QuickForecasterWorkloadParams>.Matches(
						y =>
							y.WorkLoad == workload && y.FuturePeriod == futurePeriod && y.HistoricalPeriod == historicalPeriod &&
							y.SkillDays == skillDays))).Return(90.9);
