...
namespace Teleopti.Ccc.DomainTest.Forecasting.Angel
{
	public class OnlyStatisticsTest
	{
		...
		public void SingleSimpleWorkloadDay()
		{
			...
			var target = new QuickForecaster(new Domain.Forecasting.Angel.HistoricalData.HistoricalData(dailyStatistics, MockRepository.GenerateStub<IValidatedVolumeDayRepository>()), loadSkillDays);
