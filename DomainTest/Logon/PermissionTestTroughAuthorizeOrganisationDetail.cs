...
namespace Teleopti.Ccc.DomainTest.Logon
{
	...
	public class PermissionTestTroughAuthorizeOrganisationDetail
	{
		...
		public void ShouldHavePermissionForMyTeam()
		{
			...
			var otherGuyDetails = new authorizeOrganisationDetailForTest
			{
				PersonId = otherGuyId,
			...
			var myDetails = new authorizeOrganisationDetailForTest
			{
				PersonId = meId,
				BusinessUnitId = Database.CurrentBusinessUnitId(),
				SiteId = siteId,
		...
		private class authorizeOrganisationDetailForTest : IAuthorizeOrganisationDetail
		{
