...
namespace Teleopti.Ccc.DomainTest.Scheduling.Assignment
{
	public class DeleteAndResourceCalculateServiceSkipResCalcTest
	{
		...
		public void ShouldResourceCalculate()
		{
			...
			resourceOptHelper.AssertWasCalled(x => x.ResourceCalculate(date, new ResourceOptimizationData(false, false)), options => options.IgnoreArguments());
		}
		...
		public void ShouldNotResourceCalculate()
		{
			...
			resourceOptHelper.AssertWasNotCalled(x => x.ResourceCalculate(date, new ResourceOptimizationData(false, false)), options => options.IgnoreArguments());
		}
	}
}