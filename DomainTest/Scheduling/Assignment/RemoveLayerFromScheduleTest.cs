...
namespace Teleopti.Ccc.DomainTest.Scheduling.Assignment
{
	...
	public class RemoveLayerFromScheduleTest
    {
	    ...
	    public void VerifyRemovesPersonAbsence()
	    {
		    ...
		    Assert.IsFalse(schedulePart.PersonAbsenceCollection().Contains(firstPersonAbsence),
			    "The PersonAbsence containing the layer should have been removed");
	    }
	    ...
	    public void VerifyRemovesOvertimeLayer()
	    {
		    ...
		    Assert.AreEqual(0, schedulePart.PersonAssignment().OvertimeActivities().Count(),
			    "The OvertimeLayer  should have been removed");
	    }
    }
}
