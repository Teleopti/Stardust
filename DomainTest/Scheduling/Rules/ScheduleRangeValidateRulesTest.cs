...
namespace Teleopti.Ccc.DomainTest.Scheduling.Rules
{
    ...
    public class ScheduleRangeValidateRulesTest
    {
        ...
        public void VerifyValidate()
        {
            ...
            dic.Modify(ScheduleModifier.Scheduler, schedulePart, NewBusinessRuleCollection.Minimum(), new DoNothingScheduleDayChangeCallBack(), new ScheduleTagSetter(NullScheduleTag.Instance));
