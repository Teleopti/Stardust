...
namespace Teleopti.Ccc.DomainTest.Scheduling.Rules
{
    ...
    public class OverlappingAssignmentRuleTest
    {
        ...
        public void Setup()
        {
            ...
            _scheduleRange = new ScheduleRange(dic, new ScheduleParameters(_scenario, _person, _schedulePeriod), new PersistableScheduleDataPermissionChecker());
        ...
        public void VerifyLongestDateTimePeriodForAssignmentReturnsCorrectWhenSeekingOnAssignment()
        {
            ...
            var expected = new DateTimePeriod(new DateTime(2007, 8, 1, 12, 0, 0, DateTimeKind.Utc), new DateTime(2007, 8, 1, 12, 0, 0, DateTimeKind.Utc));
