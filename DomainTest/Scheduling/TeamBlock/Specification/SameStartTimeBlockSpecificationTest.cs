...
{
    public class SameStartTimeBlockSpecificationTest
    {
        ...
        private ISameStartTimeBlockSpecification _target;
        ...
        public void Setup()
        {
            ...
            _target = new SameStartTimeBlockSpecification();
        ...
        [Test]
        public void ShouldReturnFalseForBlockHasDifferentStartTime()
        {
            ...
            var dateTimePeriod2 = new DateTimePeriod(new DateTime(2013, 11, 1, 9, 0, 0, DateTimeKind.Utc),
                                                     new DateTime(2013, 11, 1, 16, 0, 0, DateTimeKind.Utc));
            using (_mock.Record())
            {
				Expect.Call(_teamBlockInfo.BlockInfo).Return(_blockInfo);
				Expect.Call(_blockInfo.BlockPeriod).Return(dateOnlyPeriod);
        ...
        [Test]
        public void ShouldReturnTrueForBlockHasStartTime()
        {
            var dateOnlyPeriod = new DateOnlyPeriod(_today, _today.AddDays(1));
            IEnumerable<IScheduleMatrixPro> matrixList = new List<IScheduleMatrixPro> { _matrix1 };
            var dateTimePeriod1 = new DateTimePeriod(new DateTime(2013, 10, 31, 7, 0, 0, DateTimeKind.Utc),
