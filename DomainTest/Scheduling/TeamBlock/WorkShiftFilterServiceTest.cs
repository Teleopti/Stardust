...
namespace Teleopti.Ccc.DomainTest.Scheduling.TeamBlock
{
	...
	public class WorkShiftFilterServiceTest
	{
		...
		public void Setup()
		{
			...
			var validDateTimePeriodShiftFilter = new ValidDateTimePeriodShiftFilter();
		...
		public void ShouldReturnNullIfEffectiveRestrictionIsNull()
		{
			...
			var retShift = _target.FilterForRoleModel(new GroupPersonSkillAggregator(new PersonalSkillsProvider()), _schedules, dateOnly, _teamBlockInfo, null,
			                              _schedulingOptions, true, false, new List<ISkillDay>());
		...
		public void ShouldReturnNoShiftsWhenNotMatchingRequestedShiftCategory()
		{
			...
			var result = _target.FilterForRoleModel(new GroupPersonSkillAggregator(new PersonalSkillsProvider()), _schedules, _dateOnly, _teamBlockInfo, effectiveRestriction, _schedulingOptions, true, false, new List<ISkillDay>());
