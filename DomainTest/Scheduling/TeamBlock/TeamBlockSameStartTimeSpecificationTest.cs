...
{
    public class TeamBlockSameStartTimeSpecificationTest
    {
        ...
        private ITeamBlockSameStartTimeSpecification _target;
        ...
        public void Setup()
        {
            ...
            _target = new TeamBlockSameStartTimeSpecification(_validSampleDayPickerFromTeamBlock);
        ...
        public void ShouldReturnFalseIfDifferentStartTime()
        {
            ...
            var dateTimePeriod1 = new DateTimePeriod(new DateTime(2013, 10, 31, 7, 0, 0, DateTimeKind.Utc),
                                                     new DateTime(2013, 10, 31, 15, 0, 0, DateTimeKind.Utc));
            var dateTimePeriod2 = new DateTimePeriod(new DateTime(2013, 10, 31, 6, 0, 0, DateTimeKind.Utc),
