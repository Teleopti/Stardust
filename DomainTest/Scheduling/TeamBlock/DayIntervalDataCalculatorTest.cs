...
namespace Teleopti.Ccc.DomainTest.Scheduling.TeamBlock
{
	...
	public class DayIntervalDataCalculatorTest
	{
		...
		public void Setup()
		{
			...
			_target = new DayIntervalDataCalculator(_medianCalculatorForDays);
		}

	    [Test]
	    public void ShouldReturnNull()
	    {
	        var result =  _target.CalculatePerfect(15, null);
        ...
        public void ShouldHaveCorrectIntervals()
        {
            ...
            var result = _target.CalculatePerfect(15,list );
        ...
        public void VerifyCalculationOvernightShiftForSingleDay()
        {
            ...
            var result = _target.CalculatePerfect(60, list);
