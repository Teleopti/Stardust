...
namespace Teleopti.Ccc.DomainTest.Scheduling.TeamBlock
{
    ...
    public class NightlyRestRestrictionForTeamBlockTest
    {
        ...
        public void MultipleAgentsSingleDayBlock()
        {
            ...
            var dateTimePeriod1 = new DateTimePeriod(new DateTime(2013, 09, 27, 10, 0, 0, DateTimeKind.Utc), new DateTime(2013, 09, 27, 14, 0, 0, DateTimeKind.Utc));
            var dateTimePeriod2 = new DateTimePeriod(new DateTime(2013, 09, 27, 11, 0, 0, DateTimeKind.Utc), new DateTime(2013, 09, 27, 13, 0, 0, DateTimeKind.Utc));
        ...
        public void MultipleAgentsMultipleDaysBlock()
        {
            ...
            var dateTimePeriod1 = new DateTimePeriod(new DateTime(2013, 09, 27, 10, 0, 0, DateTimeKind.Utc), new DateTime(2013, 09, 27, 13, 0, 0, DateTimeKind.Utc));
            var dateTimePeriod2 = new DateTimePeriod(new DateTime(2013, 09, 27, 11, 0, 0, DateTimeKind.Utc), new DateTime(2013, 09, 27, 14, 0, 0, DateTimeKind.Utc));
