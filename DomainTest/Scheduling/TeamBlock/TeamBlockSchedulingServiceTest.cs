    ...
    public class TeamBlockSchedulingServiceTest
    {
		...
		public void ShouldNotVerifyIfScheduleWasNotSuccessfull()
		{
			...
			using (_mock.Record())
			{
				...
				Expect.Call(_teamBlockScheduler.ScheduleTeamBlockDay(null, _teamBlockInfoMock, _date, _schedulingOptions,
					_rollbackService, _resourceCalculateDelayer, null, null, null, NewBusinessRuleCollection.AllForScheduling(_schedulingResultStateHolder)))
					.IgnoreArguments()
					.Return(false);
				Expect.Call(() => _teamBlockScheduler.DayScheduled -= null).IgnoreArguments();
			}
		...
		public void ShouldIgoreATeamIfSomeoneFailedButContinueWithOtherTeams()
		{
			...
			using (_mock.Record())
			{
				...
				Expect.Call(_teamBlockScheduler.ScheduleTeamBlockDay(null, _teamBlockInfoMock, _date, _schedulingOptions,
					_rollbackService, _resourceCalculateDelayer, null,
