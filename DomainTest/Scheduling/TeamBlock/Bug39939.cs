...
namespace Teleopti.Ccc.DomainTest.Scheduling.TeamBlock
{
	...
	public class Bug39939
	{
		...
		public void ShouldHandleStrangeSchedules()
		{
			...
			agent1.PermissionInformation.SetDefaultTimeZone(TimeZoneInfoFactory.TaipeiTimeZoneInfo());
			...
			agent2.PermissionInformation.SetDefaultTimeZone(TimeZoneInfoFactory.TaipeiTimeZoneInfo());
			...
			assignments.Count.Should().Be.EqualTo(13);
		}
	}
}