...
{
    public class TeamBlockSameShiftSpecificationTest
    {
        ...
        private ITeamBlockSameShiftSpecification _target;
        ...
        public void Setup()
        {
            ...
            _target = new TeamBlockSameShiftSpecification(_validSampleDayPickerFromTeamBlock, _scheduleDayEquator);
        }
