    ...
    public class TeamSchedulingTest
    {
        ...
        public void ShouldSchedulePerDayAndPerson()
        {
            ...
            using (_mock.Playback())
            {
				...
				_target.ExecutePerDayPerPerson(_person, DateOnly.MinValue, _teamBlockInfo, _shiftProjectionCache, new DateOnlyPeriod(DateOnly.MinValue, DateOnly.MinValue), _schedulePartModifyAndRollbackService);
				//_target.DayScheduled += targetDayScheduledCanceled;
            }
