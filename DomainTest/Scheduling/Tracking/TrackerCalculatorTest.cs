...
namespace Teleopti.Ccc.DomainTest.Scheduling.Tracking
{
    ...
    public class TrackerCalculatorTest
    {
        ...
        public void VerifyCanCountAbsenceDaysOverPeriod()
        {
            ...
            schedulePart.CreateAndAddActivity(new MainShiftActivityLayer(underlyingActivity,period1),new ShiftCategory("-"));
            schedulePart2.CreateAndAddActivity(new MainShiftActivityLayer(underlyingActivity, period2), new ShiftCategory("-"));
            schedulePart3.CreateAndAddActivity(new MainShiftActivityLayer(underlyingActivity, period3), new ShiftCategory("-"));
