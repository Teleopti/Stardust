...
namespace Teleopti.Ccc.DomainTest.Scheduling.Tracking
{
    ...
    public class TrackerCalculatorTest
    {
        ...
        public void VerifyCanCountAbsenceDaysOverPeriod()
        {
            ...
            schedulePart.CreateAndAddActivity(new MainShiftActivityLayerNew(underlyingActivity,period1),new ShiftCategory("-"));
            schedulePart2.CreateAndAddActivity(new MainShiftActivityLayerNew(underlyingActivity, period2), new ShiftCategory("-"));
            schedulePart3.CreateAndAddActivity(new MainShiftActivityLayerNew(underlyingActivity, period3), new ShiftCategory("-"));
