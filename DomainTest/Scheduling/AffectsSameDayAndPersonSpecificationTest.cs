...
namespace Teleopti.Ccc.DomainTest.Scheduling
{
    ...
    public class ScheduleAffectsSameDayAndPersonTest
    {
        ...
        public void VerifyReturnsTrueIfItsTheSameDateAndPerson()
        {
            ...
            IScheduleDay scheduleDay = ExtractedSchedule.CreateScheduleDay(new ScheduleDictionary(_scenario,_period, _permissionChecker, PrincipalAuthorization.Current()), _person, _date);
            IScheduleDay scheduleWithSameDateAndPerson = ExtractedSchedule.CreateScheduleDay(new ScheduleDictionary(_scenario,_period, _permissionChecker, PrincipalAuthorization.Current()), _person, _date);
        ...
        public void VerifyIsNotSatisfiedIfTheDateOrThePersonDoesNotMatchTheOriginalScheduleDay()
        {
            ...
            IScheduleDay scheduleDay = ExtractedSchedule.CreateScheduleDay(new ScheduleDictionary(_scenario, _period, _permissionChecker, PrincipalAuthorization.Current()), _person, _date);
            IScheduleDay scheduleWithAnotherPerson = ExtractedSchedule.CreateScheduleDay(new ScheduleDictionary(_scenario, _period, _permissionChecker, PrincipalAuthorization.Current()), anotherPerson, _date);
            IScheduleDay scheduleWithAnotherDate = ExtractedSchedule.CreateScheduleDay(new ScheduleDictionary(_scenario, _period, _permissionChecker, PrincipalAuthorization.Current()), _person, anotherDate);
