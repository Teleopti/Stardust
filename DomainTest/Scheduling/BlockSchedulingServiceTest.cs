...
namespace Teleopti.Ccc.DomainTest.Scheduling
{
    ...
    public class BlockSchedulingServiceTest
    {
        ...
        {
            _interface = new BlockSchedulingService(_blockShiftCategoryFinder, _scheduleDayService, _blockFinderFactory, _optimizerPreferences);
            ...
            using (_mocks.Record())
            {
                Expect.Call(_blockFinderFactory.CreateFinder(_matrix0, BlockFinderType.SchedulePeriod)).Return(_blockFinder).Repeat.Any();
                ...
                Expect.Call(
                    _blockShiftCategoryFinder.BestShiftCategoryForDays(_result,
                                                                       _person,_fairness,_fairness)).Return(
                ...
                Expect.Call(_scheduleDayService.ScheduleDay(schedulePart)).Return(true).Repeat.Any();
                _blockFinder.ResetBlockPointer();
                LastCall.Repeat.Any();
            }
            _interface.Execute(_matrixList, BlockFinderType.SchedulePeriod, _reportList);
        }

        [Test]
        public void VerifyBlockFinderList()
        {
            _instance = new BlockSchedulingService(_blockShiftCategoryFinder, _scheduleDayService, _blockFinderFactory, _optimizerPreferences);
        ...
        public void VerifyActOnResultReturnsWhenNoBlock()
        {
            ...
            _instance.ActOnResult(result, null);
        }
        ...
        public void VerifyActOnResultFindsBestCategoryIfResultCategoryIsNull()
        {
            ...
            using(_mocks.Record())
            {
				...
				Expect.Call(_range.FairnessPoints()).Return(_fairness);
                Expect.Call(
                    _blockShiftCategoryFinder.BestShiftCategoryForDays(_result, _person,_fairness,_fairness)).Return(
                ...
                Expect.Call(_matrix0.UnlockedDays).Return(
                    new ReadOnlyCollection<IScheduleDayPro>(new List<IScheduleDayPro> { scheduleDayPro })).Repeat.Any();
                Expect.Call(_scheduleDayService.ScheduleDay(schedulePart)).Return(true).Repeat.Once();
            }
            _instance = new BlockSchedulingService(_blockShiftCategoryFinder, _scheduleDayService, _blockFinderFactory, _optimizerPreferences);
            ...
            {
                _instance.ActOnResult(result, _matrix0);
            }
        ...
        public void VerifyReturnIfNoShiftCategoryFound()
        {
            using (_mocks.Record())
            {
				...
				Expect.Call(_range.FairnessPoints()).Return(_fairness);
                Expect.Call(
                    _blockShiftCategoryFinder.BestShiftCategoryForDays(null, null,_fairness,_fairness)).IgnoreArguments().Return(new BestShiftCategoryResult(null,FailureCause.AlreadyAssigned)).Repeat.Once();
                Expect.Call(_matrix0.Person).Return(_person).Repeat.Any();
            }
            _instance = new BlockSchedulingService(_blockShiftCategoryFinder, _scheduleDayService, _blockFinderFactory, _optimizerPreferences);
            IBlockFinderResult result = new BlockFinderResult(null, new List<DateOnly> { new DateOnly(2010, 1, 1) }, _reportList);
        ...
        public void VerifyActOnResultTryAnotherCategoryIfFirstFails()
        {
            ...
            using (_mocks.Record())
            {
                ...
                Expect.Call(_scheduleDayService.ScheduleDay(schedulePart)).Return(false).Repeat.Once();
            ...
            Assert.AreEqual("xx", _optimizerPreferences.SchedulingOptions.NotAllowedShiftCategories[0].Description.Name);
        }
        ...
        public void VerifyLockedDaysDoesNotGetScheduled()
        {
            ...
            using (_mocks.Record())
            {
                ...
                Expect.Call(_matrix0.UnlockedDays).Return(
                    new ReadOnlyCollection<IScheduleDayPro>(new List<IScheduleDayPro>())).Repeat.Any();
                Expect.Call(_scheduleDayService.ScheduleDay(schedulePart)).Repeat.Never();
            }
            _instance = new BlockSchedulingService(_blockShiftCategoryFinder, _scheduleDayService, _blockFinderFactory, _optimizerPreferences);
        ...
        public void VerifyBlockScheduledEvent()
        {
            ...
            using (_mocks.Record())
            {
				...
				Expect.Call(
                    _blockShiftCategoryFinder.BestShiftCategoryForDays(_result, _person,_fairness, _fairness)).
        ...
        public void VerifyTryScheduleBlockReturnsTrueIfBlockSuccessfullyScheduled()
        {
            ...
            Assert.IsTrue(_instance.TryScheduleBlock(result, _matrix0));
        }
        ...
        public void VerifyTryScheduleBlockReturnsFalseIfNotBlockSuccessfullyScheduled()
        {
            ...
            using (_mocks.Record())
            {
                ...
                Expect.Call(_scheduleDayService.ScheduleDay(schedulePartToFail)).Return(false).Repeat.Once();
                Expect.Call(_scheduleDayService.DeleteMainShift(new List<IScheduleDay> {schedulePart})).Return(
            ...
            using(_mocks.Playback())
            {
                Assert.IsFalse(_instance.TryScheduleBlock(result, _matrix0));
            }
