    ...
    public class MeetingSlotFinderServiceTest
    {
        ...
        public void Setup()
        {
            ...
            using (_mocks.Playback())
            {
                ...
                _p2D3.AddMainShift(MainShiftFactory.CreateMainShift(activity, _d3, category));
                ...
                _scheduleDayToNextDay.AddMainShift(MainShiftFactory.CreateMainShift(activity, _periodToNextDay, category));
