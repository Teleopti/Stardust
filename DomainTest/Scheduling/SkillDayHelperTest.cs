...
namespace Teleopti.Ccc.DomainTest.Scheduling
{
    ...
    public class SkillDayHelperTest
    {
        ...
        public void VerifyEstimatedServiceLevel()
        {
            ...
            Assert.AreEqual(3.01d, periodlist1[0].Payload.ForecastedIncomingDemand, 0.0001);
            Assert.AreEqual(4.01d, periodlist2[0].Payload.ForecastedIncomingDemand, 0.0001);
