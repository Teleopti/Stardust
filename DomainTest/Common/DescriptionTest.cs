...
namespace Teleopti.Ccc.DomainTest.Common
{
	...
	public class DescriptionTest
	{
		...
		{
			Assert.Throws<ArgumentOutOfRangeException>(() => target = new Description(string.Concat(Enumerable.Repeat("a", 55)), null));
		}
		...
		{
			Assert.Throws<ArgumentOutOfRangeException>(() => target = new Description(_name, "".PadLeft(26)));
		}

		[Test]
		public void ShouldNotAcceptOnlyWhitespacesInName()
		{
			Assert.Throws<ArgumentException>(() => target = new Description(" "));
		}
	}
}