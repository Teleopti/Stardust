	...
	public class StaffingThresholdWithShrinkageValidatorTest
	{
		...
		public void CanValidateIfRequestedOnlyOneDayOfAbsence()
		{
			...
			var result = _target.Validate(absenceRequest,
				new RequiredForHandlingAbsenceRequest(stateHolder, null, _resourceOptimizationHelper, null));
		...
		public void ShouldDenyIfSeriouslyUnderStaffedDuringOnlyInterval()
		{
			...
			var result = _target.Validate(absenceRequest, new RequiredForHandlingAbsenceRequest(stateHolder, null, _resourceOptimizationHelper, null));
			Assert.IsFalse(result.IsValid);
		}
