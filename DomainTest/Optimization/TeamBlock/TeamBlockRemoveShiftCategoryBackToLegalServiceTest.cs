	...
	public class TeamBlockRemoveShiftCategoryBackToLegalServiceTest
	{
		...
		public void ShouldExecuteOnWeekRestriction()
		{
			...
			using (_mock.Record())
			{
				...
				Expect.Call(_teamBlockScheduler.ScheduleTeamBlockDay(_teamBlockInfo, _dateOnly, _schedulingOptions, _rollbackService, _resourceCalculateDelayer, null, _shiftNudgeDirective, NewBusinessRuleCollection.AllForScheduling(_schedulingResultStateHolder))).IgnoreArguments().Return(true);
		...
		public void ShouldClearTeamBlockAndRetryIfNoSuccesOnOneDay()
		{
			...
			using (_mock.Record())
			{
				...
				Expect.Call(_teamBlockScheduler.ScheduleTeamBlockDay(_teamBlockInfo, _dateOnly, _schedulingOptions, _rollbackService, _resourceCalculateDelayer, null, _shiftNudgeDirective, NewBusinessRuleCollection.AllForScheduling(_schedulingResultStateHolder))).IgnoreArguments().Return(false);
