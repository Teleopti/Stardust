...
{
    [TestFixture]
    public class SuitableDayOffToGiveAwayTest
    {
        private ISuitableDayOffToGiveAway _target;
        ...
        public void Setup()
        {
            _target = new SuitableDayOffToGiveAway();
        ...
        public void ShouldReturnDayWithMostPrioritySingleTry()
        {
            ...
            Assert.AreEqual(result, new DateOnly(2014, 02, 07));
        }
        ...
        public void ShouldReturnDayWithMostPriorityTwoTries()
        {
            ...
            var firstResult = new DateOnly(2014, 02, 07);
