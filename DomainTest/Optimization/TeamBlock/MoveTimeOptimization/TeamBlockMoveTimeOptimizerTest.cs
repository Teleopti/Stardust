...
namespace Teleopti.Ccc.DomainTest.Optimization.TeamBlock.MoveTimeOptimization
{
	...
	public class TeamBlockMoveTimeOptimizerTest
	{
		...
		public void Setup()
		{
			...
			_target = new TeamBlockMoveTimeOptimizer(_schedulingOptionsCreator, _decisionMaker, _teamBlockClearer, _teamBlockInfoFactory, _teamBlockScheduler, _safeRollbackAndResourceCalculation, _teamBlockShiftCategoryLimitationValidator, _workShiftSelector);
		...
		public void ShouldOptimizeSuccessfully()
		{
				...
				using (_mock.Record())
				{
					...
					Expect.Call(_teamBlockScheduler.ScheduleTeamBlockDay(_workShiftSelector, _teamBlockInfo, new DateOnly(2014, 5, 14), _schedulingOptions,
						_rollbackService, _resourceCalulateDelayer, null, null, _shiftNudgeDirective, NewBusinessRuleCollection.AllForScheduling(_schedulingResultStateHolder))).IgnoreArguments().Return(true);
