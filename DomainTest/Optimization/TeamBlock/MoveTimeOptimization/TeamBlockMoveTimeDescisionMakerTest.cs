...
{
	[TestFixture]
	public class TeamBlockMoveTimeDescisionMakerTest
	{
		private ITeamBlockMoveTimeDescisionMaker _target;
		...
		public void Setup()
		{
			...
			_dayValueUnlockedIndexSorder = new DayValueUnlockedIndexSorter();
			_lokableBitArrayFactory = _mocks.StrictMock<ILockableBitArrayFactory>();
			_scheduleResultDataExtractorProvider = _mocks.StrictMock<IScheduleResultDataExtractorProvider>();
			_validateFoundMovedDaysSpecification = _mocks.StrictMock<IValidateFoundMovedDaysSpecification>();
			_target = new TeamBlockMoveTimeDescisionMaker(_dayValueUnlockedIndexSorder, _lokableBitArrayFactory, _scheduleResultDataExtractorProvider, _validateFoundMovedDaysSpecification);
