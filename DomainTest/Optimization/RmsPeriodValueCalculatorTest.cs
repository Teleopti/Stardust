...
{
    [TestFixture]
    public class RmsPeriodValueCalculatorTest
    {
        private RmsPeriodValueCalculator _target;
        ...
        public void Setup()
        {
            ...
            _target = new RmsPeriodValueCalculator(_scheduleResultDataExtractor);
        }
        ...
        public void VerifyPeriodValue()
        {
            ...
            {
                Assert.AreEqual(3.3166, _target.PeriodValue(IterationOperationOption.WorkShiftOptimization), 0.1);
            }
