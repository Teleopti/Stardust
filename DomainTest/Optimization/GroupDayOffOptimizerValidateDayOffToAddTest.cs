...
{
	[TestFixture]
	public class GroupDayOffOptimizerValidateDayOffToAddTest
	{
		private IGroupDayOffOptimizerValidateDayOffToAdd _target;
		...
		public void Setup()
		{
			...
			_target = new GroupDayOffOptimizerValidateDayOffToAdd(_groupOptimizerFindMatrixesForGroup);
		...
		[Test]
		public void ShouldSuccessAndLockIfDayOff()
		{
			using (_mock.Record())
			{
				commonMocks();
