    ...
    public class OptimizationOverLimitByRestrictionDeciderTest
    {
		...
		public void VerifyPreferencesUnderLimitWhenNoPreferencesInPeriod()
		{
			...
			using (_mocks.Record())
			{
				...
				Expect.Call(_restrictionChecker.CheckPreference()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckPreference()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckPreference()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckPreference()).Return(PermissionState.None);
			}
		...
		public void VerifyMustHavesNoMustHavesInPeriod()
		{
			...
			using (_mocks.Record())
			{
				...
				Expect.Call(_restrictionChecker.CheckPreferenceMustHave()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckPreferenceMustHave()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckPreferenceMustHave()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckPreferenceMustHave()).Return(PermissionState.None);
			}
		...
		public void VerifyRotationNoRotationInPeriod()
		{
			...
			using (_mocks.Record())
			{
				...
				Expect.Call(_restrictionChecker.CheckRotations()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckRotations()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckRotations()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckRotations()).Return(PermissionState.None);
			}
		...
		public void VerifyAvailabilitiesIsUnderLimitIfNoAvailabilitiesInPeriod()
		{
			...
			using (_mocks.Record())
			{
				...
				Expect.Call(_restrictionChecker.CheckAvailability()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckAvailability()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckAvailability()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckAvailability()).Return(PermissionState.None);
			}
		...
		public void VerifyStudentAvailabilitiesIsUnderLimitIfNoStudentAvailabilitiesInPeriod()
		{
			...
			using (_mocks.Record())
			{
				...
				Expect.Call(_restrictionChecker.CheckStudentAvailability()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckStudentAvailability()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckStudentAvailability()).Return(PermissionState.None);
				Expect.Call(_restrictionChecker.CheckStudentAvailability()).Return(PermissionState.None);
			}
