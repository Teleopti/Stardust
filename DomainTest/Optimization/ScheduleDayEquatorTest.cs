...
namespace Teleopti.Ccc.DomainTest.Optimization
{
    ...
    public class ScheduleDayEquatorTest
    {
        ...
        public void ShouldMainShiftBeDifferentIfSameNumberOfLayerDifferentOrder()
        {
            ...
            Assert.AreEqual(2, personAssingment.MainShiftLayers.Count());
		...
		private static void setSameIdOnActivites(IScheduleDay scheduleDay1, IScheduleDay scheduleDay2)
		{
			...
			scheduleDay1.PersonAssignmentCollection()[0].MainShiftLayers.First().Payload.SetId(id1);
			scheduleDay2.PersonAssignmentCollection()[0].MainShiftLayers.First().Payload.SetId(id1);
			scheduleDay1.PersonAssignmentCollection()[0].MainShiftLayers.Last().Payload.SetId(id2);
			scheduleDay2.PersonAssignmentCollection()[0].MainShiftLayers.Last().Payload.SetId(id2);
		}
    }
}
