...
{
	public class BlockPreferenceProviderUsingFiltersTest
	{
		[Test]
		public void ShouldReturnRulesForContractFilter()
		{
			...
			new BlockPreferenceProviderUsingFilters(planningGroup.Settings).ForAgent(agent, new DateOnly(2000, 1, 1)).BlockTypeValue
