...
{
	[TestFixture]
	public class ScheduleMatrixLockableBitArrayConverterExTest
	{
		private IScheduleMatrixLockableBitArrayConverterEx _target;
		...
		public void Setup()
		{
			...
			_target = new ScheduleMatrixLockableBitArrayConverterEx();
		...
		public void VerifyConvert()
		{
			...
			{
				ret = _target.Convert(_matrix, false, false);
			}
		...
		public void VerifyConvertWeekBefore()
		{
			...
			using (_mocks.Playback())
			{
				ret = _target.Convert(_matrix, true, false);
			}
		...
		public void VerifyConvertWeekAfter()
		{
			...
			using (_mocks.Playback())
			{
				ret = _target.Convert(_matrix, false, true);
			}
		...
		public void VerifyConvertWeekBeforeAndAfter()
		{
			...
			using (_mocks.Playback())
			{
				ret = _target.Convert(_matrix, true, true);
			}
