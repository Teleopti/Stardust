...
{
    [TestFixture]
    public class RelativeDailyDifferencesByAllSkillsExtractorTest
    {
        private RelativeDailyDifferencesByAllSkillsExtractor _target;
        ...
        public void VerifyValueOneDay()
        {
            ...
            IList<double?> ret;
            _target = new RelativeDailyDifferencesByAllSkillsExtractor(period, _dailySkillForecastAndScheduledValueCalculator, _skillExtractor);
