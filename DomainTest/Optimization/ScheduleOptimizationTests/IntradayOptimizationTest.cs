...
namespace Teleopti.Ccc.DomainTest.Optimization.ScheduleOptimizationTests
{
	...
	public class IntradayOptimizationTest
	{
		...
		public IIntradayOptimizationCommandHandler TargetCommandHandler;
		...
		public void ShouldNotResolveWeeklyRestIfCommandSaysItShouldNotRun()
		{
			...
			TargetCommandHandler.Execute(new IntradayOptimizationCommand
			{
				Agents = PersonRepository.LoadAll(),
				Period = new DateOnlyPeriod(dateOnly, dateOnly.AddDays(6)),
