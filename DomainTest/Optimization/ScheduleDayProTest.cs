...
namespace Teleopti.Ccc.DomainTest.Optimization
{
    ...
    public class ScheduleDayProTest
    {
		...
		private ScheduleDictionaryForTest scheduleDictionary;
        ...
        public void Setup()
        {
			...
			scheduleDictionary = new ScheduleDictionaryForTest(scenario, scheduleDateTimePeriod, new Dictionary<IPerson, IScheduleRange>());
            ...
            _scheduleMatrix = ScheduleMatrixProFactory.Create(new DateOnlyPeriod(_day, _day), scheduleDictionary, _person, _schedulePeriod);
        ...
        public void TestConstructors()
        {
            ...
            Assert.AreEqual(scheduleDictionary[_person], _target.ActiveScheduleRange);
