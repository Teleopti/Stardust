...
namespace Teleopti.Ccc.DomainTest.Optimization
{
    ...
    public class GroupDayOffOptimizationServiceTest
    {
        ...
        public void Setup()
        {
            ...
            _target = new GroupDayOffOptimizationService(_periodValueCalculator, _schedulePartModifyAndRollbackService,
                                                         _resourceOptimizationHelper,
                                                         _groupOptimizerFindMatrixesForGroup, _daysOffPreferences);
        }
