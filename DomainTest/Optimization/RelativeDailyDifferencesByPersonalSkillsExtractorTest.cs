...
{
    [TestFixture]
    public class RelativeDailyDifferencesByPersonalSkillsExtractorTest
    {
        private RelativeDailyDifferencesByPersonalSkillsExtractor _target;
        ...
        public void VerifyValueOneDay()
        {
            ...
            IList<double?> ret;
            _target = new RelativeDailyDifferencesByPersonalSkillsExtractor(_matrix, _dailySkillForecastAndScheduledValueCalculator, _skillExtractor);
