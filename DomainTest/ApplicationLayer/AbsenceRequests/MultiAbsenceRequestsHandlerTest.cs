...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer.AbsenceRequests
{
	...
	[DomainTestWithStaticDependenciesAvoidUse]
	public class MultiAbsenceRequestsHandlerBUgTest : ISetup
	{
		public IPersonRequestRepository PersonRequestRepository;
		public IQueuedAbsenceRequestRepository QueuedAbsenceRequestRepository;
		public MultiAbsenceRequestsHandler Target;
		...
		[Test]
		public void KeepTheRequestPendingIfThereIsSqlExceptionWhileLoading()
		{
			var dateTimeNow = new DateTime(2016, 12, 01, 8, 0, 0, 2);
			var truncatedSent = new DateTime(2016, 12, 01, 8, 0, 0, 0);
			Now.Is(dateTimeNow);
		...
		[Test]
		public void ResetSentColumnIfThereIsSqlExceptionWhileLoading()
		{
			var dateTimeNow = new DateTime(2016, 12, 01, 8, 0, 0, 2);
			var truncatedSent = new DateTime(2016, 12, 01, 8, 0, 0, 0);
			Now.Is(dateTimeNow);
	...
	public class FakePersonAssignmentRepositoryThrowsLockException : IPersonAssignmentRepository
	{
		...
		{
			throw SqlExceptionConstructor.CreateSqlException("Deadlock exception", 14);
		}
