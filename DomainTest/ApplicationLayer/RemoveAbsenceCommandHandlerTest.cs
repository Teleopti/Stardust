...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer
{
	...
	public class RemovePersonAbsenceCommandHandlerTest
	{
		...
		public void Setup()
		{
			...
			var scheduleDifferenceSaver = new ScheduleDifferenceSaver(_scheduleStorage, new ThisUnitOfWork(new FakeUnitOfWork(new FakeStorageSimple())), new NoUpdateResourceCalculationReadmodel());
