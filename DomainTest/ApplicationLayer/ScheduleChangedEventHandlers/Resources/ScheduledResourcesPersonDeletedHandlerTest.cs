...
{
	[TestFixture]
	public class ScheduledResourcesPersonDeletedHandlerTest
	{
		private ScheduledResourcesPersonDeletedHandler _target;
		...
		public void Setup()
		{
			...
			_target = new ScheduledResourcesPersonDeletedHandler(new ScheduledResourcesReadModelUpdater(_storage, null, new ControllableEventSyncronization()), _readModelFinder, _skillRepository, _scenarioRepository);
		}

		[Test]
		public void ShouldHandlePersonWithSkillEfficiencyDeleted()
		{
			...
			_target.Handle(new PersonDeletedEvent
				{
					PersonId = _personId,
