...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer.ScheduleChangedEventHandlers.Resources
{
	...
	public class ScheduledResourcesPersonTerminatedHandlerTest
	{
		...
		public void Setup()
		{
			...
			_target = new ScheduledResourcesPersonTerminatedHandler(new ScheduledResourcesReadModelUpdater(_storage), _readModelFinder, _skillRepository, _scenarioRepository);
		}
