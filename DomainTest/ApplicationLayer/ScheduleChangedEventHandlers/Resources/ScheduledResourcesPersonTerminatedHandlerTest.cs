...
{
	[TestFixture]
	public class ScheduledResourcesPersonTerminatedHandlerTest
	{
		private ScheduledResourcesPersonTerminatedHandler _target;
		...
		public void Setup()
		{
			...
			_target = new ScheduledResourcesPersonTerminatedHandler(new ScheduledResourcesReadModelUpdater(_storage, null, new ControllableEventSyncronization()), _readModelFinder, _skillRepository, _scenarioRepository);
		}

		[Test]
		public void ShouldHandlePersonWithSkillEfficiencyTerminated()
		{
			...
			_target.Handle(new PersonTerminatedEvent
				{
					PersonId = _personId,
					TerminationDate = _date.Date.AddDays(2),
