...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer.ScheduleChangedEventHandlers.Resources
{
	...
	public class ScheduledResourcesPersonPeriodStartDateChangedHandlerTest
	{
		...
		public void Setup()
		{
			...
			_target = new ScheduledResourcesPersonPeriodStartDateChangedHandler(new ScheduledResourcesReadModelUpdater(_storage), _readModelFinder, _skillRepository, _scenarioRepository);
		}
