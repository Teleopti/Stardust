...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer.ScheduleChangedEventHandlers.Resources
{
	...
	public class ScheduledResourcesPersonPeriodRemovedHandlerTest
	{
		...
		public void Setup()
		{
			...
			_target = new ScheduledResourcesPersonPeriodRemovedHandler(new ScheduledResourcesReadModelUpdater(_storage), _readModelFinder, _skillRepository, _scenarioRepository);
		}
