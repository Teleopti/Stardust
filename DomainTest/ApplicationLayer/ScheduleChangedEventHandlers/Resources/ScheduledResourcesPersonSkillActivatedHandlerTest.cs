...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer.ScheduleChangedEventHandlers.Resources
{
	...
	public class ScheduledResourcesPersonSkillActivatedHandlerTest
	{
		...
		public void Setup()
		{
			...
			_target = new ScheduledResourcesPersonSkillActivatedHandler(new ScheduledResourcesReadModelUpdater(_storage), _readModelFinder, _skillRepository, _scenarioRepository);
		}
