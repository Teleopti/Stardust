...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer.ScheduleChangedEventHandlers.Resources
{
	...
	public class ScheduledResourcesPersonReactivatedHandlerTest
	{
		...
		public void Setup()
		{
			...
			_target = new ScheduledResourcesPersonReactivatedHandler(new ScheduledResourcesReadModelUpdater(_storage), _readModelFinder, _skillRepository, _scenarioRepository);
		}
