...
{
	[TestFixture]
	public class AnalyticsScheduleChangeUpdaterHangfireTest
	{
		private AnalyticsScheduleChangeUpdaterHangfire _target;
		...
		public void Setup()
		{
			...
			_target = new AnalyticsScheduleChangeUpdaterHangfire(
