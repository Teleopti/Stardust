...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer
{
	...
	public class AddFullDayAbsenceCommandHandlerTest
	{
		...
		public void Setup()
		{
			...
			var scheduleDifferenceSaver = new FakeScheduleDifferenceSaver_DoNotUse(_scheduleStorage);
		...
		public void ShouldConvertFromAgentsTimeZone()
		{
			...
			var personRepository = new FakeWriteSideRepository<IPerson>(null) { person };
