...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer.Rta
{
	...
	public class CalculateAdherenceTest
	{
		...
		public void ShouldProduceAModel()
		{
			...
			var target = new CalculateAdherence(new ThisIsNow(new DateTime(2014, 12, 24, 15, 0, 0)), new FakeAdherencePercentageReadModelReader(model), new ThreadCulture(), new UtcTimeZone());
		...
		public void ShouldResultIn50PercentWhenInAndOutOfAdherenceIsTheSame()
		{
			...
			var target = new CalculateAdherence(new ThisIsNow(now), new FakeAdherencePercentageReadModelReader(model), new ThreadCulture(), new UtcTimeZone());
		...
		public void ShouldResultInNullWhenNoAdherenceData()
		{
			...
			var target = new CalculateAdherence(new ThisIsNow("2014-12-24 11:00".Utc()), new FakeAdherencePercentageReadModelReader(model), new ThreadCulture(), new UtcTimeZone());
		...
		public void ShouldAddTimeInAdherenceBasedOnCurrentTime()
		{
			...
			var target = new CalculateAdherence(new ThisIsNow("2014-12-24 11:00"), new FakeAdherencePercentageReadModelReader(model), new ThreadCulture(), new UtcTimeZone());
		...
		public void ShouldFormatTimestamp()
		{
			...
			var target = new CalculateAdherence(new ThisIsNow("2014-12-24 15:00"), new FakeAdherencePercentageReadModelReader(model), new CatalanCulture(), new UtcTimeZone());
		...
		public void ShouldAdjustTimestampToUserTimeZone()
		{
			...
			var target = new CalculateAdherence(new ThisIsNow("2014-12-24 14:00"), new FakeAdherencePercentageReadModelReader(model), new ThreadCulture(), new HawaiiTimeZone());
