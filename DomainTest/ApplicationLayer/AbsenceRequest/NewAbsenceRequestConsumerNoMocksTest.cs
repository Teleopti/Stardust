...
namespace Teleopti.Ccc.DomainTest.ApplicationLayer.AbsenceRequest
{
	...
	public class NewAbsenceRequestHandlerNoMocksTest
	{
		...
		public void ShouldProcessWaitlistedRequestForSamePerson()
		{
			...
			newAbsenceRequestConsumer.Handle(new NewAbsenceRequestCreated() { PersonRequestId = newRequest.Id.Value });
		...
		public void ShouldNotUseWaitlistingWhenWorkflowControlSetIsNotAutoAcceptType()
		{
			...
			newAbsenceRequestHandler.Handle(new NewAbsenceRequestCreated() { PersonRequestId = newRequest.Id.Value });
		...
		private PersonRequest simpleRequestStatusTest(IProcessAbsenceRequest processAbsenceRequest, bool forcePersonalAccountUpdate = false, bool enableWaitlisting = false)
		{
			...
			newAbsenceRequestConsumer.Handle(new NewAbsenceRequestCreated() { PersonRequestId = request.Id.Value });
