...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.DayOffOptimization
{
	...
	public class DayOffOptimizationDayOffRulesTest : DayOffOptimizationScenario
	{
		...
		public void ShouldUseSettingForConsecutiveWorkDays()
		{
			...
			var planningPeriod = PlanningPeriodRepository.Has(firstDay, 1);
			var scenario = ScenarioRepository.Has("some name");
			PlanningGroupSettingsRepository.HasDefault(x => x.ConsecutiveWorkdays = new MinMax<int>(1, 6));
			var schedulePeriod = new SchedulePeriod(firstDay, SchedulePeriodType.Week, 1);
		...
		public void ShouldUseSettingForDayOffPerWeek_NotValid()
		{
			...
			var scenario = ScenarioRepository.Has("some name");
			PlanningGroupSettingsRepository.HasDefault(x => x.DayOffsPerWeek = new MinMax<int>(3, 4));
		...
		public DayOffOptimizationDayOffRulesTest(SeperateWebRequest seperateWebRequest, bool resourcePlannerDayOffOptimizationIslands47208, bool resourcePlannerDayOffUsePredictorEverywhere75667, bool resourcePlannerMinimumStaffing75339) : base(seperateWebRequest, resourcePlannerDayOffOptimizationIslands47208, resourcePlannerDayOffUsePredictorEverywhere75667, resourcePlannerMinimumStaffing75339)
		{
		}
	}
}