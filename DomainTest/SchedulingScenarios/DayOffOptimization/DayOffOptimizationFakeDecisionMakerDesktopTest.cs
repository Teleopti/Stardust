...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.DayOffOptimization
{
	...
	public class DayOffOptimizationFakeDecisionMakerDesktopTest : DayOffOptimizationScenario
	{
		...
		public void ShouldNotHangIfDecisionMakerReturnsTrueButBitArraysAreTheSame()
		{
			...
			Target.Execute(period, new[] { agent }, new NoSchedulingProgress(), optPrefs, new FixedDayOffOptimizationPreferenceProvider(dayOffPrefs), (o, args) => { }, new NoOptimizationCallback());
		...
		public DayOffOptimizationFakeDecisionMakerDesktopTest(SeperateWebRequest seperateWebRequest, RemoveImplicitResCalcContext removeImplicitResCalcContext, bool resourcePlannerDayOffOptimizationIslands47208) : base(seperateWebRequest, removeImplicitResCalcContext, resourcePlannerDayOffOptimizationIslands47208)
		{
		}
	}
}