...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.DayOffOptimization
{
	...
	public class DayOffOptimizationFakeDecisionMakerTest : DayOffOptimizationScenario
	{
		...
		public void ShouldNotHangIfDecisionMakerReturnsTrueButBitArraysAreTheSame()
		{
			...
			Target.Execute(period, new[] { agent }, new NoSchedulingProgress(), optPrefs, new FixedDayOffOptimizationPreferenceProvider(dayOffPrefs), new GroupPageLight("_", GroupPageType.SingleAgent), (o, args) => { });
