	...
	*/
	...
	public class DayOffOptimizationDesktopTest : DayOffOptimizationScenario
	{
		...
		public void ShouldNotMoveDayOffWhenUsingConsecutiveWorkDaysAndHavingDayOffPreference100Percent()
		{
			...
			Target.Execute(period, new[] { agent }, new NoSchedulingProgress(), optPrefs, new FixedDayOffOptimizationPreferenceProvider(dayOffPreferences), (o, args) => { });
		...
		public DayOffOptimizationDesktopTest(SeperateWebRequest seperateWebRequest, RemoveImplicitResCalcContext removeImplicitResCalcContext, bool resourcePlannerDayOffOptimizationIslands47208) : base(seperateWebRequest, removeImplicitResCalcContext, resourcePlannerDayOffOptimizationIslands47208)
		{
		}
	}
}