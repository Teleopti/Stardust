...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.DayOffOptimization
{
	...
	public class DayOffOptimizationRotationTest : DayOffOptimizationScenario
	{
		...
		[Test]
		public void ShouldRespectRotations()
		{
			...
			var personRotation = new PersonRotation(agent, new Rotation("_", 7), date,0);
			personRotation.Rotation.RotationDays[6].RestrictionCollection.First().DayOffTemplate = dayOffTemplate;
			...
			PersonRotationRepository.Has(personRotation);
		...
		public DayOffOptimizationRotationTest(ResourcePlannerTestParameters resourcePlannerTestParameters) : base(resourcePlannerTestParameters)
		{
		}
	}
}