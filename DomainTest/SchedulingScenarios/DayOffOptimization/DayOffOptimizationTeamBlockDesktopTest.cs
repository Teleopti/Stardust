...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.DayOffOptimization
{
	...
	public class DayOffOptimizationTeamBlockDesktopTest : DayOffOptimizationScenario
	{
		...
		public void ShouldCareAboutGroupType()
		{
			...
			Target.Execute(period, agents, new NoSchedulingProgress(), optPrefs, new FixedDayOffOptimizationPreferenceProvider(new DaysOffPreferences()), (o, args) => { }, new NoOptimizationCallback());
		...
		public void ShouldConsiderDayOffPreferences()
		{
			...
			Target.Execute(period, new[] { agents[0] }, new NoSchedulingProgress(), optPrefs, new FixedDayOffOptimizationPreferenceProvider(dayOffsPreferences), (o, args) => { }, new NoOptimizationCallback());
		...
		public DayOffOptimizationTeamBlockDesktopTest(SeperateWebRequest seperateWebRequest, RemoveImplicitResCalcContext removeImplicitResCalcContext, bool resourcePlannerDayOffOptimizationIslands47208) : base(seperateWebRequest, removeImplicitResCalcContext, resourcePlannerDayOffOptimizationIslands47208)
		{
		}
	}
}