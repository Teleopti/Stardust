...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.MaxSeat
{
	...
	public class MaxSeatOptimizationTest
	{
		...
		[Test, Ignore("40939")]
		public void ShouldBreakMaxSeatIfItIsLessBad()
		{
			var activity = new Activity("_") { RequiresSeat = true }.WithId();
			var site = new Site("_") { MaxSeats = 1 }.WithId();
			var dateOnly = DateOnly.Today;
			var scenario = new Scenario("_");
			var ruleSet = new WorkShiftRuleSet(new WorkShiftTemplateGenerator(activity, new TimePeriodWithSegment(8, 0, 9, 0, 60), new TimePeriodWithSegment(16, 0, 17, 0, 60), new ShiftCategory("_").WithId()));
			var agentScheduledAt8_1 = MaxSeatDataFactory.CreateAgentWithAssignment(dateOnly, site, new RuleSetBag(ruleSet), scenario, activity, new TimePeriod(8, 0, 9, 0));
			var agentScheduledAt8_2 = MaxSeatDataFactory.CreateAgentWithAssignment(dateOnly, site, new RuleSetBag(ruleSet), scenario, activity, new TimePeriod(8, 0, 9, 0));
			var agentScheduledAt9 = MaxSeatDataFactory.CreateAgentWithAssignment(dateOnly, site, new RuleSetBag(ruleSet), scenario, activity, new TimePeriod(9, 0, 10, 0));
			var agentData = MaxSeatDataFactory.CreateAgentWithAssignment(dateOnly, site, new RuleSetBag(ruleSet), scenario, activity, new TimePeriod(8, 0, 16, 0));
			var schedules = ScheduleDictionaryCreator.WithData(scenario, dateOnly.ToDateOnlyPeriod(), new[] { agentData.Assignment, agentScheduledAt8_1.Assignment, agentScheduledAt8_2.Assignment, agentScheduledAt9.Assignment });
			var optPrefs = new OptimizationPreferences { Shifts = { KeepShifts = true, KeepShiftsValue = 1d } };

			Target.Optimize(dateOnly.ToDateOnlyPeriod(), new[] { agentData.Agent }, schedules, scenario, optPrefs);
		...
		[Test, Ignore("40939")]
		public void ShouldNotChangeToWorseMaxSeat()
		{
			var activity = new Activity("_") { RequiresSeat = true }.WithId();
			var site = new Site("_") { MaxSeats = 1 }.WithId();
			var dateOnly = DateOnly.Today;
			var scenario = new Scenario("_");
			var ruleSet = new WorkShiftRuleSet(new WorkShiftTemplateGenerator(activity, new TimePeriodWithSegment(8, 0, 9, 0, 60), new TimePeriodWithSegment(16, 0, 17, 0, 60), new ShiftCategory("_").WithId()));
			var agentScheduledAt8 = MaxSeatDataFactory.CreateAgentWithAssignment(dateOnly, site, new RuleSetBag(ruleSet), scenario, activity, new TimePeriod(8, 0, 9, 0));
			var agentScheduledAt9_1 = MaxSeatDataFactory.CreateAgentWithAssignment(dateOnly, site, new RuleSetBag(ruleSet), scenario, activity, new TimePeriod(9, 0, 10, 0));
			var agentScheduledAt9_2 = MaxSeatDataFactory.CreateAgentWithAssignment(dateOnly, site, new RuleSetBag(ruleSet), scenario, activity, new TimePeriod(9, 0, 10, 0));
			var agentData = MaxSeatDataFactory.CreateAgentWithAssignment(dateOnly, site, new RuleSetBag(ruleSet), scenario, activity, new TimePeriod(8, 0, 16, 0));
			var schedules = ScheduleDictionaryCreator.WithData(scenario, dateOnly.ToDateOnlyPeriod(), new[] { agentData.Assignment, agentScheduledAt8.Assignment, agentScheduledAt9_1.Assignment, agentScheduledAt9_2.Assignment });
			var optPrefs = new OptimizationPreferences { Shifts = { KeepShifts = true, KeepShiftsValue = 1d } };
