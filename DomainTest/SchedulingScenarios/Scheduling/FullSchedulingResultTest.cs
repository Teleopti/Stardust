...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.Scheduling
{
	...
	public class FullSchedulingResultTest : SchedulingScenario
	{
		...
		public void ShouldShowAgentsWithNoScheduleAsNotScheduledEvenWithTolerance()
		{
			...
			SkillDayRepository.Has(skill.CreateSkillDaysWithDemandOnConsecutiveDays(scenario, firstDay, 1));
			var planningPeriod = PlanningPeriodRepository.Has(new DateOnlyPeriod(firstDay, firstDay.AddDays(6)));
		...
		public FullSchedulingResultTest(bool runInSeperateWebRequest, bool resourcePlannerEasierBlockScheduling46155, bool resourcePlannerRemoveClassicShiftCat46582) : base(runInSeperateWebRequest, resourcePlannerEasierBlockScheduling46155, resourcePlannerRemoveClassicShiftCat46582)
		{
		}
	}
}
