...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.Scheduling
{
	...
	public class SchedulingPlanningPeriodTest : SchedulingScenario
	{
		...
		public void ShouldOnlySchedulePeopleInPlanningGroup()
		{
			...
			var planningPeriod = new PlanningPeriod(period, new PlanningGroup().WithId().AddFilter(new TeamFilter(team)));
		...
		public SchedulingPlanningPeriodTest(bool runInSeperateWebRequest, bool resourcePlannerEasierBlockScheduling46155, bool resourcePlannerRemoveClassicShiftCat46582) : base(runInSeperateWebRequest, resourcePlannerEasierBlockScheduling46155, resourcePlannerRemoveClassicShiftCat46582)
		{
		}
	}
}