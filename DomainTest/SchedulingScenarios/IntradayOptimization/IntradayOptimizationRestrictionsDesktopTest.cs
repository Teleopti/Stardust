...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.IntradayOptimization
{
	...
	public class IntradayOptimizationRestrictionsDesktopTest : IntradayOptimizationScenarioTest
	{
		...
		[Test]
		public void ShouldRespectStartTimeTolerance_AdjustLatestEndWithinDay()
		{
			if(_resourcePlanner_BreakPreferenceStartTimeByMax_46002 == BreakPreferenceStartTimeByMax.DoNotConsiderBreakPreferenceStartTimeByMax) Assert.Ignore();
			var scenario = new Scenario("_");
			var phoneActivity = ActivityFactory.CreateActivity("_");
		...
		public IntradayOptimizationRestrictionsDesktopTest(BreakPreferenceStartTimeByMax resourcePlannerBreakPreferenceStartTimeByMax46002) : base(resourcePlannerBreakPreferenceStartTimeByMax46002)
		{
		}
	}
}