	...
	public class IntradayOptimizationCascadingDesktopTest : IntradayOptimizationScenarioTest
	{
		...
		public void ShouldKeepCalculatedLoggedOnValueWhenHavingOuterResContext()
		{
			...
			using (ResourceCalculationContextFactory.Create(schedulerStateHolderFrom.Schedules, schedulerStateHolderFrom.SchedulingResultState.Skills, false, date.ToDateOnlyPeriod()))
			{
				...
				Target.Optimize(new[] { agentAB, agentB }, date.ToDateOnlyPeriod(), new OptimizationPreferencesDefaultValueProvider().Fetch(), new NoIntradayOptimizationCallback());
		...
		public IntradayOptimizationCascadingDesktopTest(OptimizationCodeBranch resourcePlannerMergeTeamblockClassicIntraday45508, bool resourcePlannerSpeedUpShiftsWithinDay45694) : base(resourcePlannerMergeTeamblockClassicIntraday45508, resourcePlannerSpeedUpShiftsWithinDay45694)
		{
		}
	}
}