...
{
	[DomainTest]
	public class IntradayOptimizationTeamBlockForSingleAgentTeamAndSingleDayTest : ISetup
	{
		...
		public void ShouldNotRollBackIfSingleAgentSingleDayAndPeriodValueIsNotBetter()
		{
			...
			var skillDay = skill.CreateSkillDayWithDemandOnInterval(scenario, date, 0,
