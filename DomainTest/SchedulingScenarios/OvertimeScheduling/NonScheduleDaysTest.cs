...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.OvertimeScheduling
{
	...
	{
		public ScheduleOvertimeCommand Target;
		...
		public void ShouldNotPlaceOvertimeWhenResultGetsWorse()
		{
			...
			Target.Execute(overtimePreference, new NoSchedulingProgress(), new[] { stateHolder.Schedules[agentToSchedule].ScheduledDay(dateOnly) }, new GridlockManager());
