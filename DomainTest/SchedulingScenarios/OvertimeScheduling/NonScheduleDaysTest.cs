...
namespace Teleopti.Ccc.DomainTest.SchedulingScenarios.OvertimeScheduling
{
	...
	public class NonScheduleDaysTest
	{
		...
		public void ShouldPlaceOvertimeOnEmptyDayWithDemand()
		{
			...
			Target.Execute(overtimePreference, new NoSchedulingProgress(), new [] {stateHolder.Schedules[agent].ScheduledDay(dateOnly)}, new GridlockManager(), true);
		...
		public void ShouldConsiderWeeklyRest()
		{
			...
			Target.Execute(overtimePreference, new NoSchedulingProgress(), new[] { stateHolder.Schedules[agent].ScheduledDay(dateToSchedule) }, new GridlockManager(), true);
		...
		public void ShouldNotPlaceOvertimeWhenResultGetsWorse()
		{
			...
			Target.Execute(overtimePreference, new NoSchedulingProgress(), new[] { stateHolder.Schedules[agentToSchedule].ScheduledDay(dateOnly) }, new GridlockManager(), true);
