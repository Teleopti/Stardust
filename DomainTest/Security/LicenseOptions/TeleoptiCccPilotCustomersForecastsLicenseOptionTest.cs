...
{
    [TestFixture]
    public class TeleoptiCccPilotCustomersForecastsLicenseOptionTest
    {
        private TeleoptiCccPilotCustomersForecastsLicenseOption _target;

        [SetUp]
        public void Setup()
        {
            _target = new TeleoptiCccPilotCustomersForecastsLicenseOption();
        }
