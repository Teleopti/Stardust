...
{
    [TestFixture]
    public class TeleoptiCccPayrollIntegrationLicenseOptionTest
    {
        private TeleoptiCccPayrollIntegrationLicenseOption _target;

        [SetUp]
        public void Setup()
        {
            _target = new TeleoptiCccPayrollIntegrationLicenseOption();
        }
