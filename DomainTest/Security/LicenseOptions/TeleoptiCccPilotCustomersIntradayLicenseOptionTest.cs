...
{
    [TestFixture]
    public class TeleoptiCccPilotCustomersIntradayLicenseOptionTest
    {
        private TeleoptiCccPilotCustomersIntradayLicenseOption _target;

        [SetUp]
        public void Setup()
        {
            _target = new TeleoptiCccPilotCustomersIntradayLicenseOption();
        }
