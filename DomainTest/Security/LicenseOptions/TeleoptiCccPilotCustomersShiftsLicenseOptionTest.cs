...
{
    [TestFixture]
    public class TeleoptiCccPilotCustomersShiftsLicenseOptionTest
    {
        private TeleoptiCccPilotCustomersShiftsLicenseOption _target;

        [SetUp]
        public void Setup()
        {
            _target = new TeleoptiCccPilotCustomersShiftsLicenseOption();
        }
