...
{
    [TestFixture]
    public class TeleoptiCccPilotCustomersAgentPortalLicenseOptionTest
    {
        private TeleoptiCccPilotCustomersAgentPortalLicenseOption _target;

        [SetUp]
        public void Setup()
        {
            _target = new TeleoptiCccPilotCustomersAgentPortalLicenseOption();
        }
