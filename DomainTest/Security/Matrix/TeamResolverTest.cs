...
namespace Teleopti.Ccc.DomainTest.Security.Matrix
{
    ...
    public class TeamResolverForPersonAndApplicationRoleTest
    {
        ...
        public void Setup()
        {
            ...
            var siteRepository = MockRepository.GenerateStub<ISiteRepository>();
            siteRepository.Stub(s => s.LoadAll()).Return(_siteCollection);
            ...
            _target = new TeamResolver(_person,siteRepository);
