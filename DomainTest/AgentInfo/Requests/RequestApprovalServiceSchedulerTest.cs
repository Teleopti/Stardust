...
namespace Teleopti.Ccc.DomainTest.AgentInfo.Requests
{
    ...
    public class RequestApprovalServiceSchedulerTest
    {
        ...
        public void Setup()
        {
			...
			target = new RequestApprovalServiceScheduler(scheduleDictionary, scenario, swapAndModifyService, businessRules, scheduleDayChangeCallback, globalSettingDataRepository, new CheckingPersonalAccountDaysProvider(_personAbsenceAccountRepository), null);
        }
