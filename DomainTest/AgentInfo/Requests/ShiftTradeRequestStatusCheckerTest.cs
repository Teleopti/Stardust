...
namespace Teleopti.Ccc.DomainTest.AgentInfo.Requests
{
    ...
    public class ShiftTradeRequestStatusCheckerTest
    {
        ...
        public void VerifyChangedScheduleForOwnerRefersRequest()
        {
            ...
            Expect.Call(_scheduleRepository.FindSchedulesOnlyForGivenPeriodAndPersons(new[] { _person2, _person1 }, new ScheduleDictionaryLoadOptions(true, true), new DateOnlyPeriod(new DateOnly(_personRequest2.Request.Period.StartDateTime), new DateOnly(_personRequest2.Request.Period.EndDateTime.AddDays(1))), _scenario)).Return(_scheduleDictionary).IgnoreArguments();
            SetupSchedule();
