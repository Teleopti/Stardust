...
namespace Teleopti.Ccc.DomainTest.ResourceCalculation
{
	...
	public class SwapAndModifyServiceNewByFakeTest : ISetup
	{
		...
		public void ShouldFireEventsWithCorrectTrackedCommandInfoWhenSwapWithDayOff()
		{
			...
			var agent1 = PersonRepository.Has(new Contract("_"),new ContractSchedule("_"),new PartTimePercentage("_"),new Team { Site = new Site("site") },schedulePeriod,skill).InTimeZone(TimeZoneInfoFactory.StockholmTimeZoneInfo());
			var agent2 = PersonRepository.Has(new Contract("_"),new ContractSchedule("_"),new PartTimePercentage("_"),new Team { Site = new Site("site") },schedulePeriod,skill).InTimeZone(TimeZoneInfoFactory.StockholmTimeZoneInfo());
