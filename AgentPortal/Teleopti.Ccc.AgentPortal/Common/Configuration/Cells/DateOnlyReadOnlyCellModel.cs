...
namespace Teleopti.Ccc.AgentPortal.Common.Configuration.Cells
{
    ...
    /// </summary>
    public class DateOnlyReadOnlyCellModelRenderer : GridStaticCellRenderer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateOnlyReadOnlyCellModelRenderer"/> class.
        /// </summary>
        ...
        /// </remarks>
        public DateOnlyReadOnlyCellModelRenderer(GridControlBase grid, GridCellModelBase cellModel)
            : base(grid, cellModel)
        {
        }
