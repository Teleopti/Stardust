namespace Teleopti.Ccc.AgentPortal.Requests
{
	partial class PersonAccountView
	{
		...
		private void InitializeComponent()
		{
			...
			this.gridControlPersonAccounts.SerializeCellsBehavior =
			...
			this.gridControlPersonAccounts.RowsRemoving +=
				new Syncfusion.Windows.Forms.Grid.GridRangeRemovingEventHandler(this.gridControlPersonAccounts_RowsRemoving);
			// 
			...
			this.dateTimePickerAdvSelectedDate.Calendar.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F,
			...
			this.dateTimePickerAdvSelectedDate.Calendar.HeaderEndColor = System.Drawing.Color.FromArgb(((int) (((byte) (231)))),
			                                                                                           ((int) (((byte) (242)))),
			                                                                                           ((int) (((byte) (255)))));
			...
			this.dateTimePickerAdvSelectedDate.Calendar.HeaderStartColor = System.Drawing.Color.FromArgb(
				((int) (((byte) (179)))), ((int) (((byte) (209)))), ((int) (((byte) (252)))));
			...
			this.dateTimePickerAdvSelectedDate.Calendar.Size = new System.Drawing.Size(198, 174);
			...
			this.dateTimePickerAdvSelectedDate.Calendar.WeekInterior =
				new Syncfusion.Drawing.BrushInfo(Syncfusion.Drawing.GradientStyle.Vertical, System.Drawing.Color.PeachPuff,
				                                 System.Drawing.Color.AntiqueWhite);
			// 
			// 
			// 
			this.dateTimePickerAdvSelectedDate.Calendar.NoneButton.Appearance =
				Syncfusion.Windows.Forms.ButtonAppearance.Office2007;
			this.dateTimePickerAdvSelectedDate.Calendar.NoneButton.Location = new System.Drawing.Point(126, 0);
			...
			// 
			// 
			this.dateTimePickerAdvSelectedDate.Calendar.TodayButton.Appearance =
				Syncfusion.Windows.Forms.ButtonAppearance.Office2007;
			this.dateTimePickerAdvSelectedDate.Calendar.TodayButton.Location = new System.Drawing.Point(0, 0);
			this.dateTimePickerAdvSelectedDate.Calendar.TodayButton.Size = new System.Drawing.Size(198, 20);
			...
			this.dateTimePickerAdvSelectedDate.Calendar.Click +=
				new System.EventHandler(this.dateTimePickerAdvSelectedDate_Calendar_Click);
			this.dateTimePickerAdvSelectedDate.CalendarTitleBackColor = System.Drawing.Color.FromArgb(((int) (((byte) (179)))),
			                                                                                          ((int) (((byte) (209)))),
			                                                                                          ((int) (((byte) (252)))));
			...
			this.dateTimePickerAdvSelectedDate.UseCurrentCulture = true;
			this.dateTimePickerAdvSelectedDate.Value = new System.DateTime(2010, 2, 11, 15, 15, 38, 986);
			this.dateTimePickerAdvSelectedDate.ValueChanged +=
				new System.EventHandler(this.dateTimePickerAdvSelectedDate_ValueChanged);
			...
			// 
			this.autoLabelDateSelection.Anchor =
