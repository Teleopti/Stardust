...
"C:\Program Files (x86)\Teleopti\ApplicationConfiguration\CccAppConfig.exe" -DSlocalhost -DDTeleoptiCCC -DUteleopticcc -DPteleopticcc -TZ"W. Europe Standard Time" -BUACME -CUen-GB
rem Finished
pause
