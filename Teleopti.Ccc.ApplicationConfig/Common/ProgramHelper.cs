...
namespace Teleopti.Ccc.ApplicationConfig.Common
{
    ...
    public class ProgramHelper
    {
        ...
        {
			InitializeApplication initializeApplication = new InitializeApplication(new DataSourcesFactory(new EnversConfiguration(), new List<IDenormalizer>(), new DataSourceConfigurationSetter(false, false, null)),
