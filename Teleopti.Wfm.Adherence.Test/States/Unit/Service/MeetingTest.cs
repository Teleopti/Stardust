...
namespace Teleopti.Wfm.Adherence.Test.States.Unit.Service
{
	...
	public class MeetingTest
	{
		...
		public void ShouldPersistMeeting()
		{
			...
			Database
				.WithMappedRule("training", training, 0, Domain.Configuration.Adherence.In)
				.WithMappedRule("training", phone, -1, Domain.Configuration.Adherence.Out)
				.WithMappedRule("training", null, -1, Domain.Configuration.Adherence.Out)
				.WithMappedRule("phone", phone, 0, Domain.Configuration.Adherence.In)
				.WithMappedRule("phone", training, -1, Domain.Configuration.Adherence.Out)
				.WithMappedRule("phone", null, -1, Domain.Configuration.Adherence.Out)
				.WithMappedRule(null, phone, -1, Domain.Configuration.Adherence.Out)
				.WithMappedRule(null, training, -1, Domain.Configuration.Adherence.Out)
