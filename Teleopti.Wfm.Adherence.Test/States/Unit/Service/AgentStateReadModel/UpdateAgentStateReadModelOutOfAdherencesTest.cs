	...
	public class UpdateAgentStateReadModelOutOfAdherencesTest
	{
		...
		public void ShouldPersistOutOfAdherence()
		{
			...
			Database
				...
				.WithMappedRule("out", phone, -1, Domain.Configuration.Adherence.Out);
		...
		public void ShouldPersistOutOfAdherences()
		{
			...
			Database
				...
				.WithMappedRule("out", phone, -1, Domain.Configuration.Adherence.Out)
				.WithMappedRule("ready", phone, 0, Domain.Configuration.Adherence.In);
		...
		public void ShouldExcludeOutOfAdherencesEndingOverAnHourAgo()
		{
			...
			Database
				...
				.WithMappedRule("out", phone, -1, Domain.Configuration.Adherence.Out)
				.WithMappedRule("ready", phone, 0, Domain.Configuration.Adherence.In)
				.WithMappedRule("incall", phone, 0, Domain.Configuration.Adherence.In);
