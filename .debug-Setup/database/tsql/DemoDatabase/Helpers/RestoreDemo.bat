...
SET CS=Data Source=%INSTANCE%;User Id=%SQLLogin%;Password=%SQLPwd%
"%INSTALLDIR%\DatabaseInstaller\Enrypted\Teleopti.Support.Security.exe" -DS%INSTANCE% -AP"%TELEOPTICCC%" -AN"%TELEOPTIANALYTICS%" -CD"%TELEOPTIAGG%" -CS"%CS%" %SA2% >> "%ROOTDIR%\..\patchDB.log"
