...
namespace Teleopti.Ccc.Sdk.ServiceBus.TeleoptiRtaService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="TeleoptiRtaService.ITeleoptiRtaService")]
    public interface ITeleoptiRtaService {
        ...
        void GetUpdatedScheduleChange(System.Guid personId, System.Guid businessUnitId, System.DateTime timestamp);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITeleoptiRtaServiceChannel : Teleopti.Ccc.Sdk.ServiceBus.TeleoptiRtaService.ITeleoptiRtaService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TeleoptiRtaServiceClient : System.ServiceModel.ClientBase<Teleopti.Ccc.Sdk.ServiceBus.TeleoptiRtaService.ITeleoptiRtaService>, Teleopti.Ccc.Sdk.ServiceBus.TeleoptiRtaService.ITeleoptiRtaService {
        ...
        public int SaveBatchExternalUserState(string authenticationKey, string platformTypeId, string sourceId, Teleopti.Ccc.Sdk.ServiceBus.TeleoptiRtaService.ExternalUserState[] externalUserStateBatch) {
            return base.Channel.SaveBatchExternalUserState(authenticationKey, platformTypeId, sourceId, externalUserStateBatch);
        }
        
        public void GetUpdatedScheduleChange(System.Guid personId, System.Guid businessUnitId, System.DateTime timestamp) {
            base.Channel.GetUpdatedScheduleChange(personId, businessUnitId, timestamp);
        }
    }
}
