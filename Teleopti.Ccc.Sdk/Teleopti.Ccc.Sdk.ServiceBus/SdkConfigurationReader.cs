...
namespace Teleopti.Ccc.Sdk.ServiceBus
{
	public class SdkConfigurationReader : IConfigurationReader
	{
		...
		public void ReadConfiguration(MessageSenderCreator creator, Func<IMessageBrokerComposite> messageBroker)
		{
			...
			var path = wrapper.AppSettings["NhibPath"];
			lock (LockObject)
			{
				...
				application.Start(new BasicState(), path, null, new ConfigurationManagerWrapperInternal(encryptedAppSettings), true);
	...
	class ConfigurationManagerWrapperInternal : IConfigurationWrapper
	{
		public ConfigurationManagerWrapperInternal(IDictionary<string, string> appSettings)
		{
