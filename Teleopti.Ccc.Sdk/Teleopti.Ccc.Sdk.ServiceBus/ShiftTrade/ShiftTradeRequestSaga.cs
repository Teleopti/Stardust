...
namespace Teleopti.Ccc.Sdk.ServiceBus.ShiftTrade
{
	...
	{
		private static readonly ILog Logger = LogManager.GetLogger(typeof(ShiftTradeRequestSaga));
		...
		public ShiftTradeRequestSaga(ICurrentUnitOfWorkFactory unitOfWorkFactory, ISchedulingResultStateHolderProvider schedulingResultStateHolderProvider, IShiftTradeValidator validator, IRequestFactory requestFactory, ICurrentScenario scenarioRepository, IPersonRequestRepository personRequestRepository, IScheduleStorage scheduleStorage, IPersonRepository personRepository, IPersonRequestCheckAuthorization personRequestCheckAuthorization, IScheduleDifferenceSaver scheduleDictionarySaver, ILoadSchedulesForRequestWithoutResourceCalculation loadSchedulingDataForRequestWithoutResourceCalculation, IDifferenceCollectionService<IPersistableScheduleData> differenceService)
		{
