...
{
    /// <summary>
	/// This command adds a new person period to an existing <see cref="IPerson"/> and updates the <see cref="IPerson"/> with new details or creates a new <see cref="IPerson"/> if the Id of <see cref="PersonDto"/> is set to null. The person period is created according to the specified <see cref="Period"/>, <see cref="PersonContract"/> and <see cref="Team"/>. 
    /// </summary>
    ...
    {  
        /// <summary>
		/// Gets or sets the mandatory person. The entire <see cref="PersonDto"/> is required as the details are used to update or create a <see cref="IPerson"/>.
        /// </summary>
        ...
        /// <remarks>Currently only the start date is used, as it will be the start date of the <see cref="IPersonPeriod"/>.</remarks>
        [DataMember(IsRequired = true)]
