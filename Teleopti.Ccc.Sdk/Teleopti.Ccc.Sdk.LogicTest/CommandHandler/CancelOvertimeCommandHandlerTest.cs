...
namespace Teleopti.Ccc.Sdk.LogicTest.CommandHandler
{
    ...
    public class CancelOvertimeCommandHandlerTest
    {
        ...
        public void Setup()
        {
			...
			_target = new CancelOvertimeCommandHandler(_dateTimePeriodAssembler, _scheduleTagAssembler, _scheduleRepository, _personRepository, _scenarioRepository, _currentUnitOfWorkFactory, _businessRulesForPersonalAccountUpdate, _scheduleSaveHandler);
