...
namespace Teleopti.Ccc.Sdk.LogicTest.CommandHandler
{
	...
	public class CancelPersonalActivityCommandHandlerTest
	{
		...
		public void Setup()
		{
			...
			_target = new CancelPersonalActivityCommandHandler(_dateTimePeriodAssembler, _scheduleTagAssembler, _scheduleRepository, _personRepository, _scenarioRepository, _currentUnitOfWorkFactory, _saveSchedulePartService, _messageBrokerEnablerFactory, _businessRulesForPersonalAccountUpdate);
		...
		public void ShouldCancelPersonalActivitySuccessfully()
		{
			...
			scheduleDay.PersonAssignment().AddPersonalLayer(_activity, _period);
			...
			using (_mock.Record())
			{
				...
				Expect.Call(_scheduleRepository.FindSchedulesOnlyForGivenPeriodAndPerson(null, null, new DateOnlyPeriod(), _scenario)).
			...
			using (_mock.Playback())
			{
				...
				scheduleDay.PersonAssignment().PersonalLayers().Should().Be.Empty();
			}
		}
