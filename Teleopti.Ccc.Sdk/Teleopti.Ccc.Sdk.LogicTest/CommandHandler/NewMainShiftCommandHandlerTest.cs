...
namespace Teleopti.Ccc.Sdk.LogicTest.CommandHandler
{
    ...
    public class NewMainShiftCommandHandlerTest
    {
        ...
        public void Setup()
        {
	        ...
	        period.LocalStartDateTime = dtp.StartDateTimeLocal(TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.Regional.TimeZone);
	        period.LocalEndDateTime = dtp.EndDateTimeLocal(TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.Regional.TimeZone);
