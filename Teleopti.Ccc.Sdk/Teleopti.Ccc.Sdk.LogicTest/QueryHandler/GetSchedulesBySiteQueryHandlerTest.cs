...
namespace Teleopti.Ccc.Sdk.LogicTest.QueryHandler
{
	...
	public class GetSchedulesBySiteQueryHandlerTest
	{
		...
		public void Setup()
		{
			...
			target = new GetSchedulesBySiteQueryHandler(unitOfWorkFactory,scheduleRepository,personRepository,scenarioRepository,siteRepository,dateTimePeriodAssembler,scheduleDayAssembler);
		}
