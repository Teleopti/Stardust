...
namespace Teleopti.Ccc.Sdk.LogicTest.QueryHandler
{
	...
	public class GetValidatedSchedulePartsForStudentAvailabilityQueryHandlerTest
	{
		...
		public void Setup()
		{
			...
			target = new GetValidatedSchedulePartsForStudentAvailabilityQueryHandler(unitOfWorkFactory, shiftCategoryRepository, activityRepository, personRepository, scheduleStorage, scenarioRepository, preferenceDayAssembler, studentAvailabilityDayAssembler, workShiftWorkTime);
		}
		...
		public void ShouldGetValidatedSchedulePartsForStudentAvailability()
		{
			...
			{
				var result = target.Handle(new GetValidatedSchedulePartsForStudentAvailabilityQueryDto { DateInPeriod = new DateOnlyDto { DateTime = date.Date }, Person = personDto, TimeZoneId = "W. Europe Standard Time" });
		...
		public void ShouldGetValidatedSchedulePartsForStudentAvailabilityWithValidShiftBag()
		{
			...
			{
				var result =
					target.Handle(new GetValidatedSchedulePartsForStudentAvailabilityQueryDto
						{
