...
namespace Teleopti.Ccc.Sdk.LogicTest.QueryHandler
{
	...
	public class GetSchedulesByTeamQueryHandlerTest
	{
		...
		public void Setup()
		{
			...
			target = new GetSchedulesByTeamQueryHandler(unitOfWorkFactory,scheduleRepository,personRepository,scenarioRepository,dateTimePeriodAssembler,scheduleDayAssembler);
		}
		...
		public void ShouldGetScheduleForTeamInGivenScenario()
		{
			...
			{
				var result =
					target.Handle(new GetSchedulesByTeamQueryHandlerDto
					              	{
		...
		public void ShouldNotGetScheduleForTeamUsingInvalidScenarioId()
		{
			...
			using (mocks.Playback())
			{
				Assert.Throws<FaultException>(()=>target.Handle(new GetSchedulesByTeamQueryHandlerDto
					{
						StartDate = new DateOnlyDto { DateTime = new DateTime(2012, 5, 2) },
						EndDate = new DateOnlyDto { DateTime = new DateTime(2012, 5, 2) },
						ScenarioId = scenarioId,
