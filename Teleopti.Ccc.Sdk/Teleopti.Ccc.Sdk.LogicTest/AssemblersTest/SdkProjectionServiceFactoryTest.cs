...
namespace Teleopti.Ccc.Sdk.LogicTest.AssemblersTest
{
	...
	public class SdkProjectionServiceFactoryTest
	{
		...
		public void Setup()
		{
			...
			var dic = new ScheduleDictionary(scenario, new ScheduleDateTimePeriod(new DateTimePeriod(1900, 1, 1, 2200, 1, 1)), new PersistableScheduleDataPermissionChecker(new PermissionProvider(PrincipalAuthorization.Current())), PrincipalAuthorization.Current());
