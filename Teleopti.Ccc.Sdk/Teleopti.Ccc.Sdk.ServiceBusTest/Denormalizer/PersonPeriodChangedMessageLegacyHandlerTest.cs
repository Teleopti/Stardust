...
{
	[TestFixture]
	public class PersonPeriodChangedMessageLegacyHandlerTest
	{
		[Test]
		public void ShouldHandleLegacyMessage()
		{
			...
			var handler = new PublishPersonPeriodCollectionChangedFromLegacyPersonPeriodChangedMessage(publisher, currentUnitOfWorkFactory);
			var legacyMessage = new PersonPeriodChangedMessage();
