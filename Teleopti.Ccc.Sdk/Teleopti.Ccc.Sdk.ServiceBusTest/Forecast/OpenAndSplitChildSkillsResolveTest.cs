...
{
	[TestFixture]
	public class OpenAndSplitChildSkillsResolveTest
	{
		...
		public void ShouldResolveNewAbsenceRequestConsumer()
		{
			...
			builder.RegisterType<OpenAndSplitChildSkillsConsumer>().As<ConsumerOf<OpenAndSplitChildSkills>>();
			...
			{
				container.Resolve<ConsumerOf<OpenAndSplitChildSkills>>().Should().Not.Be.Null();
			}
		}
	}
}