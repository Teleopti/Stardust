...
namespace Teleopti.Ccc.Sdk.WcfService.Factory
{
    internal static class AnalyticsReportsFactory
    {
        ...
        internal static ICollection<MatrixReportInfoDto> Create()
        {
            ...
            var appFuncList = PrincipalAuthorization.Instance().GrantedFunctionsBySpecification(null, new ExternalApplicationFunctionSpecification(DefinedForeignSourceNames.SourceMatrix));
