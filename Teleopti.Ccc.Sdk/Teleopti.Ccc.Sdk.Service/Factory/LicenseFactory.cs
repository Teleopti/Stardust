...
namespace Teleopti.Ccc.Sdk.WcfService.Factory
{
	public class LicenseFactory : ILicenseFeedback
	{
		...
		public LicenseVerificationResultDto VerifyLicense(IUnitOfWorkFactory unitOfWorkFactory, string tenant)
		{
			...
			if (_licenseVerificationResultDto != null) return _licenseVerificationResultDto;
			...
			if (licenseService != null)
			{
				...
				_licenseVerificationResultDto.LicenseHolderName = DefinedLicenseDataFactory.GetLicenseActivator(unitOfWorkFactory.Name).CustomerName;
			}
