...
{
	public class GetSchedulesByTeamQueryHandler : IHandleQuery<GetSchedulesByTeamQueryHandlerDto, ICollection<SchedulePartDto>>
	{
		...
		public ICollection<SchedulePartDto> Handle(GetSchedulesByTeamQueryHandlerDto query)
		{
		...
		private IScenario GetGivenScenarioOrDefault(GetSchedulesByTeamQueryHandlerDto query)
		{
			IScenario scenario;
