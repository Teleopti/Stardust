...
ECHO ROBOCOPY "\\gigantes\Customer Databases\CCC\RestoreToLocal\Baselines\7zip" "%Zip7Folder%" /MIR
ROBOCOPY "\\gigantes\Customer Databases\CCC\RestoreToLocal\Baselines\7zip" "%Zip7Folder%" /MIR
...
TYPE "\\gigantes\Customer Databases\CCC\RestoreToLocal\Baselines\Databases.txt"
ECHO.
ECHO ---
...
XCOPY "\\gigantes\Customer Databases\CCC\RestoreToLocal\Baselines\%AppRar%" "%RarFolder%\" /D /Y > "%temp%\NumberOfFiles.txt"
...
XCOPY "\\gigantes\Customer Databases\CCC\RestoreToLocal\Baselines\%StatRar%" "%RarFolder%\" /D /Y > "%temp%\NumberOfFiles.txt"
) ELSE (
GOTO SkipStat
)
