...
SELECT @XpCommand='"C:\Data\RaptorScrum\Root-Azure\Database\DBManager.exe" -S. -DTeleoptiCCC7_Demo -OTeleoptiCCC7 -E -T'
exec xp_cmdshell @XpCommand

--encrypt local pwd
SELECT @XpCommand='"C:\Data\RaptorScrum\Root-Azure\Database\Tools\Encryption\Teleopti.Support.Security.exe" -DS. -DDTeleoptiCCC7_Demo -EE'
exec xp_cmdshell @XpCommand
