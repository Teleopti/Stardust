...
DELETE FROM TeleoptiApp_Demo.dbo.AuthenticationInfo

--insert current user and connect to @userid
INSERT INTO TeleoptiApp_Demo.dbo.AuthenticationInfo
SELECT
	Person=@userid,
	[Identity]=@csv
...
delete from TeleoptiAgg_Demo.dbo.agent_logg where date_from > @TemplateEndDate --unwanted days after template period
...
BEGIN
	...
	insert into TeleoptiAgg_Demo.dbo.agent_logg
	select
	queue,
