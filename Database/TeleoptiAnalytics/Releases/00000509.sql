...
ALTER PROCEDURE [mart].[raptor_number_of_calls_per_agent_by_date] 
@threshold int,
...
ALTER PROCEDURE [mart].[raptor_adherence_per_agent_by_date]
@local_date smalldatetime,
...
ALTER PROCEDURE [mart].[raptor_AHT_per_agent_by_date] 
@threshold int,
@time_zone_code nvarchar(50),
@local_date smalldatetime, 
@business_unit_code uniqueidentifier
