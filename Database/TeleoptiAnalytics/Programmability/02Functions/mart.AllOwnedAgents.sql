...
CREATE FUNCTION [mart].[AllOwnedAgents](@person_code uniqueidentifier,@report_id int, @business_unit_code uniqueidentifier = '00000000-0000-0000-0000-000000000000')
