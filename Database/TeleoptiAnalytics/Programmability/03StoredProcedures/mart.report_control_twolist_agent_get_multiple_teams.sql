IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[mart].[report_control_twolist_agent_get_multiple_teams]') AND type in (N'P', N'PC'))
DROP PROCEDURE [mart].[report_control_twolist_agent_get_multiple_teams]
GO
...
CREATE PROC [mart].[report_control_twolist_agent_get_multiple_teams]
@date_from		datetime,
@date_to		datetime,
@site_id		int,
