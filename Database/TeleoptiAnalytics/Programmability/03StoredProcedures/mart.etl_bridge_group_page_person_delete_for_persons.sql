IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[mart].[etl_bridge_group_page_person_delete_for_persons]') AND type in (N'P', N'PC'))
DROP PROCEDURE [mart].[etl_bridge_group_page_person_delete_for_persons]
GO

-- =============================================
-- Description:	Delete given people in a specific group page
-- =============================================
CREATE PROCEDURE [mart].[etl_bridge_group_page_person_delete_for_persons]
