...
BEGIN
	...
	join (select person_id from [mart].[dim_person] 
			where person_period_code = @person_period_code AND business_unit_code=@business_unit_code) person
		on bgpp.person_id = person.person_id
