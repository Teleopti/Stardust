...
SELECT         f.shift_startdate_local_id,d.date_id, i.interval_id, f.person_id, f.activity_starttime, f.scenario_id, f.activity_id, f.absence_id, f.scheduled_time_m, f.shift_category_id, f.scheduled_contract_time_m, f.scheduled_paid_time_m, 
                         f.scheduled_ready_time_m, f.scheduled_over_time_m, f.scheduled_work_time_m, f.scheduled_contract_time_absence_m, f.business_unit_id, f.overtime_id, f.planned_overtime_m
...
WHERE        (tz.time_zone_id =
                             (SELECT        TOP (1) b.time_zone_id
                               WHERE        (tz.default_zone = 1)))
GO