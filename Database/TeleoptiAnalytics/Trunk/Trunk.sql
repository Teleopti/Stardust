...
-- Description: Gets the agent whose AHT under @threshold during @Date
-- =============================================
-- EXEC [mart].[raptor_AHT_per_agent_by_date] @threshold=120, @local_date='2014-07-10'
...
-- Update date: 
-- Description:	Used to get adherence for specific day
-- ====================================================

/* 
EXEC [mart].[raptor_adherence_per_agent_by_date]
     @threshold=0.58, -- 58%
