...
BEGIN
	...
	INSERT INTO mart.report_control_collection(Id, ControlId, CollectionId, control_collection_id, collection_id, print_order, control_id, default_value, control_name_resource_key, fill_proc_param, param_name, depend_of1, depend_of2, depend_of3, depend_of4, DependOf1, DependOf2, DependOf3, DependOf4)
	SELECT 'ED0014EB-CF18-4262-A044-CF05BD693D28',mart.report_control.Id,'22AF82E4-E0E0-44DE-8AD5-82768F74E6C1',455,42,5,3,'-2','ResSiteNameColon',NULL,'@site_id',451,452,453,NULL,'7D02E87F-FC1C-4386-993C-5252526F6201','5B67EF62-5211-49D3-AB35-F9B40CAA67DD','3C2F6E27-751C-409E-830C-C229BDABB199',NULL
	FROM mart.report_control WHERE control_id=3

	INSERT INTO mart.report_control_collection(Id, ControlId, CollectionId, control_collection_id, collection_id, print_order, control_id, default_value, control_name_resource_key, fill_proc_param, param_name, depend_of1, depend_of2, depend_of3, depend_of4, DependOf1, DependOf2, DependOf3, DependOf4)
	SELECT '0E8E1C3D-43C5-41A4-9EF7-0357F7AB0D60',mart.report_control.Id,'22AF82E4-E0E0-44DE-8AD5-82768F74E6C1',456,42,6,34,'-99','ResTeamNameColon',NULL,'@team_set',451,452,453,455,'7D02E87F-FC1C-4386-993C-5252526F6201','5B67EF62-5211-49D3-AB35-F9B40CAA67DD','3C2F6E27-751C-409E-830C-C229BDABB199','ED0014EB-CF18-4262-A044-CF05BD693D28'
	FROM mart.report_control WHERE control_id=34

	INSERT INTO mart.report_control_collection(Id, ControlId, CollectionId, control_collection_id, collection_id, print_order, control_id, default_value, control_name_resource_key, fill_proc_param, param_name, depend_of1, depend_of2, depend_of3, depend_of4, DependOf1, DependOf2, DependOf3, DependOf4)
	SELECT 'F2DACAEB-5596-4839-B7BA-6258F27D83CF',mart.report_control.Id,'22AF82E4-E0E0-44DE-8AD5-82768F74E6C1',457,42,7,36,'-2','ResAgentsColon',NULL,'@agent_person_code',451,452,455,456,'7D02E87F-FC1C-4386-993C-5252526F6201','5B67EF62-5211-49D3-AB35-F9B40CAA67DD','ED0014EB-CF18-4262-A044-CF05BD693D28','0E8E1C3D-43C5-41A4-9EF7-0357F7AB0D60'
	FROM mart.report_control WHERE control_id=36

	INSERT INTO mart.report_control_collection(Id, ControlId, CollectionId, control_collection_id, collection_id, print_order, control_id, default_value, control_name_resource_key, fill_proc_param, param_name, depend_of1, depend_of2, depend_of3, depend_of4, DependOf1, DependOf2, DependOf3, DependOf4)
	SELECT 'D980BE85-A32D-42C4-87D4-9852EE2ED41F',mart.report_control.Id,'22AF82E4-E0E0-44DE-8AD5-82768F74E6C1',458,42,8,21,6,'ResSortByColon',NULL,'@sort_by',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
	FROM mart.report_control WHERE control_id=21
	
	INSERT INTO mart.report_control_collection(Id, ControlId, CollectionId, control_collection_id, collection_id, print_order, control_id, default_value, control_name_resource_key, fill_proc_param, param_name, depend_of1, depend_of2, depend_of3, depend_of4, DependOf1, DependOf2, DependOf3, DependOf4)
	SELECT 'F0AC9AAC-D6F0-4D9E-B88B-6AD54610EFF2',mart.report_control.Id,'22AF82E4-E0E0-44DE-8AD5-82768F74E6C1',459,42,9,22,'-95','ResTimeZoneColon',NULL,'@time_zone_id',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
