IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ReadModel].[PersonFinderWithCriteriaAndTeams]')
...
-- =============================================
CREATE PROCEDURE [ReadModel].[PersonFinderWithCriteriaAndTeams]
...
INSERT INTO #TeamId
SELECT * FROM dbo.SplitStringString(@teamIds)
