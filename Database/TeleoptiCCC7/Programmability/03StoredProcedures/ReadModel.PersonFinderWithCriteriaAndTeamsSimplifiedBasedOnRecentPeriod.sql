IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ReadModel].[PersonFinderWithCriteriaAndTeamsSimplifiedBasedOnRecentPeriod]')
   AND type in (N'P', N'PC'))
DROP PROCEDURE [ReadModel].[PersonFinderWithCriteriaAndTeamsSimplifiedBasedOnRecentPeriod]
GO

-- exec [ReadModel].[PersonFinderWithCriteriaAndTeamsSimplifiedBasedOnRecentPeriod] N'FirstName:Ash,LastName:an', '2017-02-14 00:00:00', N'0a1cdb27-bc01-4bb9-b0b3-9b5e015ab495,e5f968d7-6f6d-407c-81d5-9b5e015ab495,d7a9c243-8cd8-406e-9889-9b5e015ab495,7f38bb91-d33b-4f5b-8161-9b5e015ab495,34590a63-6331-4921-bc9f-9b5e015ab495,e7ce8892-4db3-49c8-bdf6-9b5e015ab495'
-- =============================================
-- Author:      Chundan
-- Create date: 2017-07-03
-- Description: Gets the person(s) match search criteria and teams specified in the ReadModel (AND-search) in the most recent period, Based on ReadModel.PersonFinder 
-- Change Log
------------------------------------------------
-- When         Who       What
