...
--Name: Tamasb
--Date: 2012-11-26  
--Desc: Bugfix reAdd the following new application function: AdminWeb
...
--Name: tamasb
--Date: 2012-11-28  
--Desc: Add the following new application function to AdminWeb: Schedules
--Note: The application function has been once added in v. 378.sql, but there the parent's foreignid was already occupied, so the application function
--      was not added but with a wrong parent. Adding the function again will correct that bug
----------------  
SET NOCOUNT ON
