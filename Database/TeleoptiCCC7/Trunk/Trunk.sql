...
--Name: Xinfeng Li
--Date: 2014-09-25
--Desc: Add new application function "View badge leader board"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0102' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ViewBadgeLeaderboard' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxViewBadgeLeaderboard' --Description of the function > hardcoded
