...
--Name: Mingdi
--Date: 2018-11-02
--Desc: Add new application function "Reply Request"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0167' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ReplyRequest' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxReplyRequest' --Description of the function > hardcoded
