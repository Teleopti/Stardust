...
--Name: Ola HÂkansson  
--Date: 2009-02-18  
--Desc: JusticePointWindow is removed as a SystemSetting  
----------------  
DELETE FROM dbo.Setting
WHERE Name = 'JusticePointWindow' 
GO 
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (71,'7.0.71') 
