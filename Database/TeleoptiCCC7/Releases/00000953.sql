...
--Name: Dumpling
--Date: 2018-03-20
--Desc: Add permission for add day off on the web-teams module
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0151' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'AddDayOff' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxAddDayOff' --Description of the function > hardcoded
