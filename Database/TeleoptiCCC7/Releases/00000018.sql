...
--Name: ostenp 
--Date: 2008-12-17 
--Desc: needed in alarmtypes
----------------  
ALTER TABLE AlarmType add StaffingEffect DOUBLE PRECISION
GO

UPDATE AlarmType 
SET StaffingEffect = 0.0


ALTER TABLE AlarmType
ALTER COLUMN [StaffingEffect]  DOUBLE PRECISION NOT NULL
GO

----------------  
--Name: dineshr for virajs
--Date: 2008-12-17 
--Desc: Recurrent Meeting changers
----------------  


ALTER TABLE [Meeting] ADD [RecurrentMeetingType]  [int] NULL 
ALTER TABLE [Meeting] ADD [IsRecurrent] [bit] NULL 
ALTER TABLE [Meeting] ADD [RecurOn] [int] NULL 
ALTER TABLE [Meeting] ADD [EndAfter] [int] NULL
GO
...
----------------  
UPDATE [Meeting]
SET [RecurrentMeetingType] = 0,
	[IsRecurrent] = 0,
	[RecurOn] = 0,
	[EndAfter] = 0

ALTER TABLE [Meeting] ALTER COLUMN [RecurrentMeetingType]  [int] NOT NULL 
ALTER TABLE [Meeting] ALTER COLUMN [IsRecurrent] [bit] NOT NULL 
ALTER TABLE [Meeting] ALTER COLUMN [RecurOn] [int] NOT NULL 
ALTER TABLE [Meeting] ALTER COLUMN [EndAfter] [int] NOT NULL 
GO
----
SET ANSI_NULLS ON
GO
...
--Name: Henry Greijer
--Date: 2008-12-18 
--Desc: SkillDay is now deletable.
----------------  
ALTER TABLE dbo.SkillDay DROP COLUMN IsDeleted


----------------  
--Name: Micke Deig�rd
--Date: 2008-12-18 
--Desc: Added justice values to shiftcategories.
----------------  
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
--Name: Klas Mellbourn
--Date: 2008-12-19  
--Desc: Renamed domain entities according to revised design
----------------  
EXECUTE sp_rename N'dbo.BudgetingRowDefinition', N'BudgetRow', 'OBJECT' 
GO
EXECUTE sp_rename N'dbo.BudgetRow.ValueIsPercentage', N'ValueIsProportional', 'COLUMN' 
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (18,'7.0.18') 
