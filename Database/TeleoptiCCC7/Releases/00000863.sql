...
--Name: Mingdi
--Date: 2017-06-29
--Desc: Add new application function "Overtime Requests"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0146' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'OvertimeRequestWeb' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxOvertimeRequest' --Description of the function > hardcoded
