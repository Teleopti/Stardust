----------------  
--Desc: Add new application function "Import schedule"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0138' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ImportSchedule' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxImportSchedule' --Description of the function > hardcoded
