...
--Name: Ola HÂknsson  
--Date: 2009-05-07  
--Desc: Activity got a new prop.  
----------------  
ALTER TABLE dbo.Activity
ADD ReportLevelDetail int null
GO
UPDATE dbo.Activity SET ReportLevelDetail = 0
GO
ALTER TABLE dbo.Activity
ALTER COLUMN ReportLevelDetail int not null
GO
----------------  
--Name: ˆsten Petersson  
--Date: 2009-05-07  
--Desc: Added new table  
----------------  
create table [dbo].[Conversation] (Id UNIQUEIDENTIFIER not null, Version INT not null, CreatedBy UNIQUEIDENTIFIER not null, UpdatedBy UNIQUEIDENTIFIER null, CreatedOn DATETIME not null, UpdatedOn DATETIME null, Title NVARCHAR(255) not null, Message NVARCHAR(255) not null, BusinessUnit UNIQUEIDENTIFIER not null, IsDeleted BIT not null, primary key (Id))
GO
alter table [dbo].[Conversation] add constraint FK_Conversation_Person_CreatedBy foreign key (CreatedBy) references Person
alter table [dbo].[Conversation] add constraint FK_Conversation_Person_UpdatedBy foreign key (UpdatedBy) references Person
alter table [dbo].[Conversation] add constraint FK_Conversation_BusinessUnit foreign key (BusinessUnit) references BusinessUnit
GO
...
CREATE TABLE [dbo].[ConversationDialogue]
(
...
GO
ALTER TABLE [dbo].[ConversationDialogue] ADD PRIMARY KEY (Id)
GO

-- Foreign keys
ALTER TABLE [dbo].[ConversationDialogue] ADD CONSTRAINT [FK_ConversationDialogue_BusinessUnit] FOREIGN KEY ([BusinessUnit]) REFERENCES [dbo].[BusinessUnit] ([Id])
GO
ALTER TABLE [dbo].[ConversationDialogue] ADD CONSTRAINT [FK_ConversationDialogue_Conversation] FOREIGN KEY ([Conversation]) REFERENCES [dbo].[Conversation] ([Id])
GO
ALTER TABLE [dbo].[ConversationDialogue] ADD CONSTRAINT [FK_ConversationDialogue_Person_CreatedBy] FOREIGN KEY ([CreatedBy]) REFERENCES [dbo].[Person] ([Id])
GO
ALTER TABLE [dbo].[ConversationDialogue] ADD CONSTRAINT [FK_ConversationDialogue_Person_UpdatedBy] FOREIGN KEY ([UpdatedBy]) REFERENCES [dbo].[Person] ([Id])
GO
ALTER TABLE [dbo].[ConversationDialogue] ADD CONSTRAINT [FK_ConversationDialogue_Receiver] FOREIGN KEY ([Receiver]) REFERENCES [dbo].[Person] ([Id])
GO
...
--Date: 2009-05-11    
---------------- 
create table dbo.Message (Id UNIQUEIDENTIFIER not null, Created DATETIME not null, Text NVARCHAR(255) not null, Parent UNIQUEIDENTIFIER not null, primary key (Id))
GO
alter table dbo.Message add constraint FK_ConversationDialogue_Message foreign key (Parent) references ConversationDialogue
GO
