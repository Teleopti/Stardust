--Name: Chundan
--Date: 2018-09-28  
--Desc: Add the new application function> ExportSchedule
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0156' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ExportSchedule' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxExportSchedule' --Description of the function > hardcoded
