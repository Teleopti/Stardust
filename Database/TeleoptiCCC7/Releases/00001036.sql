...
SELECT @ForeignId = '0169' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ViewCibLandingPage' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxViewCibLandingPage' --Description of the function > hardcoded
