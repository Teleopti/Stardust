...
--Name: Request team
--Date: 2015-11-26  
--Desc: Add new application function "WebRequests"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0126' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'WebRequests' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxRequests' --Description of the function > hardcoded
