...
--Name: ZoÎ Trender  
--Date: 2009-04-15  
--Desc: Changed Worktime limitation data type 
----------------  
ALTER TABLE AvailabilityDayRestriction
ALTER COLUMN WorkTimeMinimum bigint null
ALTER TABLE AvailabilityDayRestriction
ALTER COLUMN WorkTimeMaximum bigint null
GO
