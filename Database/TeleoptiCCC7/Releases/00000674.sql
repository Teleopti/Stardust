...
--Name: Xueli and Rob
--Date: 2016-04-19
--Desc: Add new application function "Cancel Absence Request"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0130' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'WebCancelRequest' --Name of the function > hardcoded
