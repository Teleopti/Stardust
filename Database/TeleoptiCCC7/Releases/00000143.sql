...
--Name: Micke  
--Date: 20090826  
--Desc: Dropping some old tables
----------------  
ALTER TABLE [dbo].[ChartSeriesSetting] DROP CONSTRAINT [FK_ChartSeriesSetting_ChartSetting]
GO

ALTER TABLE [dbo].[IntradaySetting] DROP CONSTRAINT [FK_IntradaySetting_BusinessUnit]
GO

ALTER TABLE [dbo].[IntradaySetting] DROP CONSTRAINT [FK_IntradaySetting_ChartSetting]
GO

ALTER TABLE [dbo].[IntradaySetting] DROP CONSTRAINT [FK_IntradaySetting_Person_CreatedBy]
GO

ALTER TABLE [dbo].[IntradaySetting] DROP CONSTRAINT [FK_IntradaySetting_Person_UpdatedBy]
GO

DROP TABLE [dbo].[IntradaySetting]
GO

DROP TABLE [dbo].[ChartSeriesSetting]
GO

DROP TABLE [dbo].[ChartSetting]
GO
...
--Name: Roger Kratz  
--Date: 20090826  
--Desc: Changing column names for setting tables. 
----------------  
EXEC sp_rename @objname=N'[dbo].[GlobalSettingData].[Name]', @newname=N'Key', @objtype=N'COLUMN'
GO
EXEC sp_rename N'[dbo].[GlobalSettingData].[UQ_Name_BusinessUnit]', N'UQ_Key_BusinessUnit', N'INDEX'
GO
EXEC sp_rename @objname=N'[dbo].[PersonalSettingData].[Name]', @newname=N'Key', @objtype=N'COLUMN'
GO
EXEC sp_rename N'[dbo].[PersonalSettingData].[UQ_Name_OwnerPerson]', N'UQ_Key_OwnerPerson', N'INDEX'
GO 
GO 
