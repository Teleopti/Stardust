...
--Desc: Remove BU  
---------------- 
ALTER TABLE KeyPerformanceIndicator
DROP CONSTRAINT FK_KeyPerformanceIndicator_BusinessUnit
GO
ALTER TABLE KeyPerformanceIndicator
...
----------------  
--Name: David Jonsson
--Desc: Data update for missing KPI data. This is only a patch for already deployed environements!
--Date: 2009-03-17 (init)
--Date: 2009-03-24 (moved post "create SuperUser", to be able to use that id (instead of DatabaseConverter)
--Intial KPI-data is moved to AppConfig.exe
----------------
		--declare
...
SET NOCOUNT ON
IF         (
           NOT EXISTS (SELECT id FROM [dbo].[KeyPerformanceIndicator])  --There must not be any existing KPI values
           AND
           EXISTS (SELECT id FROM [dbo].[person] WHERE id = @SuperUserId) --SuperUser must exist
		   AND 
		   EXISTS (SELECT id FROM [dbo].[BusinessUnit]) --Yes; this is a deployed environment=AppConfig.exe is already executed!
           )
BEGIN
		   PRINT 'Added KPI default data. Working ...'

           --insert
           INSERT [dbo].[KeyPerformanceIndicator] ([Id], [Version], [CreatedBy], [UpdatedBy], [CreatedOn], [UpdatedOn], [Name], [ResourceKey], [TargetValueType], [DefaultTargetValue], [DefaultMinValue], [DefaultMaxValue], [DefaultBetweenColor], [DefaultLowerThanMinColor], [DefaultHigherThanMaxColor]) VALUES (newid(), 1, @SuperUserId, NULL, getdate(), NULL, N'Readiness (%)', N'KpiReadiness', 0, 80, 75, 80, -256, -65536, -16744448)
           INSERT [dbo].[KeyPerformanceIndicator] ([Id], [Version], [CreatedBy], [UpdatedBy], [CreatedOn], [UpdatedOn], [Name], [ResourceKey], [TargetValueType], [DefaultTargetValue], [DefaultMinValue], [DefaultMaxValue], [DefaultBetweenColor], [DefaultLowerThanMinColor], [DefaultHigherThanMaxColor]) VALUES (newid(), 1, @SuperUserId, NULL, getdate(), NULL, N'Average After Call Work (s)', N'KpiAverageAfterCallWork', 1, 20, 0, 40, -16744448, -16744448, -65536)
           INSERT [dbo].[KeyPerformanceIndicator] ([Id], [Version], [CreatedBy], [UpdatedBy], [CreatedOn], [UpdatedOn], [Name], [ResourceKey], [TargetValueType], [DefaultTargetValue], [DefaultMinValue], [DefaultMaxValue], [DefaultBetweenColor], [DefaultLowerThanMinColor], [DefaultHigherThanMaxColor]) VALUES (newid(), 1, @SuperUserId, NULL, getdate(), NULL, N'Average Handle Time (s)', N'KpiAverageHandleTime', 1, 140, 30, 180, -16744448, -256, -65536)
           INSERT [dbo].[KeyPerformanceIndicator] ([Id], [Version], [CreatedBy], [UpdatedBy], [CreatedOn], [UpdatedOn], [Name], [ResourceKey], [TargetValueType], [DefaultTargetValue], [DefaultMinValue], [DefaultMaxValue], [DefaultBetweenColor], [DefaultLowerThanMinColor], [DefaultHigherThanMaxColor]) VALUES (newid(), 1, @SuperUserId, NULL, getdate(), NULL, N'Answered Calls per Scheduled Phone Hour', N'KpiAnsweredCallsPerScheduledPhoneHour', 1, 25, 0, 10, -256, -65536, -16744448)
           INSERT [dbo].[KeyPerformanceIndicator] ([Id], [Version], [CreatedBy], [UpdatedBy], [CreatedOn], [UpdatedOn], [Name], [ResourceKey], [TargetValueType], [DefaultTargetValue], [DefaultMinValue], [DefaultMaxValue], [DefaultBetweenColor], [DefaultLowerThanMinColor], [DefaultHigherThanMaxColor]) VALUES (newid(), 1, @SuperUserId, NULL, getdate(), NULL, N'Adherence (%)', N'KpiAdherence', 0, 80, 75, 80, -256, -65536, -16744448)
           INSERT [dbo].[KeyPerformanceIndicator] ([Id], [Version], [CreatedBy], [UpdatedBy], [CreatedOn], [UpdatedOn], [Name], [ResourceKey], [TargetValueType], [DefaultTargetValue], [DefaultMinValue], [DefaultMaxValue], [DefaultBetweenColor], [DefaultLowerThanMinColor], [DefaultHigherThanMaxColor]) VALUES (newid(), 1, @SuperUserId, NULL, getdate(), NULL, N'Average Talk Time (s)', N'KpiAverageTalkTime', 1, 120, 30, 160, -16744448, -256, -65536)
           INSERT [dbo].[KeyPerformanceIndicator] ([Id], [Version], [CreatedBy], [UpdatedBy], [CreatedOn], [UpdatedOn], [Name], [ResourceKey], [TargetValueType], [DefaultTargetValue], [DefaultMinValue], [DefaultMaxValue], [DefaultBetweenColor], [DefaultLowerThanMinColor], [DefaultHigherThanMaxColor]) VALUES (newid(), 1, @SuperUserId, NULL, getdate(), NULL, N'Absenteeism (%)', N'KpiAbsenteeism', 0, 5, 4, 6, -256, -16744448, -65536)
		   
		   PRINT 'Added KPI default data. Finished!'
END
SET NOCOUNT OFF
GO
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (97,'7.0.97') 
