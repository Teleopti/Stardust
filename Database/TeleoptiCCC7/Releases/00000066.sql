...
--Name: ZoÎ Trender  
--Date: 2009-02-05 
--Desc: Adding MultiplicatorDefinitionSets to Contract 
----------------  
...
GOIF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[v_stg_queue]'))
DROP VIEW [dbo].[v_stg_queue]
GO
CREATE VIEW [dbo].[v_stg_queue]
AS
SELECT * FROM dbo.stg_queue
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (66,'7.0.66') 
