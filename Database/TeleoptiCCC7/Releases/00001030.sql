...
--Name: Mingdi
--Date: 2018-11-02
--Desc: Add new application function "Edit Site Open Hours"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0168' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'EditSiteOpenHours' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxEditSiteOpenHours' --Description of the function > hardcoded
