----------------  
--Desc: Add new application function "Archive schedule"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0137' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ArchiveSchedule' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxArchiveSchedule' --Description of the function > hardcoded
