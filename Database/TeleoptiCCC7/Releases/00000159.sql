...
--Name: Micke D  
--Date: 2009-10-10  
--Desc: Cleaning global settings  
----------------  
delete from GlobalSettingData where [Key] = 'Scheduler'
delete from GlobalSettingData where [Key] = 'OpenForecast'



----------------  
--Name: Cleaning AvailableTeamsInApplicationRole and AvailableSiteInApplicationRole
--Date: 2009-10-11
--Desc: 8370
----------------  
------------------
--drop FKs
------------------
--AvailableTeamsInApplicationRole
ALTER TABLE dbo.AvailableTeamsInApplicationRole
           DROP CONSTRAINT FK_AvailableTeamsInApplicationRole_AvailableData
GO
ALTER TABLE dbo.AvailableTeamsInApplicationRole
           DROP CONSTRAINT FK_AvailableTeamsInApplicationRole_Team
GO
...
--------------------
select distinct *
into temp_AvailableSitesInApplicationRole
from AvailableSitesInApplicationRole

select distinct *
into temp_AvailableTeamsInApplicationRole
from AvailableTeamsInApplicationRole

--------------------
--drop current data
--------------------
truncate table AvailableTeamsInApplicationRole
truncate table AvailableSitesInApplicationRole

--------------------
--re-create previous data
--------------------
insert into AvailableTeamsInApplicationRole
select * from temp_AvailableTeamsInApplicationRole

insert into AvailableSitesInApplicationRole
select * from temp_AvailableSitesInApplicationRole

------------------
--Add missing PK, add NOT NULL and re-add FKs
------------------
ALTER TABLE dbo.AvailableTeamsInApplicationRole ALTER COLUMN AvailableTeam uniqueidentifier NOT NULL
GO
ALTER TABLE dbo.AvailableTeamsInApplicationRole ADD CONSTRAINT
           PK_AvailableTeamsInApplicationRole PRIMARY KEY CLUSTERED 
           (
           AvailableData,
           AvailableTeam
           )
GO         
ALTER TABLE dbo.AvailableTeamsInApplicationRole ADD CONSTRAINT
FK_AvailableTeamsInApplicationRole_Team FOREIGN KEY
(
AvailableTeam
) REFERENCES dbo.Team
(
...
GO
ALTER TABLE dbo.AvailableTeamsInApplicationRole ADD CONSTRAINT
           FK_AvailableTeamsInApplicationRole_AvailableData FOREIGN KEY
           (
           AvailableData
...
--AvailableSitesInApplicationRole
ALTER TABLE dbo.AvailableSitesInApplicationRole
           DROP CONSTRAINT FK_AvailableSitesInApplicationRole_AvailableData
GO
ALTER TABLE dbo.AvailableSitesInApplicationRole
           DROP CONSTRAINT FK_AvailableSitesInApplicationRole_Site
GO
ALTER TABLE dbo.AvailableSitesInApplicationRole ALTER COLUMN AvailableSite uniqueidentifier NOT NULL
GO
ALTER TABLE dbo.AvailableSitesInApplicationRole ADD CONSTRAINT
           PK_AvailableSitesInApplicationRole PRIMARY KEY CLUSTERED 
           (
           AvailableData,
           AvailableSite
           )
GO
ALTER TABLE dbo.AvailableSitesInApplicationRole ADD CONSTRAINT
           FK_AvailableSitesInApplicationRole_Site FOREIGN KEY
           (
           AvailableSite
           ) REFERENCES dbo.Site
           (
...
GO
ALTER TABLE dbo.AvailableSitesInApplicationRole ADD CONSTRAINT
           FK_AvailableSitesInApplicationRole_AvailableData FOREIGN KEY
           (
           AvailableData
           ) REFERENCES dbo.AvailableData
           (
...
-- Drop temp tables
---------------
DROP TABLE temp_AvailableSitesInApplicationRole
DROP TABLE temp_AvailableTeamsInApplicationRole
