...
--Name: Jonas Nordh
--Date: 2009-06-16 
--Desc: Removing request parts, just one request per person request
----------------  
EXECUTE sp_rename N'dbo.ShiftTradeRequest.RequestStatus', N'ShiftTradeStatus', 'COLUMN' 
GO
Execute sp_rename N'dbo.RequestPart',N'Request','OBJECT'
GO
...
GO
Execute sp_rename N'FK_TextRequest_RequestPart',N'FK_TextRequest_Request','OBJECT'
GO
Execute sp_rename N'FK_AbsenceRequest_RequestPart',N'FK_AbsenceRequest_Request','OBJECT'
GO
Execute sp_rename N'FK_ShiftTradeRequest_RequestPart',N'FK_ShiftTradeRequest_Request','OBJECT'
GO
Execute sp_rename N'dbo.AbsenceRequest.RequestPart',N'Request','COLUMN'
GO
Execute sp_rename N'dbo.ShiftTradeRequest.RequestPart',N'Request','COLUMN'
GO
Execute sp_rename N'dbo.TextRequest.RequestPart',N'Request','COLUMN'
GO
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (116,'7.0.116') 
