...
SELECT @ForeignId = '0161' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ChatBot' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxChatBot' --Description of the function > hardcoded
