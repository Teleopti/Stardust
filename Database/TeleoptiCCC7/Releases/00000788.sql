...
--Name: Ola
--Date: 2017-01-12
--Desc: Add new application function for Staffing actions on the web
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0140' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'WebStaffing' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxWebStaffing' --Description of the function > hardcoded
