...
--Name: CS
--Date: 2014-01-14
--Desc: Add new application function "RequestSchedulerViewAllowance"
----------------  
SET NOCOUNT ON
...
--get parent level
SELECT @ParentForeignId = '0021'	--Parent Foreign id that is hardcoded
SELECT @ParentId = Id FROM ApplicationFunction WHERE ForeignSource='Raptor' AND IsDeleted='False' AND ForeignId Like(@ParentForeignId + '%')
	
--insert/modify application function
SELECT @ForeignId = '0106' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'RequestSchedulerViewAllowance' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxViewAllowance' --Description of the function > hardcoded
