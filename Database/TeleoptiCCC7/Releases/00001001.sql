...
--Name: Bockemon
--Date: 2018-06-14
--Desc: Add permission for PeopleManageUser in people module 
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0155' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'PeopleManageUser' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxPeopleManageUser' --Description of the function > hardcoded
