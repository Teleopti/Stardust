...
ALTER TABLE  [dbo].[GlobalSettingData] ADD CONSTRAINT [UQ_Name_BusinessUnit] UNIQUE NONCLUSTERED 
(
	[Name] ASC,
	[BusinessUnit] ASC
)
...
ALTER TABLE [dbo].[PersonalSettingData] ADD CONSTRAINT [PK_PersonalSettingData] PRIMARY KEY CLUSTERED
(
	[Id] ASC
)
ON [PRIMARY]

ALTER TABLE  [dbo].[PersonalSettingData] ADD CONSTRAINT [UQ_Name_OwnerPerson] UNIQUE NONCLUSTERED 
(
	[Name] ASC,
	[OwnerPerson] ASC
)
...
alter table GlobalSettingData add constraint FK_GlobalSettingData_BusinessUnit foreign key (BusinessUnit) references BusinessUnit
alter table PersonalSettingData add constraint FK_PersonalSettingData_Person foreign key (OwnerPerson) references Person
