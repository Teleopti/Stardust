...
--Name: Mingdi
--Date: 2015-12-25
--Desc: Add new application function "Swap Shifts"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0108' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'SwapShifts' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxSwapShifts' --Description of the function > hardcoded
