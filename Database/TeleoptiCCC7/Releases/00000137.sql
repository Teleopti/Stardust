...
--Name: Micke D  
--Date: 2009-08-11  
--Desc: Setting PartOfUnique on deleted Persons 
----------------  
update Person
set PartOfUnique = id,
WindowsLogonName = null,
ApplicationLogonName = null,
[Password] = null
where IsDeleted = 1
GO
...
--Name: Ola H  
--Date: 2009-08-12  
--Desc: Remove Scenario from WorkloadDay
----------------  
--BEGIN TRANSACTION
GO
ALTER TABLE dbo.WorkloadDay
	DROP CONSTRAINT FK_WorkloadDay_Scenario
--GO
...
--GO
--ALTER TABLE dbo.WorkloadDay SET (LOCK_ESCALATION = TABLE)
GO
--COMMIT 
GO 
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (137,'7.0.137') 
