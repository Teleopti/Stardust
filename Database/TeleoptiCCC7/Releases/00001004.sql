...
--Name: Mingdi
--Date: 2018-07-24
--Desc: Add new application function "Gamification"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0160' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'Gamificaiton' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxGamification' --Description of the function > hardcoded
