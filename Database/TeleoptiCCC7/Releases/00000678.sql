...
--Name: CS
--Date: 2016-05-10
--Desc: Add new application function "Organize Cascading Skills"
----------------  
SET NOCOUNT ON
...
SELECT @FunctionCode = 'OrganizeCascadingSkills' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxOrganizeCascadingSkills' --Description of the function > hardcoded
