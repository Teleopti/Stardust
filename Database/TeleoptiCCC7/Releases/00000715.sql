...
--Name: Zulong Chen
--Date: 2016-08-03
--Desc: Add new application function "Edit Shift Category"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0110' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'EditShiftCategory' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxEditShiftCategory' --Description of the function > hardcoded
