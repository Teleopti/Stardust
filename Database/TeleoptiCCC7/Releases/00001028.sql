...
--Name: Mingdi
--Date: 2018-11-02
--Desc: Add new application function "Approve/Deny Request"
----------------  
SET NOCOUNT ON
...
--get parent level
SELECT @ParentForeignId = '0126'	--Parent Foreign id that is hardcoded
SELECT @ParentId = Id FROM ApplicationFunction WHERE ForeignSource='Raptor' AND IsDeleted='False' AND ForeignId Like(@ParentForeignId + '%')
	
--insert/modify application function
SELECT @ForeignId = '0166' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ApproveOrDenyRequest' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxApproveOrDenyRequest' --Description of the function > hardcoded
