...
--Name: Jianfeng
--Date: 2016-04-08
--Desc: Add new application function "Remove Activity"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0109' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'RemoveActivity' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxRemoveActivity' --Description of the function > hardcoded
