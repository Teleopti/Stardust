...
--Name: Rob Wright
--Date: 2015-01-27
--Desc: Add new application function "SeatPlanner"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0107' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'SeatPlanner' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxSeatPlanner' --Description of the function > hardcoded
