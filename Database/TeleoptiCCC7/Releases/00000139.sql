...
--Name: ZoÎ Trender  
--Date: 2009-08-14  
--Desc: Correcting consequences after
--earlier bad design  
----------------  
UPDATE ScheduleRestriction
SET WorkTimeMaximum = NULL, WorkTimeMinimum = NULL
WHERE (WorkTimeMaximum = 0
AND WorkTimeMinimum = 0)
GO
UPDATE RotationDayRestriction
SET WorkTimeMaximum = NULL, WorkTimeMinimum = NULL
WHERE (WorkTimeMaximum = 0
AND WorkTimeMinimum = 0)
GO
UPDATE AvailabilityDayRestriction
SET WorkTimeMaximum = NULL, WorkTimeMinimum = NULL
WHERE (WorkTimeMaximum = 0
AND WorkTimeMinimum = 0)
Go
...
--Name: Ola HÂkansson  
--Date: 2009-08-17  
--Desc: increasing the column SerializedValue so things can be saved too :-)
----------------  

Alter Table Setting Alter column SerializedValue nvarchar(4000) not null

GO
----------------  
--Name: Ola HÂkansson  
--Date: 2009-08-18  
--Desc: Fixing wrong data
----------------  
UPDATE AvailabilityRestriction SET Available = 1 
GO 
