...
--Name: Mathias S
--Date: 2012-11-26  
--Desc: Add the following new application function> AdminWeb
----------------  
SET NOCOUNT ON
...
--Name: Robin K
--Date: 2012-11-28  
--Desc: Add the following new application function> SchedulesAdminWeb
----------------  
SET NOCOUNT ON
...
SELECT @FunctionDescription = 'Schedules'
SELECT @ParentId = @ParentId
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (375,'7.3.375') 
