...
--Name: Zulong Chen
--Date: 2016-09-22
--Desc: Add new application function "Move Invalid Overlapped Activity"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0111' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'MoveInvalidOverlappedActivity' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxMoveInvalidOverlappedActivity' --Description of the function > hardcoded
