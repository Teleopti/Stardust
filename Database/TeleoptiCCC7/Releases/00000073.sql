...
--Name: Roger Kratz
--Date: 2009-02-23
--Desc: Because dropping entities for TimeActivity & Compensation
----------------  
ALTER TABLE [dbo].[Compensation] DROP CONSTRAINT [FK_Compensation_BusinessUnit]
GO
ALTER TABLE [dbo].[Compensation] DROP CONSTRAINT [FK_Compensation_Person_CreatedBy] 
GO
ALTER TABLE [dbo].[Compensation] DROP CONSTRAINT [FK_Compensation_Person_UpdatedBy]
GO
ALTER TABLE [dbo].[CompensationLayer] DROP CONSTRAINT [FK_CompensationLayer_Compensation]
GO
ALTER TABLE [dbo].[CompensationLayer] DROP CONSTRAINT [FK_CompensationLayer_PersonCompensation]
GO
ALTER TABLE [dbo].[ExtraTimeDirectiveAllowedTypes] DROP CONSTRAINT [FK_ExtraTimeDirectiveAllowedTypes_Contract]
GO
ALTER TABLE [dbo].[ExtraTimeDirectiveTime] DROP CONSTRAINT [FK_ExtraTimeDirectiveTime_Contract_MaxTime]
GO
ALTER TABLE [dbo].[PersonCompensation] DROP CONSTRAINT [FK_PersonCompensation_BusinessUnit]
GO
ALTER TABLE [dbo].[PersonCompensation] DROP CONSTRAINT [FK_PersonCompensation_Person_CreatedBy]
GO
ALTER TABLE [dbo].[PersonCompensation] DROP CONSTRAINT [FK_PersonCompensation_Person_UpdatedBy]
GO
ALTER TABLE [dbo].[PersonCompensation] DROP CONSTRAINT [FK_PersonCompensation_Person3]
GO
ALTER TABLE [dbo].[PersonCompensation] DROP CONSTRAINT [FK_PersonCompensation_Scenario]
GO
ALTER TABLE [dbo].[PersonTimeActivity] DROP CONSTRAINT [FK_PersonTimeActivity_BusinessUnit]
GO
ALTER TABLE [dbo].[PersonTimeActivity] DROP CONSTRAINT [FK_PersonTimeActivity_Person_CreatedBy]
GO
ALTER TABLE [dbo].[PersonTimeActivity] DROP CONSTRAINT [FK_PersonTimeActivity_Person_UpdatedBy]
GO
ALTER TABLE [dbo].[PersonTimeActivity] DROP CONSTRAINT [FK_PersonTimeActivity_Person3]
GO
ALTER TABLE [dbo].[PersonTimeActivity] DROP CONSTRAINT [FK_PersonTimeActivity_Scenario]
GO
ALTER TABLE [dbo].[TimeActivity] DROP CONSTRAINT [FK_TimeActivity_BusinessUnit]
GO
ALTER TABLE [dbo].[TimeActivity] DROP CONSTRAINT [FK_TimeActivity_Person_CreatedBy]
GO
ALTER TABLE [dbo].[TimeActivity] DROP CONSTRAINT [FK_TimeActivity_Person_UpdatedBy]
GO
ALTER TABLE [dbo].[TimeActivityLayer] DROP CONSTRAINT [FK_TimeActivityLayer_PersonTimeActivity]
GO
ALTER TABLE [dbo].[TimeActivityLayer] DROP CONSTRAINT [FK_TimeActivityLayer_TimeActivity]
GO
DROP TABLE [dbo].[Compensation]
GO
DROP TABLE [dbo].[CompensationLayer]
GO
DROP TABLE [dbo].[ExtraTimeDirectiveAllowedTypes]
GO
DROP TABLE [dbo].[ExtraTimeDirectiveTime]
GO
DROP TABLE [dbo].[PersonCompensation]
GO
DROP TABLE [dbo].[PersonTimeActivity]
GO
DROP TABLE [dbo].[TimeActivity]
GO
DROP TABLE [dbo].[TimeActivityLayer]
GO 
GO 
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (73,'7.0.73') 
