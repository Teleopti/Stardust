...
CREATE NONCLUSTERED INDEX [IX_Person_Scenario]
ON [dbo].[PersonAssignment] ([Person])
INCLUDE ([Scenario])
...
--Name: Ola  
--Date: 2009-09-29  
--Desc: Refact of restrictions.  
----------------  
CREATE TABLE [dbo].[RestrictionBase](
...
GO
CREATE TABLE [dbo].[RotationRestrictionNew](
...
ALTER TABLE [dbo].[RotationRestrictionNew]  WITH CHECK ADD  CONSTRAINT [FK_RotationDayRestrictionNew_DayOff] FOREIGN KEY([DayOffTemplate])
REFERENCES [dbo].[DayOffTemplate] ([Id])
GO

ALTER TABLE [dbo].[RotationRestrictionNew] CHECK CONSTRAINT [FK_RotationDayRestrictionNew_DayOff]
GO

ALTER TABLE [dbo].[RotationRestrictionNew]  WITH CHECK ADD  CONSTRAINT [FK_RotationDayRestrictionNew_RotationDay] FOREIGN KEY([Parent])
REFERENCES [dbo].[RotationDay] ([Id])
GO

ALTER TABLE [dbo].[RotationRestrictionNew] CHECK CONSTRAINT [FK_RotationDayRestrictionNew_RotationDay]
GO

ALTER TABLE [dbo].[RotationRestrictionNew]  WITH CHECK ADD  CONSTRAINT [FK_RotationDayRestrictionNew_ShiftCategory] FOREIGN KEY([ShiftCategory])
REFERENCES [dbo].[ShiftCategory] ([Id])
GO

ALTER TABLE [dbo].[RotationRestrictionNew] CHECK CONSTRAINT [FK_RotationDayRestrictionNew_ShiftCategory]
GO

ALTER TABLE [dbo].[RotationRestrictionNew]  WITH CHECK ADD  CONSTRAINT [FK_RotationRestriction_RestrictionBase] FOREIGN KEY([RestrictionBase])
REFERENCES [dbo].[RestrictionBase] ([Id])
GO

ALTER TABLE [dbo].[RotationRestrictionNew] CHECK CONSTRAINT [FK_RotationRestriction_RestrictionBase]
GO
...
FROM dbo.RotationDayRestriction

INSERT INTO dbo.RotationRestrictionNew
SELECT Id,Parent,ShiftCategory,DayOffTemplate
FROM dbo.RotationDayRestriction

/*
Senare l‰gg till drop pÂ gamla grejer
*/

EXEC sp_rename 'RotationRestriction', 'RotationRestrictionOld';

EXEC sp_rename 'RotationRestrictionNew', 'RotationRestriction';
GO

EXEC sp_rename 'Availability', 'AvailabilityRotation';
EXEC sp_rename 'AvailabilityRestriction', 'AvailabilityRestrictionOld';
GO
...
ALTER TABLE [dbo].[AvailabilityRestriction]  WITH CHECK ADD  CONSTRAINT [FK_AvailabilityDayRestrictionNew_AvailabilityDayNew] FOREIGN KEY([RestrictionBase])
REFERENCES [dbo].[RestrictionBase] ([Id])
GO

ALTER TABLE [dbo].[AvailabilityRestriction] CHECK CONSTRAINT [FK_AvailabilityDayRestrictionNew_AvailabilityDayNew]
GO

CREATE TABLE [dbo].[AvailabilityDayNew](
	[Id] [uniqueidentifier] NOT NULL,
...
ALTER TABLE [dbo].[AvailabilityDayNew]  WITH CHECK ADD  CONSTRAINT [FK_AvailabilityDayNew_Restriction] FOREIGN KEY([Restriction])
REFERENCES [dbo].[AvailabilityRestriction] ([RestrictionBase])
GO

ALTER TABLE [dbo].[AvailabilityDayNew] CHECK CONSTRAINT [FK_AvailabilityDayNew_Restriction]
GO

ALTER TABLE [dbo].[AvailabilityDayNew]  WITH CHECK ADD  CONSTRAINT [FK_AvailabilityDayNew_Rotation] FOREIGN KEY([Parent])
REFERENCES [dbo].[AvailabilityRotation] ([Id])
GO

ALTER TABLE [dbo].[AvailabilityDayNew] CHECK CONSTRAINT [FK_AvailabilityDayNew_Rotation]
GO


Insert into [dbo].[RestrictionBase]
SELECT Id,StartTimeMinimum, StartTimeMaximum,EndTimeMinimum, EndTimeMaximum,
WorkTimeMinimum, WorkTimeMaximum
FROM dbo.AvailabilityDayRestriction

GO
INSERT INTO AvailabilityRestriction
SELECT Id, CONVERT(bit,Available -1)
FROM AvailabilityDayRestriction

GO

INSERT AvailabilityDayNew
SELECT d.Id, d.Parent, r.Id, [Day]
FROM AvailabilityDay d
INNER JOIN AvailabilityDayRestriction r
ON d.Id = r.Parent

GO
EXECUTE sp_rename N'dbo.PersonAvailability.Rotation', N'Availability', 'COLUMN' 
