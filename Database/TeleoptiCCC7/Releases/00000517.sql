...
--Name: Jianguang Fang
--Date: 2015-01-22
--Desc: make BulletinBoard (shift exchange) function depend on ShiftTradeRequest function
----------------  
SET NOCOUNT ON
...
--get parent level
SELECT @ParentForeignId = '0083'	--Parent Foreign id that is hardcoded
SELECT @ParentId = Id FROM ApplicationFunction WHERE ForeignSource='Raptor' AND IsDeleted='False' AND ForeignId Like(@ParentForeignId + '%')
	
--insert/modify application function
SELECT @ForeignId = '0104' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ShiftTradeBulletinBoard' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxShiftTradeBulletinBoard' --Description of the function > hardcoded
