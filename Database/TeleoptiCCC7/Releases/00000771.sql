...
--Name: Jianfeng
--Date: 2016-11-24
--Desc: Add new application function "Add Overtime Activity"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0139' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'AddOvertimeActivity' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxAddOvertimeActivity' --Description of the function > hardcoded
