...
--Name: Ola HÂkansson  
--Date: 2009-10-29 
--Desc: Because Mappingschanges of restrictions  
----------------  

	
BEGIN TRANSACTION

ALTER TABLE AvailabilityRestriction	ADD  [StartTimeMinimum] [bigint] NULL
ALTER TABLE AvailabilityRestriction	ADD [StartTimeMaximum] [bigint] NULL
ALTER TABLE AvailabilityRestriction	ADD [EndTimeMinimum] [bigint] NULL
ALTER TABLE AvailabilityRestriction	ADD [EndTimeMaximum] [bigint] NULL
ALTER TABLE AvailabilityRestriction	ADD [WorkTimeMinimum] [bigint] NULL
ALTER TABLE AvailabilityRestriction	ADD [WorkTimeMaximum] [bigint] NULL
GO

UPDATE AvailabilityRestriction 
SET StartTimeMinimum = b.StartTimeMinimum, 
StartTimeMaximum = b.StartTimeMaximum, 
EndTimeMinimum = b.EndTimeMinimum, 
EndTimeMaximum = b.EndTimeMaximum, 
WorkTimeMinimum = b.WorkTimeMinimum, 
WorkTimeMaximum = b.WorkTimeMaximum


FROM dbo.RestrictionBase b 
INNER JOIN AvailabilityRestriction a
ON a.RestrictionBase = b.Id

GO
ALTER TABLE dbo.AvailabilityRestriction
	DROP CONSTRAINT  FK_AvailabilityDayRestrictionNew_AvailabilityDayNew

GO

ALTER TABLE [dbo].[AvailabilityDayNew] DROP CONSTRAINT [FK_AvailabilityDayNew_Restriction]
GO

Update AvailabilityRestriction SET RestrictionBase = d.Id
FROM AvailabilityRestriction a
INNER JOIN dbo.AvailabilityDayNew d ON d.Restriction = a.RestrictionBase


GO
EXECUTE sp_rename N'dbo.AvailabilityRestriction.RestrictionBase', N'Id', 'COLUMN' 
GO

ALTER TABLE [dbo].[AvailabilityRestriction]  WITH CHECK 
ADD  CONSTRAINT [FK_AvailabilityRestriction_AvailablilityDay] FOREIGN KEY([Id])
REFERENCES [dbo].[AvailabilityDayNew] ([Id])
GO
...
ALTER TABLE dbo.AvailabilityDayNew
	DROP COLUMN Restriction

GO
GO
DROP TABLE AvailabilityRestrictionOld
GO
DROP TABLE AvailabilityDayRestriction
GO
DROP TABLE AvailabilityDay

GO
EXEC dbo.sp_rename @objname = N'[dbo].[AvailabilityDayNew]', @newname = N'AvailabilityDay', @objtype = N'OBJECT'
...
DELETE FROM [PreferenceRestrictionNew]
WHERE RestrictionBase not in(SELECT Restriction FROM PreferenceDay)

ALTER TABLE PreferenceRestrictionNew	ADD  [StartTimeMinimum] [bigint] NULL
ALTER TABLE PreferenceRestrictionNew	ADD [StartTimeMaximum] [bigint] NULL
ALTER TABLE PreferenceRestrictionNew	ADD [EndTimeMinimum] [bigint] NULL
ALTER TABLE PreferenceRestrictionNew	ADD [EndTimeMaximum] [bigint] NULL
ALTER TABLE PreferenceRestrictionNew	ADD [WorkTimeMinimum] [bigint] NULL
ALTER TABLE PreferenceRestrictionNew	ADD [WorkTimeMaximum] [bigint] NULL
GO

UPDATE PreferenceRestrictionNew 
SET StartTimeMinimum = b.StartTimeMinimum, 
StartTimeMaximum = b.StartTimeMaximum, 
EndTimeMinimum = b.EndTimeMinimum, 
EndTimeMaximum = b.EndTimeMaximum, 
...
FROM dbo.RestrictionBase b 
INNER JOIN PreferenceRestrictionNew a
ON a.RestrictionBase = b.Id

GO

ALTER TABLE [dbo].[PreferenceRestrictionNew] DROP CONSTRAINT [FK_PreferenceRestriction_RestrictionBase]
GO

ALTER TABLE [dbo].[PreferenceDay] DROP CONSTRAINT [FK_PreferenceRestrictionNew_Restriction]
GO


Update [PreferenceRestrictionNew] SET RestrictionBase = d.Id
FROM [PreferenceRestrictionNew] a
INNER JOIN dbo.PreferenceDay d ON d.Restriction = a.RestrictionBase


GO
EXECUTE sp_rename N'dbo.PreferenceRestrictionNew.RestrictionBase', N'Id', 'COLUMN' 
GO

ALTER TABLE [dbo].[PreferenceRestrictionNew]  WITH CHECK 
ADD  CONSTRAINT [FK_PreferenceRestrictin_PreferenceDay] FOREIGN KEY([Id])
REFERENCES [dbo].[PreferenceDay] ([Id])
GO

ALTER TABLE [dbo].[PreferenceRestrictionNew] CHECK CONSTRAINT [FK_PreferenceRestrictin_PreferenceDay]
GO

ALTER TABLE dbo.PreferenceDay
	DROP COLUMN Restriction

GO
GO
DROP TABLE dbo.PreferenceRestriction
GO

EXEC dbo.sp_rename @objname = N'[dbo].[PreferenceRestrictionNew]', @newname = N'PreferenceRestriction', @objtype = N'OBJECT'
...
ALTER TABLE RotationRestriction	ADD  [StartTimeMinimum] [bigint] NULL
ALTER TABLE RotationRestriction	ADD [StartTimeMaximum] [bigint] NULL
ALTER TABLE RotationRestriction	ADD [EndTimeMinimum] [bigint] NULL
ALTER TABLE RotationRestriction	ADD [EndTimeMaximum] [bigint] NULL
ALTER TABLE RotationRestriction	ADD [WorkTimeMinimum] [bigint] NULL
ALTER TABLE RotationRestriction	ADD [WorkTimeMaximum] [bigint] NULL
GO
...
FROM dbo.RestrictionBase b 
INNER JOIN RotationRestriction a
ON a.RestrictionBase = b.Id

GO

ALTER TABLE [dbo].[RotationRestriction] DROP CONSTRAINT [FK_RotationRestriction_RestrictionBase]

GO
EXECUTE sp_rename N'dbo.RotationRestriction.RestrictionBase', N'Id', 'COLUMN' 
GO

GO
DROP TABLE dbo.RotationRestrictionOld
GO
DROP TABLE dbo.RotationDayRestriction
...
ALTER TABLE StudentAvailabilityRestriction	ADD  [StartTimeMinimum] [bigint] NULL
ALTER TABLE StudentAvailabilityRestriction	ADD [StartTimeMaximum] [bigint] NULL
ALTER TABLE StudentAvailabilityRestriction	ADD [EndTimeMinimum] [bigint] NULL
ALTER TABLE StudentAvailabilityRestriction	ADD [EndTimeMaximum] [bigint] NULL
ALTER TABLE StudentAvailabilityRestriction	ADD [WorkTimeMinimum] [bigint] NULL
ALTER TABLE StudentAvailabilityRestriction	ADD [WorkTimeMaximum] [bigint] NULL
GO

UPDATE StudentAvailabilityRestriction 
SET StartTimeMinimum = b.StartTimeMinimum, 
StartTimeMaximum = b.StartTimeMaximum, 
EndTimeMinimum = b.EndTimeMinimum, 
EndTimeMaximum = b.EndTimeMaximum, 
...
FROM dbo.RestrictionBase b 
INNER JOIN StudentAvailabilityRestriction a
ON a.RestrictionBase = b.Id

GO

ALTER TABLE [dbo].[StudentAvailabilityRestriction] DROP CONSTRAINT [FK_StudentAvailabilityRestriction_RestrictionBase]
GO

GO
EXECUTE sp_rename N'dbo.StudentAvailabilityRestriction.RestrictionBase', N'Id', 'COLUMN' 
GO
...
ALTER TABLE ActivityRestriction	ADD  [StartTimeMinimum] [bigint] NULL
ALTER TABLE ActivityRestriction	ADD [StartTimeMaximum] [bigint] NULL
ALTER TABLE ActivityRestriction	ADD [EndTimeMinimum] [bigint] NULL
ALTER TABLE ActivityRestriction	ADD [EndTimeMaximum] [bigint] NULL
ALTER TABLE ActivityRestriction	ADD [WorkTimeMinimum] [bigint] NULL
ALTER TABLE ActivityRestriction	ADD [WorkTimeMaximum] [bigint] NULL
GO
...
FROM dbo.RestrictionBase b 
INNER JOIN ActivityRestriction a
ON a.RestrictionBase = b.Id

GO
ALTER TABLE [dbo].[ActivityRestriction] DROP CONSTRAINT [FK_ActivityRestriction_RestrictionBase]
GO

GO
EXECUTE sp_rename N'dbo.ActivityRestriction.RestrictionBase', N'Id', 'COLUMN' 
GO

DROP TABLE RestrictionBase
GO
DROP TABLE ScheduleRestriction
GO
DROP TABLE PersonRestriction
