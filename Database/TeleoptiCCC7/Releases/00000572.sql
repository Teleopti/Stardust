...
--Name: Yanyi Wan
--Date: 2015-04-30  
--Desc: Add new application function "Outbound"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0120' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'Outbound' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxOutbound' --Description of the function > hardcoded
