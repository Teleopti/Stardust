...
--Name: ChundanX
--Date: 2016-06-24
--Desc: Add permission of ViewBadgeLeaderboard under reports.
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0134' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ViewBadgeLeaderboardUnderReports' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxBadgeLeaderBoardReport' --Description of the function > hardcoded
