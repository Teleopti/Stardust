...
--Name: Robin Karlsson
--Date: 2009-09-18
--Desc: Must be long to store the values generated equally on 32 and 64 bit machines
----------------  
ALTER TABLE ShiftTradeSwapDetail ALTER COLUMN ChecksumFrom bigint not null
ALTER TABLE ShiftTradeSwapDetail ALTER COLUMN ChecksumTo bigint not null
GO 
GO 
