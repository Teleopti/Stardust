...
--Name: Mingdi
--Date: 2017-02-07
--Desc: Add new application function "View Possibility"
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0143' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ViewPossibility' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxViewPossibility' --Description of the function > hardcoded
