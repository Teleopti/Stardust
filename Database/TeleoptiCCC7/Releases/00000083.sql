...
--Name: Peter Westlin
--Date: 2009-03-26  
--Desc: Adds "Connection" between export and result  
----------------

--First, deletes all the rows in PayrollResults
--No one exept for developers in the Payroll Team should
...
GO
ALTER TABLE dbo.PayrollResult ADD CONSTRAINT
	FK_PayrollResult_PayrollExport FOREIGN KEY
	(
	PayrollExport
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (83,'7.0.83') 
