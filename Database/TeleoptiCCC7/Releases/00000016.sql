...
CREATE TABLE [dbo].[PlanningGroupSkill](
	[PlanningGroup] [uniqueidentifier] NOT NULL,
	[Skill] [uniqueidentifier] NOT NULL
) ON [PRIMARY]

GO
ALTER TABLE [dbo].[PlanningGroupSkill]  WITH CHECK ADD  CONSTRAINT [FK_PlanningGroup_Skill] FOREIGN KEY([Skill])
REFERENCES [dbo].[Skill] ([Id])
GO
ALTER TABLE [dbo].[PlanningGroupSkill] CHECK CONSTRAINT [FK_PlanningGroup_Skill]
GO
ALTER TABLE [dbo].[PlanningGroupSkill]  WITH CHECK ADD  CONSTRAINT [FK_PlanningGroupSkill_PlanningGroup] FOREIGN KEY([PlanningGroup])
REFERENCES [dbo].[PlanningGroup] ([Id])
GO
ALTER TABLE [dbo].[PlanningGroupSkill] CHECK CONSTRAINT [FK_PlanningGroupSkill_PlanningGroup]IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SplitStringString]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (16,'7.0.16') 
