...
--Name: Chundan
--Date: 2017-01-13
--Desc: Add new application function for Saving favorite search on the web
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0141' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'SaveFavoriteSearch' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxSaveFavoriteSearch' --Description of the function > hardcoded
