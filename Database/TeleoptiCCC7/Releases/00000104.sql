...
--Name: Robin Karlsson
--Date: 2009-05-29  
--Desc: Added property to enable/disable possibility to reply with text to messages
----------------  
ALTER TABLE dbo.PushMessage ADD
	AllowDialogueReply bit NOT NULL CONSTRAINT DF_PushMessage_AllowDialogueReply DEFAULT 1
GO 
GO 
...
INSERT INTO DatabaseVersion(BuildNumber, SystemVersion) VALUES (104,'7.0.104') 
