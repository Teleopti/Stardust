...
--Name: Roger Kratz 
--Date: 2008-02-09  
--Desc: Added tables for over time  
----------------  
create table dbo.OvertimeShift (Id UNIQUEIDENTIFIER not null, Parent UNIQUEIDENTIFIER not null, OrderIndex INT not null, primary key (Id))
GO
create table dbo.OvertimeShiftActivityLayer (Id UNIQUEIDENTIFIER not null, payLoad UNIQUEIDENTIFIER not null, Minimum DATETIME not null, Maximum DATETIME not null, DefinitionSet UNIQUEIDENTIFIER not null, Parent UNIQUEIDENTIFIER not null, OrderIndex INT not null, primary key (Id))
GO
alter table dbo.OvertimeShift add constraint FK_OvertimeShift_PersonAssignment foreign key (Parent) references PersonAssignment
GO
alter table dbo.OvertimeShiftActivityLayer add constraint FK_OvertimeShiftActivityLayer_Activity foreign key (payLoad) references Activity
GO
alter table dbo.OvertimeShiftActivityLayer add constraint FK_OvertimeShiftActivityLayer_DefinitionSet foreign key (DefinitionSet) references MultiplicatorDefinitionSet
GO
alter table dbo.OvertimeShiftActivityLayer add constraint FK_OvertimeShiftActivityLayer_OvertimeShift foreign key (Parent) references OvertimeShift
GO

----------------  
--Name: Henrik Andersson, Peter Westlin
--Date: 2008-02-11  
--Desc: Added tables for over time  
----------------  
alter table dbo.PersonAccountDay add LatestCalculatedBalance INT null
GO
update PersonAccountDay set LatestCalculatedBalance = 0
alter table dbo.PersonAccountDay alter column LatestCalculatedBalance INT not null

alter table dbo.PersonAccountTime add LatestCalculatedBalance BIGINT null
GO
update PersonAccountTime set LatestCalculatedBalance = 0
alter table dbo.PersonAccountTime alter column LatestCalculatedBalance INT not null

----------------  
--Name: ZoÎ Trender
--Date: 2008-02-11  
--Desc: Making MultiplicatorDefinitonSet to an Aggregate root by adding IsDeleted 
---------------- 
GO
ALTER TABLE dbo.MultiplicatorDefinitionSet
ADD IsDeleted bit NULL
GO
UPDATE dbo.MultiplicatorDefinitionSet
SET IsDeleted = 0
GO
ALTER TABLE dbo.MultiplicatorDefinitionSet
...
--Name: David Jonsson
--Date: 2008-02-12
--Desc: Creating New Schema and transfer objects 
--      (corresponding to the changes in the DataMart)
---------------- 
CREATE SCHEMA mart
GO
ALTER SCHEMA mart TRANSFER dbo.dim_date
ALTER SCHEMA mart TRANSFER dbo.dim_queue
ALTER SCHEMA mart TRANSFER dbo.dim_interval
ALTER SCHEMA mart TRANSFER dbo.fact_queue
ALTER SCHEMA mart TRANSFER dbo.SplitStringInt
ALTER SCHEMA mart TRANSFER dbo.SplitStringString
ALTER SCHEMA mart TRANSFER dbo.raptor_dim_date_getId_ByDate
ALTER SCHEMA mart TRANSFER dbo.raptor_dim_queue_create
ALTER SCHEMA mart TRANSFER dbo.raptor_dim_queue_load
ALTER SCHEMA mart TRANSFER dbo.raptor_fact_queue_load
ALTER SCHEMA mart TRANSFER dbo.raptor_load_acd_logins
ALTER SCHEMA mart TRANSFER dbo.raptor_load_queues
ALTER SCHEMA mart TRANSFER dbo.raptor_reports_load
ALTER SCHEMA mart TRANSFER dbo.raptor_statistics_load
ALTER SCHEMA mart TRANSFER dbo.raptor_v_stg_queue_delete
ALTER SCHEMA mart TRANSFER dbo.v_stg_queue
GO
CREATE SCHEMA stg
GO
ALTER SCHEMA stg TRANSFER dbo.stg_queue
GO
----------------  
--Name: ZoÎ Trender
--Date: 2008-02-12  
--Desc: Adding Generic List setting
---------------- 
...
GO
ALTER TABLE [dbo].[ListSetting]  WITH CHECK ADD  CONSTRAINT [FK_ListSetting_Setting] FOREIGN KEY([Setting])
REFERENCES [dbo].[Setting] ([Id])
GO
ALTER TABLE [dbo].[ListSetting] CHECK CONSTRAINT [FK_ListSetting_Setting]
GO
CREATE TABLE [dbo].[ListSettingItem](
	[Id] [uniqueidentifier] NOT NULL,
	[SerializedValue] [nvarchar](255) NOT NULL,
...
GO
ALTER TABLE [dbo].[ListSettingItem]  WITH CHECK ADD  CONSTRAINT [FK_ListSettingItem_ListSetting] FOREIGN KEY([Parent])
REFERENCES [dbo].[ListSetting] ([Setting])
GO
ALTER TABLE [dbo].[ListSettingItem] CHECK CONSTRAINT [FK_ListSettingItem_ListSetting]
GO

----------------  
--Name: David Jonsson
--Date: 2008-02-12  
--Desc: Fixing nHib <-> SQL Server diff
---------------- 
ALTER TABLE [dbo].[AvailabilityDay]
ALTER COLUMN [Day] [int] NOT NULL
GO
ALTER TABLE [dbo].[PersonAccountTime]
ALTER COLUMN [LatestCalculatedBalance] [bigint] NOT NULL
GO
ALTER TABLE [dbo].[RotationDay]
ALTER COLUMN [Day] [int] NOT NULL
GO 
GO 
