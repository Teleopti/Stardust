...
--Name: Robin Karlsson
--Date: 2012-02-01  
--Desc: Add the following new application function> Forecaster/ExportForecastToOtherBusinessUnit
----------------  
SET NOCOUNT ON
...
SELECT @ForeignId = '0073' --Foreign id of the function > hardcoded	
SELECT @FunctionCode = 'ExportForecastToOtherBusinessUnit' --Name of the function > hardcoded
SELECT @FunctionDescription = 'xxExportForecastToOtherBusinessUnit' --Description of the function > hardcoded
