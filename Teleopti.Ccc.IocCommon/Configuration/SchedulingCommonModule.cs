...
namespace Teleopti.Ccc.IocCommon.Configuration
{
	internal class SchedulingCommonModule : Module
	{
		...
		protected override void Load(ContainerBuilder builder)
		{
			...
			builder.RegisterType<SchedulePlanningPeriodCommandHandler>().InstancePerLifetimeScope().ApplyAspects(); //can be single after remove ExecuteAndReturn method
		...
		private static void registerWorkShiftFilters(ContainerBuilder builder)
		{
			...
			builder.RegisterType<BusinessRulesShiftFilter>().As<IBusinessRulesShiftFilter>().SingleInstance();
