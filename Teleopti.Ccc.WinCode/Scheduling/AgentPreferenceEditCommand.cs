...
namespace Teleopti.Ccc.WinCode.Scheduling
{
	...
	public class AgentPreferenceEditCommand : IAgentPreferenceEditCommand
	{
		...
		public AgentPreferenceEditCommand(IScheduleDay scheduleDay, IShiftCategory shiftCategory, IAbsence absence, IDayOffTemplate dayOffTemplate, IActivity activity, TimeSpan? minStart, TimeSpan? maxStart, TimeSpan? minEnd, TimeSpan? maxEnd, TimeSpan? minLength, TimeSpan? maxLength, bool endNextDay, IAgentPreferenceDayCreator agentPreferenceDayCreator,
			...
			foreach (var persistableScheduleData in _scheduleDay.PersistableScheduleDataCollection())
			{
				if (persistableScheduleData is IPreferenceDay)
				{
					var result = _agentPreferenceDayCreator.CanCreate(_shiftCategory, _absence, _dayOffTemplate, _activity, _minStart,
					                                                  _maxStart, _minEnd, _maxEnd, _minLength, _maxLength, _endNextDay,
