...
{
    public class DetailPresenter : SchedulePresenterBase
    {
        public DetailPresenter(IScheduleViewBase view, ISchedulerStateHolder schedulerState, IGridlockManager lockManager,
