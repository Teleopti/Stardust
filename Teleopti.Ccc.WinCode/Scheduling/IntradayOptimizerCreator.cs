            ...
            for (int index = 0; index < _scheduleMatrixContainerList.Count; index++)
            {
                ...
                IResourceOptimizationHelper resourceOptimizationHelper =
					new ResourceOptimizationHelper(_schedulingResultStateHolder,
                                                   new OccupiedSeatCalculator(new SkillVisualLayerCollectionDictionaryCreator(), new SeatImpactOnPeriodForProjection()), nonBlendSkillCalculator, _singleSkillDictionary, new CurrentTeleoptiPrincipal());
