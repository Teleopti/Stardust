...
{
    public class ShiftCategoryLimitationViewPresenter
    {
        private IList<ISchedulePeriod> _schedulePeriods = new List<ISchedulePeriod>();
        private readonly IShiftCategoryLimitationView _view;
        private readonly IDictionary<IShiftCategory, ShiftCategoryLimitationCombination> _combinedLimitations =
