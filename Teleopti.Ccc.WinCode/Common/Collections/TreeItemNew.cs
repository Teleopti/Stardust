...
namespace Teleopti.Ccc.WinCode.Common.Collections
{
    ...
    /// </summary>
    [Serializable()]
    public class TreeItemNew<TNode> : ITreeItem<TNode>
    {
        #region Variables
        ...
        private const string StoredDisplayDataKey = "StoredDisplayDataKey";
        ...
        {
            foreach (ITreeItem<TNode> subItem in this.Enumerate(range))
            {
                if (subItem.Key==key)
                    return subItem;
            }
            ...
            //        if (range == RangeOption.Children || range == RangeOption.ThisAndChildren)
            //        {
            //            ITreeItem<TNode> result = item.FindItem(key, RangeOption.ThisOnly);
            //            if (result != null)
            //                return result;
            //        }
            //        else
            //        {
            //            ITreeItem<TNode> result = item.FindItem(key, RangeOption.ThisAndRecursiveChildren);
            //            if (result != null)
            //                return result;
            //        }
            //    }
        ...
        public ITreeItem<TNode> FindItem(TNode node, RangeOption range)
        {
            ...
            //        if (range == RangeOption.Children || range == RangeOption.ThisAndChildren)
            //        {
            //            ITreeItem<TNode> result = item.FindItem(node, RangeOption.ThisOnly);
            //            if (result != null)
            //                return result;
            //        }
            //        else
            //        {
            //            ITreeItem<TNode> result = item.FindItem(node, RangeOption.ThisAndRecursiveChildren);
            //            if (result != null)
            //                return result;
            //        }
            //    }
        ...
        public ITreeItem<TNode> FindItem(object data, RangeOption range)
        {
            ...
            //        if (range == RangeOption.Children || range == RangeOption.ThisAndChildren)
            //        {
            //            ITreeItem<TNode> result = item.FindItem(data, RangeOption.ThisOnly);
            //            if (result != null)
            //                return result;
            //        }
            //        else
            //        {
            //            ITreeItem<TNode> result = item.FindItem(data, RangeOption.ThisAndRecursiveChildren);
            //            if (result != null)
            //                return result;
            //        }
            //    }
        ...
        public ITreeItem<TNode> FindItem(ITreeItem<TNode> treeItem, RangeOption range)
        {
            ...
            //        if (range == RangeOption.Children || range == RangeOption.ThisAndChildren)
            //        {
            //            ITreeItem<TNode> result = item.FindItem(treeItem, RangeOption.ThisOnly);
            //            if (result != null)
            //                return result;
            //        }
            //        else
            //        {
            //            ITreeItem<TNode> result = item.FindItem(treeItem, range);
            //            if (result != null)
            //                return result;
            //        }
            //    }
        ...
        public bool RemoveChild(string key, bool recursiveSearch)
        {
            ...
            foreach (ITreeItem<TNode> child in this.ChildCollection)
            {
        ...
        public SelectedChildrenOption SelectedChildren
        {
            get
            {
                ...
                else if (atLeastOneChildSelected)
        ...
        public ITreeNodeDisplayInfo NodeDisplayInfo
        {
            get
            {
                if (_storedData.ContainsKey(StoredDisplayDataKey))
                    return _storedData[StoredDisplayDataKey] as ITreeNodeDisplayInfo;
                else
                {
                    _storedData[StoredDisplayDataKey] = new TreeNodeDisplayInfo();
                }
                return null;
            }
            set
            {
                if (_storedData.ContainsKey(StoredDisplayDataKey))
                    _storedData[StoredDisplayDataKey] = value;
                else
                    _storedData.Add(StoredDisplayDataKey, value);
            }
        }
        ...
        public Dictionary<string, object> StoredData
        {
