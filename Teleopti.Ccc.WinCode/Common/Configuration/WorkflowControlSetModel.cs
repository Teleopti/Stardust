...
namespace Teleopti.Ccc.WinCode.Common.Configuration
{
    public interface IWorkflowControlSetModel
    {
		...
		void SetFairnessType(FairnessType fairnessType, bool scheduler_Seniority_24331);
    ...
    public class WorkflowControlSetModel : IWorkflowControlSetModel
    {
		...
		public FairnessType GetFairnessType(bool scheduler_Seniority_24331)
        {
			return DomainEntity.GetFairnessType(scheduler_Seniority_24331);
        }

		public void SetFairnessType(FairnessType fairnessType, bool scheduler_Seniority_24331)
        {
			if (DomainEntity.GetFairnessType(scheduler_Seniority_24331) == fairnessType) return;
