...
namespace Teleopti.Ccc.WinCode.Common.Configuration
{
    public class SetScorecardPresenter : IDisposable, IMessageBrokerModule
    {
        ...
        public SetScorecardPresenter(ISetScorecardView view, IUnitOfWork unitOfWork, IMessageBroker messageBroker, IScorecardProvider scorecardProvider, ISiteProvider siteProvider, ITeamProvider teamProvider)
        {
            _view = view;
