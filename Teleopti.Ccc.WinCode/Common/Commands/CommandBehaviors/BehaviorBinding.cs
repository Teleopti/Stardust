...
namespace Teleopti.Ccc.WinCode.Common.Commands.CommandBehaviors
{
    ...
    public class BehaviorBinding : Freezable
    {
        ...
        ///// </summary>
        //private static void OnCommandChanged(DependencyObject target, DependencyPropertyChangedEventArgs eventArgs)
        //{
        //    ((BehaviorBinding)target).OnCommandChanged(eventArgs);
        //}
        ...
        ///// </summary>
        //private static void OnActionChanged(DependencyObject target, DependencyPropertyChangedEventArgs eventArgs)
        //{
        //    ((BehaviorBinding)target).OnActionChanged(eventArgs);
        //}
        ...
        //[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "eventArgs")]
        //static void OwnerReset(DependencyObject target, DependencyPropertyChangedEventArgs eventArgs)
        //{
        //    ((BehaviorBinding)target).ResetEventBinding();
        //}
