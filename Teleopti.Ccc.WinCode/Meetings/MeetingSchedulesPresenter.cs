...
namespace Teleopti.Ccc.WinCode.Meetings
{
    ...
    public class MeetingSchedulesPresenter: IMeetingDetailPresenter
    {
        ...
        private bool _skipIndexChangeEvent;
        ...
        public void GridControlSchedulesMouseUp()
        {
            ...
            {
                _skipIndexChangeEvent = true;
                _view.OnMeetingTimeChanged();
                _skipIndexChangeEvent = false;
            }
        ...
        public void Initialize()
        {
            ...
            //SetPeriodAndLoadSchedulesWhenNeeded(_meetingViewModel.StartDate);
        ...
        public static IPerson GetPerson(EntityContainer<IPerson> personViewModel)
        {
            ...
            //IPerson person = _schedulerStateHolder.Schedules[personViewModel.ContainedEntity].Person;
            //return person;
        }
