	...
	public class FilteredPeopleHolder : IDisposable
	{
		...
		private void loadFilteredPeopleGridData(IPerson person,   LogonInfoModel logonInfoModel)
		{
			...
			var personGridData = new PersonGeneralModel(person, new PrincipalAuthorization(new CurrentTeleoptiPrincipal()),
				new FilteredPeopleAccountUpdater(this, UnitOfWorkFactory.Current), logonInfoModel, new PasswordPolicy(StateHolderReader.Instance.StateReader.ApplicationScopeData.LoadPasswordPolicyService));
