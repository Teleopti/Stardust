...
namespace Teleopti.Ccc.Win.PeopleAdmin.GuiHelpers
{
    ...
    public class PersonRotationStateholder : IRotationStateHolder
    {
        ...
        public PersonRotationRepository RotationRepository
        {
            get
            {
                if (_prRepository == null)
                    _prRepository = new PersonRotationRepository(FilteredStateHolder.UnitOfWork);
        ...
        public void DeleteAllPersonRotation(int rowIndex)
        {
            ...
            PersonRotationRepository prRepository = new PersonRotationRepository(_filteredPeopleHolder.UnitOfWork);
