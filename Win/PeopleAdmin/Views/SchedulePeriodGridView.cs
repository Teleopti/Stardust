...
namespace Teleopti.Ccc.Win.PeopleAdmin.Views
{
    ...
    public class SchedulePeriodGridView : DropDownGridViewBase
    {
        ...
        {
            if ((e.RowIndex == PeopleAdminConstants.GridHeaderIndex) && (e.ColIndex >
                PeopleAdminConstants.GridHeaderIndex))
            {
                ...
                if (grid != null)
                {
                    ...
                    {
                        if (FilteredPeopleHolder.SchedulePeriodGridViewCollection[i].ExpandState == false)
                        {
                            Grid.Selections.Ranges.Add(GridRangeInfo.Cells(i +
                                PeopleAdminConstants.GridCollectionMapValue, e.ColIndex, i +
                                PeopleAdminConstants.GridCollectionMapValue, e.ColIndex));
                        }
                    }
                }
            }
        ...
        private void ParentColumn_CellDisplayChanged(object sender,
                                                     ColumnCellDisplayChangedEventArgs<SchedulePeriodModel> e)
        {
        ...
        private void CreateParentGridHeaders()
        {
            ...
            _pushButtonColumn = new PushButtonColumn<SchedulePeriodModel>
                (UserTexts.Resources.FullName, "PeriodCount");
            ...
            _fullNameColumn = new ReadOnlyTextColumn<SchedulePeriodModel>("FullName",
                                                                                    UserTexts.Resources.FullName);
            ...
            _numberColumn = new NumericCellColumnPeriod<SchedulePeriodModel>("Number",
                                                                                      UserTexts.Resources.Number, 1);
            ...
            _daysOffColumn = new ReadOnlyTextColumnPeriod<SchedulePeriodModel>("DaysOff",
                                                                                         UserTexts.Resources.DaysOff,
                                                                                         true);
            ...
            _overrideDaysOffColumn =
                new NumericCellColumnForSchedulePeriod<SchedulePeriodModel>("OverrideDaysOff",
                                                                                      UserTexts.Resources.Override);
            ...
            _mustHavePreference =
                new NumericCellColumnPeriod<SchedulePeriodModel>("MustHavePreference",
                                                                                      UserTexts.Resources.MustHave);
