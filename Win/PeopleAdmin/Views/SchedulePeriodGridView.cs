		...
		public void OnClosePreviousPeriod()
		{
			...
			using (var unitOfWork = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				...
				foreach (var selectedPerson in selectedPersons)
				{
					...
					var schedulerStateHolder = new SchedulerStateHolder(defaultScenario, new DateOnlyPeriodAsDateTimePeriod(dateOnlyPeriod, timeZoneInfo), new List<IPerson> { selectedPerson }, new DisableDeletedFilter(new FixedCurrentUnitOfWork(unitOfWork)));
