...
namespace Teleopti.Ccc.Win.PeopleAdmin.Views
{
    public partial class PersonFinderView : BaseDialogForm, IPersonFinderView
    {
        ...
        public IPersonFinderSearchCriteria PersonFinderSearchCriteria
        {
            get 
            {
                return new PersonFinderSearchCriteria((PersonFinderField)comboBox1.SelectedValue, textBox1.Text, (int)comboBox2.SelectedValue, new DateOnly(dateTimePickerAdv1.Value), _presenter.SortColumn, (int)_presenter.SortOrder);
            }
        }

        public IPersonFinderSearchCriteria PersonFinderSearchCriteriaNextPrevious
        {
            get
            {
