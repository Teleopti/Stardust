...
namespace Teleopti.Ccc.Win.Reporting
{
    public partial class ReportSettingsHostView : BaseUserControl, IReportSettingsHostView
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            reportHeader1.ShowSettings += reportHeader1_ShowSettings;
            reportHeader1.HideSettings += reportHeader1_HideSettings;
        }

        void reportHeader1_HideSettings(object sender, EventArgs e)
        {
            Fold();
            _eventAggregator.GetEvent<ViewerFoldingChangedEvent>().Publish(true);
        }

        void reportHeader1_ShowSettings(object sender, EventArgs e)
        {
            Unfold();
