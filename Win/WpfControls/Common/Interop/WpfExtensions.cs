...
namespace Teleopti.Ccc.Win.WpfControls.Common.Interop
{
    public static class WpfExtensions
    {
        ...
        private static void SetupWpfWindow(Window window, bool useVisualStyle, TimeZoneInfo timeZoneInfo)
        {
            ...
            var mvvm = new ResourceDictionary {Source = new Uri("/Teleopti.Ccc.Win;component/WpfControls/Resources/MVVM.xaml", UriKind.RelativeOrAbsolute)};
            var commonResources = new ResourceDictionary { Source = new Uri("/Teleopti.Ccc.Win;component/WpfControls/Resources/Common.xaml", UriKind.RelativeOrAbsolute) };
