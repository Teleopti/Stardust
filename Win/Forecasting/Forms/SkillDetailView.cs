...
namespace Teleopti.Ccc.Win.Forecasting.Forms
{
    public class SkillDetailView : AbstractDetailView
    {
        ...
        private void DetailViewLoad()
        {
            ...
            _skillIntradayGridControl.ModifyCells += skillIntradayGridControl_ModifyCells;
        ...
        private static void skillIntradayGridControl_ModifyCells(object sender, ModifyCellEventArgs e)
        {
