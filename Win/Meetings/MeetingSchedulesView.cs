...
namespace Teleopti.Ccc.Win.Meetings
{
    public partial class MeetingSchedulesView : BaseUserControl, IMeetingSchedulesView
    {
    	...
    	protected MeetingSchedulesView()
        {
            ...
            if (!gridControlSchedules.CellModels.ContainsKey("TimeLineHeaderCell")) gridControlSchedules.CellModels.Add("TimeLineHeaderCell", new VisualProjectionColumnHeaderCellModel(gridControlSchedules.Model, TimeZoneHelper.CurrentSessionTimeZone));
            if (!gridControlSchedules.CellModels.ContainsKey("ScheduleCell")) gridControlSchedules.CellModels.Add("ScheduleCell", new ScheduleCellModel(gridControlSchedules.Model));
        }
