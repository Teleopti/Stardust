...
namespace Teleopti.Ccc.Win.Scheduling
{
    ...
    public class ResourceOptimizationHelperWin :ResourceOptimizationHelper, IResourceOptimizationHelperWin
    {
		...
		public ResourceOptimizationHelperWin(ISchedulerStateHolder stateHolder, ISingleSkillDictionary singleSkillDictionary)
			: base(stateHolder.SchedulingResultState, new OccupiedSeatCalculator(new SkillVisualLayerCollectionDictionaryCreator(), new SeatImpactOnPeriodForProjection()), new NonBlendSkillCalculator(new NonBlendSkillImpactOnPeriodForProjection()), singleSkillDictionary, new CurrentTeleoptiPrincipal())
        {
