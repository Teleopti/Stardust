...
{
    partial class SchedulingSessionPreferencesTabPanel
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this.checkBoxShowTroubleShot = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.tableLayoutPanelRestrictions = new System.Windows.Forms.TableLayoutPanel();
			this.checkBoxUseShiftCategoryRestrictions = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxOnlyPreferenceDays = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxUsePreferences = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxUseStudentAvailability = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxOnlyAvailabilityDays = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxUseAvailability = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxUseRotations = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxOnlyRotationDays = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxMustHaves = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			...
			this.checkBoxTeamSameEndTime = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxTeamSameStartTime = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxTeamSameShiftCategory = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			...
			this.checkBoxBlockSameShiftCategory = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxBlockSameStartTime = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.checkBoxBlockSameShift = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			this.label2 = new System.Windows.Forms.Label();
			this.label7 = new System.Windows.Forms.Label();
			this.tabPageAdvance = new Syncfusion.Windows.Forms.Tools.TabPageAdv();
			this.tableLayoutPanel3 = new System.Windows.Forms.TableLayoutPanel();
			this.lblShiftSelection = new System.Windows.Forms.Label();
			this.pnlShiftCategory = new System.Windows.Forms.Panel();
			this.tableLayoutPanel7 = new System.Windows.Forms.TableLayoutPanel();
			this.checkBoxUseShiftCategory = new Syncfusion.Windows.Forms.Tools.CheckBoxAdv();
			...
			((System.ComponentModel.ISupportInitialize)(this.checkBoxShowTroubleShot)).BeginInit();
			this.tableLayoutPanelRestrictions.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseShiftCategoryRestrictions)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxOnlyPreferenceDays)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUsePreferences)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseStudentAvailability)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxOnlyAvailabilityDays)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseAvailability)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseRotations)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxOnlyRotationDays)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxMustHaves)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.checkBoxTeamSameEndTime)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxTeamSameStartTime)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxTeamSameShiftCategory)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.checkBoxBlockSameShiftCategory)).BeginInit();
			...
			this.pnlShiftCategory.SuspendLayout();
			this.tableLayoutPanel7.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseShiftCategory)).BeginInit();
			...
			// tabControl1
			// 
			this.tabControl1.ActiveTabColor = System.Drawing.Color.FromArgb(((int)(((byte)(102)))), ((int)(((byte)(102)))), ((int)(((byte)(102)))));
			this.tabControl1.BackColor = System.Drawing.Color.White;
			this.tabControl1.BeforeTouchSize = new System.Drawing.Size(520, 609);
			...
			this.tabControl1.Size = new System.Drawing.Size(520, 609);
			...
			this.tabPageGeneral.Location = new System.Drawing.Point(0, 23);
			this.tabPageGeneral.Name = "tabPageGeneral";
			this.tabPageGeneral.Padding = new System.Windows.Forms.Padding(10);
			this.tabPageGeneral.ShowCloseButton = true;
			this.tabPageGeneral.Size = new System.Drawing.Size(520, 586);
			...
			this.tableLayoutPanel1.Controls.Add(this.tableLayoutPanelRestrictions, 0, 2);
			this.tableLayoutPanel1.Controls.Add(this.tableLayoutPanelTagWith, 0, 0);
			this.tableLayoutPanel1.Controls.Add(this.lblUseRestrictions, 0, 1);
			...
			this.tableLayoutPanel1.Size = new System.Drawing.Size(498, 564);
			...
			this.checkBoxShowTroubleShot.BeforeTouchSize = new System.Drawing.Size(266, 22);
			this.tableLayoutPanel1.SetColumnSpan(this.checkBoxShowTroubleShot, 2);
			this.checkBoxShowTroubleShot.DrawFocusRectangle = false;
			this.checkBoxShowTroubleShot.Location = new System.Drawing.Point(3, 539);
			...
			this.checkBoxShowTroubleShot.Padding = new System.Windows.Forms.Padding(6, 0, 0, 0);
			this.checkBoxShowTroubleShot.Size = new System.Drawing.Size(266, 22);
			...
			// 
			// tableLayoutPanelRestrictions
			// 
			this.tableLayoutPanelRestrictions.ColumnCount = 2;
			this.tableLayoutPanelRestrictions.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 22F));
			this.tableLayoutPanelRestrictions.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.tableLayoutPanelRestrictions.Controls.Add(this.checkBoxUseShiftCategoryRestrictions, 0, 8);
			this.tableLayoutPanelRestrictions.Controls.Add(this.checkBoxOnlyPreferenceDays, 1, 1);
			this.tableLayoutPanelRestrictions.Controls.Add(this.checkBoxUsePreferences, 0, 0);
			this.tableLayoutPanelRestrictions.Controls.Add(this.checkBoxUseStudentAvailability, 0, 7);
			this.tableLayoutPanelRestrictions.Controls.Add(this.checkBoxOnlyAvailabilityDays, 1, 6);
			this.tableLayoutPanelRestrictions.Controls.Add(this.checkBoxUseAvailability, 0, 5);
			this.tableLayoutPanelRestrictions.Controls.Add(this.checkBoxUseRotations, 0, 3);
			this.tableLayoutPanelRestrictions.Controls.Add(this.checkBoxOnlyRotationDays, 1, 4);
			this.tableLayoutPanelRestrictions.Controls.Add(this.checkBoxMustHaves, 1, 2);
			this.tableLayoutPanelRestrictions.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tableLayoutPanelRestrictions.Location = new System.Drawing.Point(0, 65);
			this.tableLayoutPanelRestrictions.Margin = new System.Windows.Forms.Padding(0);
			this.tableLayoutPanelRestrictions.Name = "tableLayoutPanelRestrictions";
			this.tableLayoutPanelRestrictions.RowCount = 9;
			this.tableLayoutPanelRestrictions.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 29F));
			this.tableLayoutPanelRestrictions.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 29F));
			this.tableLayoutPanelRestrictions.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 29F));
			this.tableLayoutPanelRestrictions.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 29F));
			this.tableLayoutPanelRestrictions.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 29F));
			this.tableLayoutPanelRestrictions.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 29F));
			this.tableLayoutPanelRestrictions.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 29F));
			this.tableLayoutPanelRestrictions.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 35F));
			...
			this.tableLayoutPanelRestrictions.Size = new System.Drawing.Size(498, 307);
			this.tableLayoutPanelRestrictions.TabIndex = 23;
			// 
			// checkBoxUseShiftCategoryRestrictions
			// 
			this.checkBoxUseShiftCategoryRestrictions.BeforeTouchSize = new System.Drawing.Size(492, 22);
			...
			this.checkBoxUseShiftCategoryRestrictions.Location = new System.Drawing.Point(3, 241);
			...
			this.checkBoxUseShiftCategoryRestrictions.Size = new System.Drawing.Size(492, 22);
			...
			this.checkBoxUseShiftCategoryRestrictions.ThemesEnabled = false;
			...
			// 
			this.checkBoxOnlyPreferenceDays.BeforeTouchSize = new System.Drawing.Size(470, 23);
			...
			this.checkBoxOnlyPreferenceDays.Location = new System.Drawing.Point(25, 32);
			...
			this.checkBoxOnlyPreferenceDays.Size = new System.Drawing.Size(470, 23);
			...
			this.checkBoxOnlyPreferenceDays.ThemesEnabled = false;
			...
			// 
			this.checkBoxUsePreferences.BeforeTouchSize = new System.Drawing.Size(492, 23);
			...
			this.checkBoxUsePreferences.Font = new System.Drawing.Font("Segoe UI", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.checkBoxUsePreferences.Size = new System.Drawing.Size(492, 23);
			...
			this.checkBoxUsePreferences.ThemesEnabled = false;
			...
			// 
			this.checkBoxUseStudentAvailability.BeforeTouchSize = new System.Drawing.Size(492, 22);
			...
			this.checkBoxUseStudentAvailability.Location = new System.Drawing.Point(3, 206);
			...
			this.checkBoxUseStudentAvailability.Size = new System.Drawing.Size(492, 22);
			...
			this.checkBoxUseStudentAvailability.ThemesEnabled = false;
			...
			// 
			this.checkBoxOnlyAvailabilityDays.BeforeTouchSize = new System.Drawing.Size(470, 23);
			...
			this.checkBoxOnlyAvailabilityDays.Location = new System.Drawing.Point(25, 177);
			...
			this.checkBoxOnlyAvailabilityDays.Size = new System.Drawing.Size(470, 23);
			...
			this.checkBoxOnlyAvailabilityDays.ThemesEnabled = false;
			...
			// 
			this.checkBoxUseAvailability.BeforeTouchSize = new System.Drawing.Size(492, 23);
			...
			this.checkBoxUseAvailability.Font = new System.Drawing.Font("Segoe UI", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.checkBoxUseAvailability.Location = new System.Drawing.Point(3, 148);
			...
			this.checkBoxUseAvailability.Size = new System.Drawing.Size(492, 23);
			...
			this.checkBoxUseAvailability.ThemesEnabled = false;
			...
			// 
			this.checkBoxUseRotations.BeforeTouchSize = new System.Drawing.Size(492, 23);
			...
			this.checkBoxUseRotations.Font = new System.Drawing.Font("Segoe UI", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.checkBoxUseRotations.Location = new System.Drawing.Point(3, 90);
			...
			this.checkBoxUseRotations.Size = new System.Drawing.Size(492, 23);
			...
			this.checkBoxUseRotations.ThemesEnabled = false;
			...
			// 
			this.checkBoxOnlyRotationDays.BeforeTouchSize = new System.Drawing.Size(470, 23);
			...
			this.checkBoxOnlyRotationDays.Location = new System.Drawing.Point(25, 119);
			...
			this.checkBoxOnlyRotationDays.Size = new System.Drawing.Size(470, 23);
			...
			this.checkBoxMustHaves.Size = new System.Drawing.Size(470, 23);
			...
			this.checkBoxMustHaves.ThemesEnabled = false;
			...
			this.tableLayoutPanelTagWith.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 373F));
			...
			this.tableLayoutPanelTagWith.Location = new System.Drawing.Point(0, 0);
			this.tableLayoutPanelTagWith.Margin = new System.Windows.Forms.Padding(0);
			...
			this.tableLayoutPanelTagWith.Size = new System.Drawing.Size(498, 40);
			this.tableLayoutPanelTagWith.TabIndex = 22;
			// 
			// label6
			// 
			...
			// lblUseRestrictions
			// 
			this.lblUseRestrictions.AutoSize = true;
			this.lblUseRestrictions.Location = new System.Drawing.Point(3, 43);
			this.lblUseRestrictions.Margin = new System.Windows.Forms.Padding(3);
			this.lblUseRestrictions.Name = "lblUseRestrictions";
			this.lblUseRestrictions.Size = new System.Drawing.Size(92, 15);
			this.lblUseRestrictions.TabIndex = 25;
			this.lblUseRestrictions.Text = "xxUseRestriction";
			// 
			// tabPageExtra
			// 
			this.tabPageExtra.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.tabPageExtra.Controls.Add(this.tableLayoutPanel2);
			this.tabPageExtra.Image = null;
			this.tabPageExtra.ImageSize = new System.Drawing.Size(16, 16);
			this.tabPageExtra.Location = new System.Drawing.Point(0, 23);
			...
			this.tabPageExtra.Size = new System.Drawing.Size(520, 586);
			this.tabPageExtra.TabIndex = 1;
			...
			// 
			this.pnlBlockTeamScheduling.Controls.Add(this.tableLayoutPanel4);
			...
			this.pnlBlockTeamScheduling.Size = new System.Drawing.Size(492, 345);
			...
			this.tableLayoutPanel4.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 17F));
			this.tableLayoutPanel4.Controls.Add(this.checkBoxTeamSameActivity, 1, 9);
			this.tableLayoutPanel4.Controls.Add(this.comboBoxTeamActivity, 2, 9);
			this.tableLayoutPanel4.Controls.Add(this.checkBoxTeamSameEndTime, 1, 8);
			this.tableLayoutPanel4.Controls.Add(this.checkBoxTeamSameStartTime, 1, 7);
			this.tableLayoutPanel4.Controls.Add(this.checkBoxTeamSameShiftCategory, 1, 6);
			this.tableLayoutPanel4.Controls.Add(this.comboBoxTeamGroupPage, 2, 5);
			this.tableLayoutPanel4.Controls.Add(this.comboBoxBlockType, 2, 0);
			this.tableLayoutPanel4.Controls.Add(this.checkBoxBlockSameShiftCategory, 1, 1);
			this.tableLayoutPanel4.Controls.Add(this.checkBoxBlockSameStartTime, 1, 3);
			this.tableLayoutPanel4.Controls.Add(this.checkBoxBlockSameShift, 1, 4);
			...
			this.tableLayoutPanel4.Size = new System.Drawing.Size(492, 345);
			this.tableLayoutPanel4.TabIndex = 1;
			// 
			// checkBoxTeamSameActivity
			// 
			this.checkBoxTeamSameActivity.BeforeTouchSize = new System.Drawing.Size(253, 23);
			...
			this.checkBoxTeamSameActivity.Enabled = false;
			this.checkBoxTeamSameActivity.Location = new System.Drawing.Point(20, 253);
			...
			this.checkBoxTeamSameActivity.Padding = new System.Windows.Forms.Padding(29, 0, 0, 0);
			this.checkBoxTeamSameActivity.Size = new System.Drawing.Size(253, 23);
			this.checkBoxTeamSameActivity.Style = Syncfusion.Windows.Forms.Tools.CheckBoxAdvStyle.Metro;
			this.checkBoxTeamSameActivity.TabIndex = 39;
			this.checkBoxTeamSameActivity.Text = "xxSameActivity";
			this.checkBoxTeamSameActivity.ThemesEnabled = false;
			...
			// 
			this.checkBoxTeamSameEndTime.BeforeTouchSize = new System.Drawing.Size(253, 22);
			...
			this.checkBoxTeamSameEndTime.Enabled = false;
			this.checkBoxTeamSameEndTime.Location = new System.Drawing.Point(20, 225);
			...
			this.checkBoxTeamSameEndTime.Padding = new System.Windows.Forms.Padding(29, 0, 0, 0);
			this.checkBoxTeamSameEndTime.Size = new System.Drawing.Size(253, 22);
			...
			this.checkBoxTeamSameEndTime.ThemesEnabled = false;
			...
			// 
			this.checkBoxTeamSameStartTime.BeforeTouchSize = new System.Drawing.Size(253, 25);
			...
			this.checkBoxTeamSameStartTime.Enabled = false;
			this.checkBoxTeamSameStartTime.Location = new System.Drawing.Point(20, 194);
			...
			this.checkBoxTeamSameStartTime.Padding = new System.Windows.Forms.Padding(29, 0, 0, 0);
			this.checkBoxTeamSameStartTime.Size = new System.Drawing.Size(253, 25);
			...
			this.checkBoxTeamSameStartTime.ThemesEnabled = false;
			...
			// 
			this.checkBoxTeamSameShiftCategory.BeforeTouchSize = new System.Drawing.Size(253, 25);
			...
			this.checkBoxTeamSameShiftCategory.Enabled = false;
			this.checkBoxTeamSameShiftCategory.Location = new System.Drawing.Point(20, 163);
			...
			this.checkBoxTeamSameShiftCategory.Padding = new System.Windows.Forms.Padding(29, 0, 0, 0);
			this.checkBoxTeamSameShiftCategory.Size = new System.Drawing.Size(253, 25);
			...
			this.checkBoxTeamSameShiftCategory.ThemesEnabled = false;
			...
			// 
			this.checkBoxBlockSameShiftCategory.BeforeTouchSize = new System.Drawing.Size(253, 25);
			this.checkBoxBlockSameShiftCategory.Dock = System.Windows.Forms.DockStyle.Fill;
			this.checkBoxBlockSameShiftCategory.DrawFocusRectangle = false;
			this.checkBoxBlockSameShiftCategory.Enabled = false;
			this.checkBoxBlockSameShiftCategory.Location = new System.Drawing.Point(20, 32);
			...
			this.checkBoxBlockSameShiftCategory.Padding = new System.Windows.Forms.Padding(29, 0, 0, 0);
			this.checkBoxBlockSameShiftCategory.Size = new System.Drawing.Size(253, 25);
			...
			this.checkBoxBlockSameShiftCategory.ThemesEnabled = false;
			...
			// 
			this.checkBoxBlockSameStartTime.BeforeTouchSize = new System.Drawing.Size(253, 29);
			this.checkBoxBlockSameStartTime.Dock = System.Windows.Forms.DockStyle.Fill;
			this.checkBoxBlockSameStartTime.DrawFocusRectangle = false;
			this.checkBoxBlockSameStartTime.Enabled = false;
			this.checkBoxBlockSameStartTime.Location = new System.Drawing.Point(20, 63);
			...
			this.checkBoxBlockSameStartTime.Padding = new System.Windows.Forms.Padding(29, 0, 0, 0);
			this.checkBoxBlockSameStartTime.Size = new System.Drawing.Size(253, 29);
			...
			this.checkBoxBlockSameStartTime.ThemesEnabled = false;
			...
			// 
			this.checkBoxBlockSameShift.BeforeTouchSize = new System.Drawing.Size(253, 27);
			this.checkBoxBlockSameShift.Dock = System.Windows.Forms.DockStyle.Fill;
			this.checkBoxBlockSameShift.DrawFocusRectangle = false;
			this.checkBoxBlockSameShift.Enabled = false;
			this.checkBoxBlockSameShift.Location = new System.Drawing.Point(20, 98);
			...
			this.checkBoxBlockSameShift.Padding = new System.Windows.Forms.Padding(29, 0, 0, 0);
			this.checkBoxBlockSameShift.Size = new System.Drawing.Size(253, 27);
			...
			this.checkBoxBlockSameShift.ThemesEnabled = false;
			...
			this.label2.Text = "xxBlockScheduling";
			...
			this.label7.Text = "xxTeamScheduling";
			this.label7.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// tabPageAdvance
			// 
			this.tabPageAdvance.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.tabPageAdvance.Controls.Add(this.tableLayoutPanel3);
			this.tabPageAdvance.Image = null;
			this.tabPageAdvance.ImageSize = new System.Drawing.Size(16, 16);
			this.tabPageAdvance.Location = new System.Drawing.Point(0, 23);
			this.tabPageAdvance.Name = "tabPageAdvance";
			this.tabPageAdvance.Padding = new System.Windows.Forms.Padding(10);
			this.tabPageAdvance.ShowCloseButton = true;
			this.tabPageAdvance.Size = new System.Drawing.Size(520, 586);
			this.tabPageAdvance.TabIndex = 2;
			this.tabPageAdvance.Text = "xxAdvanced";
			this.tabPageAdvance.ThemesEnabled = false;
			// 
			// tableLayoutPanel3
			// 
			this.tableLayoutPanel3.ColumnCount = 1;
			this.tableLayoutPanel3.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.tableLayoutPanel3.Controls.Add(this.lblShiftSelection, 0, 0);
			this.tableLayoutPanel3.Controls.Add(this.pnlShiftCategory, 0, 2);
			...
			this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 33.33333F));
			this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 23F));
			this.tableLayoutPanel3.Size = new System.Drawing.Size(498, 564);
			this.tableLayoutPanel3.TabIndex = 0;
			// 
			// lblShiftSelection
			// 
			this.lblShiftSelection.AutoSize = true;
			this.lblShiftSelection.Font = new System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.lblShiftSelection.Location = new System.Drawing.Point(3, 3);
			this.lblShiftSelection.Margin = new System.Windows.Forms.Padding(3);
			this.lblShiftSelection.Name = "lblShiftSelection";
			this.lblShiftSelection.Size = new System.Drawing.Size(93, 15);
			this.lblShiftSelection.TabIndex = 26;
			this.lblShiftSelection.Text = "xxShiftSelection";
			// 
			// pnlShiftCategory
			// 
			this.pnlShiftCategory.Controls.Add(this.tableLayoutPanel7);
			this.pnlShiftCategory.Dock = System.Windows.Forms.DockStyle.Fill;
			this.pnlShiftCategory.Location = new System.Drawing.Point(3, 206);
			this.pnlShiftCategory.Name = "pnlShiftCategory";
			this.pnlShiftCategory.Size = new System.Drawing.Size(492, 174);
			...
			this.tableLayoutPanel7.Controls.Add(this.checkBoxUseShiftCategory, 0, 0);
			this.tableLayoutPanel7.Controls.Add(this.comboBoxAdvShiftCategory, 1, 1);
			...
			this.tableLayoutPanel7.Size = new System.Drawing.Size(492, 174);
			this.tableLayoutPanel7.TabIndex = 18;
			// 
			// checkBoxUseShiftCategory
			// 
			this.checkBoxUseShiftCategory.BeforeTouchSize = new System.Drawing.Size(486, 24);
			...
			this.checkBoxUseShiftCategory.Size = new System.Drawing.Size(486, 24);
			...
			this.checkBoxUseShiftCategory.ThemesEnabled = false;
			...
			this.tableLayoutPanel8.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 236F));
			...
			this.tableLayoutPanel8.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 32F));
			this.tableLayoutPanel8.Size = new System.Drawing.Size(498, 67);
			this.tableLayoutPanel8.TabIndex = 23;
			// 
			// labelScheduleOrSchedules2
			// 
			this.labelScheduleOrSchedules2.Dock = System.Windows.Forms.DockStyle.Fill;
			this.labelScheduleOrSchedules2.Location = new System.Drawing.Point(317, 32);
			this.labelScheduleOrSchedules2.Name = "labelScheduleOrSchedules2";
			this.labelScheduleOrSchedules2.Size = new System.Drawing.Size(178, 35);
			this.labelScheduleOrSchedules2.TabIndex = 22;
			this.labelScheduleOrSchedules2.Text = "xxScheduleOrSchedules";
			this.labelScheduleOrSchedules2.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			...
			this.numericUpDownRefreshRate.Location = new System.Drawing.Point(249, 41);
			...
			this.numericUpDownRefreshRate.Size = new System.Drawing.Size(58, 23);
			...
			// 
			this.checkBoxUseMaximumPersons.BeforeTouchSize = new System.Drawing.Size(485, 23);
			...
			this.checkBoxUseMaximumPersons.Location = new System.Drawing.Point(10, 32);
			this.checkBoxUseMaximumPersons.Margin = new System.Windows.Forms.Padding(10, 3, 3, 3);
			...
			this.checkBoxUseMaximumPersons.Size = new System.Drawing.Size(485, 23);
			...
			this.checkBoxUseMaximumPersons.ThemesEnabled = false;
			// 
			// checkBoxUseMinimumPersons
			// 
			this.checkBoxUseMinimumPersons.BeforeTouchSize = new System.Drawing.Size(485, 23);
			...
			this.checkBoxUseMinimumPersons.Location = new System.Drawing.Point(10, 3);
			this.checkBoxUseMinimumPersons.Margin = new System.Windows.Forms.Padding(10, 3, 3, 3);
			...
			this.checkBoxUseMinimumPersons.Size = new System.Drawing.Size(485, 23);
			...
			// 
			this.checkBoxUseAverageShiftLengths.BeforeTouchSize = new System.Drawing.Size(485, 22);
			...
			this.checkBoxUseAverageShiftLengths.Location = new System.Drawing.Point(10, 119);
			...
			this.checkBoxUseAverageShiftLengths.Size = new System.Drawing.Size(485, 22);
			...
			this.Name = "SchedulingSessionPreferencesTabPanel";
			this.Size = new System.Drawing.Size(520, 609);
			this.Tag = "Main";
			...
			((System.ComponentModel.ISupportInitialize)(this.checkBoxShowTroubleShot)).EndInit();
			this.tableLayoutPanelRestrictions.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseShiftCategoryRestrictions)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxOnlyPreferenceDays)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUsePreferences)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseStudentAvailability)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxOnlyAvailabilityDays)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseAvailability)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseRotations)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxOnlyRotationDays)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxMustHaves)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.checkBoxTeamSameActivity)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.comboBoxTeamActivity)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxTeamSameEndTime)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxTeamSameStartTime)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.checkBoxTeamSameShiftCategory)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.checkBoxBlockSameShiftCategory)).EndInit();
			...
			this.pnlShiftCategory.ResumeLayout(false);
			this.tableLayoutPanel7.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.checkBoxUseShiftCategory)).EndInit();
		  ...
		  private Syncfusion.Windows.Forms.Tools.TabPageAdv tabPageAdvance;
        ...
        private System.Windows.Forms.TableLayoutPanel tableLayoutPanelRestrictions;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxOnlyPreferenceDays;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxUsePreferences;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxUseStudentAvailability;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxOnlyAvailabilityDays;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxUseAvailability;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxUseRotations;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxOnlyRotationDays;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxMustHaves;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxShowTroubleShot;
        ...
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxBlockSameShiftCategory;
        private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxBlockSameStartTime;
		  private Syncfusion.Windows.Forms.Tools.CheckBoxAdv checkBoxBlockSameShift;
