...
{
    partial class DefinitionSetDropDownView
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this.comboBoxAdvMultiplicatorDefinitionSets = new Syncfusion.Windows.Forms.Tools.ComboBoxAdv();
			this.labelSelectMultiplicatorDefinitionSet = new System.Windows.Forms.Label();
			this.textBoxDefinitionSetName = new System.Windows.Forms.TextBox();
			this.labelDefinitionSetName = new System.Windows.Forms.Label();
			this.textBoxMultiplicatorType = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.tableLayoutPanel1.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.comboBoxAdvMultiplicatorDefinitionSets)).BeginInit();
			this.SuspendLayout();
			// 
			// tableLayoutPanel1
			// 
			...
			this.tableLayoutPanel1.Controls.Add(this.comboBoxAdvMultiplicatorDefinitionSets, 1, 0);
			this.tableLayoutPanel1.Controls.Add(this.labelSelectMultiplicatorDefinitionSet, 0, 0);
			this.tableLayoutPanel1.Controls.Add(this.textBoxDefinitionSetName, 1, 1);
			this.tableLayoutPanel1.Controls.Add(this.labelDefinitionSetName, 0, 1);
			this.tableLayoutPanel1.Controls.Add(this.textBoxMultiplicatorType, 1, 2);
        ...
        private Syncfusion.Windows.Forms.Tools.ComboBoxAdv comboBoxAdvMultiplicatorDefinitionSets;
        private System.Windows.Forms.Label labelSelectMultiplicatorDefinitionSet;
        private System.Windows.Forms.TextBox textBoxDefinitionSetName;
        private System.Windows.Forms.Label labelDefinitionSetName;
        private System.Windows.Forms.TextBox textBoxMultiplicatorType;
