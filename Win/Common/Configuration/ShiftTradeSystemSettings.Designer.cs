...
{
	partial class ShiftTradeSystemSettings
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.tableLayoutPanelHeader.Size = new System.Drawing.Size(588, 38);
			...
			this.labelHeader.Size = new System.Drawing.Size(274, 25);
			...
			// 
			this.shiftTradeBusinessRuleSettingPanel.AutoSize = true;
			this.shiftTradeBusinessRuleSettingPanel.ColumnCount = 1;
			this.shiftTradeBusinessRuleSettingPanel.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.shiftTradeBusinessRuleSettingPanel.Controls.Add(this.shifTradeBusinessRuleSubHeader, 0, 0);
			...
			// 
			this.shifTradeBusinessRuleSubHeader.BackColor = System.Drawing.Color.LightSteelBlue;
			this.shifTradeBusinessRuleSubHeader.ColumnCount = 1;
			this.shifTradeBusinessRuleSubHeader.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.shifTradeBusinessRuleSubHeader.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.shifTradeBusinessRuleSubHeader.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.shifTradeBusinessRuleSubHeader.Controls.Add(this.lblShiftTradeBusinessRuleSettingHeader, 0, 0);
			this.shifTradeBusinessRuleSubHeader.Dock = System.Windows.Forms.DockStyle.Fill;
			this.shifTradeBusinessRuleSubHeader.Location = new System.Drawing.Point(3, 3);
			...
			// 
			this.lblShiftTradeBusinessRuleSettingHeader.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.lblShiftTradeBusinessRuleSettingHeader.AutoSize = true;
			this.lblShiftTradeBusinessRuleSettingHeader.Font = new System.Drawing.Font("Segoe UI", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.lblShiftTradeBusinessRuleSettingHeader.ForeColor = System.Drawing.Color.GhostWhite;
			this.lblShiftTradeBusinessRuleSettingHeader.Location = new System.Drawing.Point(3, 7);
			this.lblShiftTradeBusinessRuleSettingHeader.Name = "lblShiftTradeBusinessRuleSettingHeader";
			this.lblShiftTradeBusinessRuleSettingHeader.Padding = new System.Windows.Forms.Padding(0, 0, 0, 3);
			this.lblShiftTradeBusinessRuleSettingHeader.Size = new System.Drawing.Size(230, 20);
			this.lblShiftTradeBusinessRuleSettingHeader.TabIndex = 0;
			this.lblShiftTradeBusinessRuleSettingHeader.Text = "xxShiftTradeRequestValidatingRules";
			this.lblShiftTradeBusinessRuleSettingHeader.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// businessRuleSettingGrid
			// 
			this.businessRuleSettingGrid.AlphaBlendSelectionColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(94)))), ((int)(((byte)(171)))), ((int)(((byte)(222)))));
			this.businessRuleSettingGrid.ColCount = 3;
			this.businessRuleSettingGrid.ColWidthEntries.AddRange(new Syncfusion.Windows.Forms.Grid.GridColWidth[] {
            new Syncfusion.Windows.Forms.Grid.GridColWidth(0, 35)});
			this.businessRuleSettingGrid.DefaultGridBorderStyle = Syncfusion.Windows.Forms.Grid.GridBorderStyle.Solid;
			this.businessRuleSettingGrid.DefaultRowHeight = 20;
			this.businessRuleSettingGrid.Dock = System.Windows.Forms.DockStyle.Fill;
			this.businessRuleSettingGrid.GridOfficeScrollBars = Syncfusion.Windows.Forms.OfficeScrollBars.Office2007;
			this.businessRuleSettingGrid.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Metro;
			this.businessRuleSettingGrid.Location = new System.Drawing.Point(3, 43);
			this.businessRuleSettingGrid.Name = "businessRuleSettingGrid";
			this.businessRuleSettingGrid.NumberedColHeaders = false;
			this.businessRuleSettingGrid.NumberedRowHeaders = false;
			this.businessRuleSettingGrid.Office2007ScrollBars = true;
			this.businessRuleSettingGrid.Properties.BackgroundColor = System.Drawing.SystemColors.Window;
			this.businessRuleSettingGrid.Properties.ForceImmediateRepaint = false;
			this.businessRuleSettingGrid.Properties.GridLineColor = System.Drawing.Color.FromArgb(((int)(((byte)(212)))), ((int)(((byte)(212)))), ((int)(((byte)(212)))));
			this.businessRuleSettingGrid.Properties.MarkColHeader = false;
			this.businessRuleSettingGrid.Properties.MarkRowHeader = false;
			this.businessRuleSettingGrid.RowCount = 0;
			...
			this.businessRuleSettingGrid.ThemesEnabled = true;
			this.businessRuleSettingGrid.UseRightToLeftCompatibleTextBox = true;
			// 
			// buttonResetRule
			// 
			...
			this.tableLayoutPanel4.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 612F));
			...
			this.tableLayoutPanel4.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
			this.tableLayoutPanel4.Size = new System.Drawing.Size(612, 69);
			this.tableLayoutPanel4.TabIndex = 1;
			// 
			// ShiftTradeSystemSettings
			// 
		...
		private Syncfusion.Windows.Forms.ButtonAdv buttonResetRule;
		private Syncfusion.Windows.Forms.Grid.GridControl businessRuleSettingGrid;
	}
}
