namespace Teleopti.Ccc.Win.Common.Configuration
{
    partial class SiteControl
    {
		...
		private void InitializeComponent()
        {
			...
			// gridControlSites
			// 
			this.gridControlSites.AlphaBlendSelectionColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(94)))), ((int)(((byte)(171)))), ((int)(((byte)(222)))));
			this.gridControlSites.DefaultGridBorderStyle = Syncfusion.Windows.Forms.Grid.GridBorderStyle.Solid;
			this.gridControlSites.DefaultRowHeight = 20;
			...
			this.gridControlSites.GridOfficeScrollBars = Syncfusion.Windows.Forms.OfficeScrollBars.Metro;
			this.gridControlSites.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Metro;
			this.gridControlSites.Location = new System.Drawing.Point(3, 43);
			this.gridControlSites.MetroScrollBars = true;
			...
			this.gridControlSites.Properties.GridLineColor = System.Drawing.Color.FromArgb(((int)(((byte)(212)))), ((int)(((byte)(212)))), ((int)(((byte)(212)))));
			...
			this.gridControlSites.ThemesEnabled = true;
			...
			this.tableLayoutPanelSubHeader2.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 29F));
