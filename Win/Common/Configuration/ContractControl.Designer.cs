...
namespace Teleopti.Ccc.Win.Common.Configuration
{
    partial class ContractControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.timeSpanTextBoxPlanningMax.TimeSpanBoxWidth = 109;
			// 
			...
			this.timeSpanTextBoxPlanningMin.TimeSpanBoxWidth = 109;
			// 
			// labelTimeBankMax
			// 
			...
			this.textBoxExtMaxTimePerWeek.TimeSpanBoxWidth = 109;
			// 
			...
			this.textBoxExtNightlyRestTime.TimeSpanBoxWidth = 109;
			// 
			...
			this.textBoxExtWeeklyRestTime.TimeSpanBoxWidth = 109;
			// 
			...
			this.textBoxExMinTimeSchedulePeriod.TimeSpanBoxWidth = 109;
			// 
			// tableLayoutPanel1
			// 
			...
			this.timeSpanTextBoxNegativeTolerance.TimeSpanBoxWidth = 109;
			// 
			...
			this.timeSpanTextBoxPositiveTolerance.TimeSpanBoxWidth = 109;
			// 
			// autoLabel9
			// 
			...
			this.textBoxExtAvgWorkTimePerDay.TimeSpanBoxWidth = 109;
			// 
			...
			this.textBoxExtMinTimePerWeek.Size = new System.Drawing.Size(126, 29);
