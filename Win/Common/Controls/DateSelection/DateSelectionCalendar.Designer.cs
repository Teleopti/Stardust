namespace Teleopti.Ccc.Win.Common.Controls.DateSelection
{
    partial class DateSelectionCalendar : BaseUserControl
    {
        ...
        new System.DateTime(2012, 7, 18, 0, 0, 0, 0)};
			...
			this.monthCalendarAdv1.DateSelected += new System.EventHandler(this.monthCalendarAdv1_DateSelected);
			this.monthCalendarAdv1.DateChanged += new System.EventHandler(this.monthCalendarAdv1_DateChanged);
			this.monthCalendarAdv1.SelectionChanged += new System.EventHandler(this.monthCalendarAdv1_SelectionChanged);
			// 
