...
namespace Teleopti.Ccc.Win.Common.Controls
{
	...
	public partial class FindAndReplaceForm : BaseDialogForm
    {
        ...
        private void buttonAdvFindAllClick(object sender, EventArgs e)
        {
            ...
            // Sets the size of the search dialog
            Size = new Size(460, 467);
			// Shows the search results table 
        	gridListControlSearchResults.Visible = true;

            // Finds the data withing the grid
            findWithinGrid();
            ...
            //TODO: Sets the status bar message
            //statusBarSearchForm.Text = string.Format("{0} cell(s) found", 1);
            Cursor.Current = Cursors.Default;
        }
        ...
        private void buttonAdvReplaceAllClick(object sender, EventArgs e)
        {
            ...
            if ((!string.IsNullOrEmpty(SearchText)) && (!string.IsNullOrEmpty(ReplaceText)))
            {
                ...
                _findReplaceEventArguments = new GridFindReplaceEventArgs(SearchText, ReplaceText, getOption(),
                                                                         locationInfo);
        ...
        private GridFindTextOptions getOption()
        {
        ...
        private void findWithinGrid()
        {
			...
			// Clear the cells
        	gridListControlSearchResults.ClearCells(
        		(GridRangeInfo.Cells(1, 1, gridListControlSearchResults.RowCount, gridListControlSearchResults.ColCount)),
        		false);

            // Gets the search option
            GridFindTextOptions options = getOption();
