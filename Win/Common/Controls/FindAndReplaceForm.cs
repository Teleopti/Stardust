...
namespace Teleopti.Ccc.Win.Common.Controls
{
	...
	public partial class FindAndReplaceForm : BaseDialogForm
	{
		...
		private void addSearchEntry(string content, int row, int column)
		{
			...
			gridListControlSearchResults[_rowCount, 1].ReadOnly = false;
			gridListControlSearchResults[_rowCount, 2].ReadOnly = false;
			gridListControlSearchResults[_rowCount, 3].ReadOnly = false;
