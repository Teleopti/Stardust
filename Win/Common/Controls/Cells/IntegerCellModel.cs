...
namespace Teleopti.Ccc.Win.Common.Controls.Cells
{
    ...
    public class IntegerCellModel : GridTextBoxCellModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegerCellModel"/> class.
        /// </summary>
    ...
    public class IntegerCellRenderer : GridTextBoxCellRenderer
    {
        ...
        public override void OnPrepareViewStyleInfo(GridPrepareViewStyleInfoEventArgs e)
        {
            ...
            e.Style.HorizontalAlignment = ((IntegerCellModel)Model).HorizontalAlignment;//GridHorizontalAlignment.Right;
