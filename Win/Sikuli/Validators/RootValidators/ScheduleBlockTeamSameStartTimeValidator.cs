...
{
	internal class ScheduleBlockTeamSameStartTimeValidator : RootValidator
	{
		private readonly ISchedulerStateHolder _schedulerState;
		private readonly IAggregateSkill _totalSkill;

		public ScheduleBlockTeamSameStartTimeValidator(ISchedulerStateHolder schedulerState, IAggregateSkill totalSkill)
		{
