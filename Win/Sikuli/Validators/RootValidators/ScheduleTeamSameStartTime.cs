...
{
	internal class ScheduleTeamSameStartTime : RootValidator
	{
		private readonly ISchedulerStateHolder _schedulerState;
		private readonly IAggregateSkill _totalSkill;

		public ScheduleTeamSameStartTime(ISchedulerStateHolder schedulerState, IAggregateSkill totalSkill)
		{
