...
{
	internal class OptimizeTeamSameStartTime : RootValidator
	{
		private readonly ISchedulerStateHolder _schedulerState;
		private readonly IAggregateSkill _totalSkill;

		public OptimizeTeamSameStartTime(ISchedulerStateHolder schedulerState, IAggregateSkill totalSkill)
		{
