...
{
	internal class ScheduleTeamSameShiftCategory : RootValidator
	{
		private readonly ISchedulerStateHolder _schedulerState;
		private readonly IAggregateSkill _totalSkill;

		public ScheduleTeamSameShiftCategory(ISchedulerStateHolder schedulerState, IAggregateSkill totalSkill)
		{
