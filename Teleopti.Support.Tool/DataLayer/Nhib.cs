   ...
   public class Nhib
    {
        ...
        public string AggragationDatabase { get; set; }
        ...
        public Nhib(string analyticDatabase, string cCCDatabase, string aggragationDatabase, string cccConnectionString, string analyticConnectionString, string cccdataSource, string analyticDatasource, string factoryname,string fileName,string cccVersion,string aggVersion, string analyticVersion)
        {
            this.AnalyticDatabase = analyticDatabase;
            this.CCCDatabase = cCCDatabase;
            this.AggragationDatabase = aggragationDatabase;
