...
"%windir%\system32\inetsrv\AppCmd.exe" Stop Apppool "Teleopti ASP.NET v3.5"
"%windir%\system32\inetsrv\AppCmd.exe" Set Apppool "Teleopti ASP.NET v3.5" /autoStart:false
...
CSCRIPT "%ROOTDIR%..\WiseIISConfig\adsutil.vbs" STOP_SERVER "W3SVC/AppPools/Teleopti ASP.NET v3.5"
