...
namespace Teleopti.Ccc.InfrastructureTest.NHibernateConfiguration.Cache
{
	...
	public class ApplicationFunctionCollectionTest : DatabaseTestWithoutTransaction
	{
		...
		public void Setup1()
		{
			var dsFactory = new DataSourcesFactory(new EnversConfiguration(), new NoPersistCallbacks(), DataSourceConfigurationSetter.ForTestWithCache(), new CurrentHttpContext());
