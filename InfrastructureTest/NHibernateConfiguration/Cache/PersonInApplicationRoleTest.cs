...
namespace Teleopti.Ccc.InfrastructureTest.NHibernateConfiguration.Cache
{
	...
	public class PersonInApplicationRoleTest : DatabaseTestWithoutTransaction
	{
		...
		public void Setup1()
		{
			var dsFactory = new DataSourcesFactory(new EnversConfiguration(), new NoMessageSenders(), DataSourceConfigurationSetter.ForTestWithCache(), new CurrentHttpContext(), null);
