...
namespace Teleopti.Ccc.InfrastructureTest.Rta.AgentStateReadModelReader
{
	...
	public class ForExcludingStateGroupsForTeamAndSkill
	{
		...
		public void ShouldLoadForTeamsAndSkill()
		{
			...
			WithUnitOfWork.Get(() => Target.ReadInAlarmExcludingPhoneStatesForTeamsAndSkill(new[] { teamId }, new[] { skillId }, new Guid?[] { loggedOut }))
		...
		public void ShouldLoadTop50InAlarmForTeamAndSkill()
		{
			...
			WithUnitOfWork.Get(() => Target.ReadInAlarmExcludingPhoneStatesForTeamsAndSkill(new[] { team }, new[] { skillId }, new Guid?[] { null }))
		...
		public void ShouldNotLoadDuplicateRowsForTeamsAndSkill()
		{
			...
			WithUnitOfWork.Get(() => Target.ReadInAlarmExcludingPhoneStatesForTeamsAndSkill(new[] { teamId }, new[] { phone, email }, new Guid?[] { loggedOut }))
				.Single().PersonId.Should().Be(expected);
		}
		...
		public void ShouldLoadInAlarmForTeamAndSkill()
		{
			...
			WithUnitOfWork.Get(() => Target.ReadInAlarmExcludingPhoneStatesForTeamsAndSkill(new[] { team }, new[] { currentSkillId }, new Guid?[] { null }))
				.Single().PersonId.Should().Be(expected);
		}
		...
		public void ShouldNotLoadForPreviousSkill()
		{
			...
			WithUnitOfWork.Get(() => Target.ReadInAlarmExcludingPhoneStatesForTeamsAndSkill(new[] { team }, new[] { email }, new Guid?[] { null }))
				.Should().Be.Empty();
		}
		...
		public void ShouldLoadForTeamsAndSkillWhenExcludingNull()
		{
			...
			WithUnitOfWork.Get(() => Target.ReadInAlarmExcludingPhoneStatesForTeamsAndSkill(new[] { teamId }, new[] { skillId }, new Guid?[] { loggedOut, null }))
				.Single().PersonId.Should().Be(expected);
		}
