...
{
	[TestFixture]
	public class SimpleAnsweredCallsTest
	{
		...
		public void ShouldReturnAnsweredCalls()
		{
			...
			_analyticsDataFactory.Setup(new FactAgentQueue(0, 1, 1, 1, 1, 1, answeredCalls, 1, dataSource.RaptorDefaultDatasourceId));
