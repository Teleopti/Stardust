...
namespace Teleopti.Ccc.InfrastructureTest.WebReports.DailyMetricsForDay
{
	...
	public class AverageAfterCallWorkTest : WebReportTest
	{
		...
		{
			analyticsDataFactory.Setup(new FactAgentQueue(TheDate.DateId,1, 1, AcdLoginId, 1, afterCallWorkQueueOne, answeredCallsQueueOne, 1));
			analyticsDataFactory.Setup(new FactAgentQueue(TheDate.DateId, 1, 2, AcdLoginId, 1, afterCallWorkQueueTwo, answeredCallsQueueTwo, 1));
		}
