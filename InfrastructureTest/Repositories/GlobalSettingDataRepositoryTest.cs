...
namespace Teleopti.Ccc.InfrastructureTest.Repositories
{
	...
	public class GlobalSettingDataRepositoryTest : DatabaseTest
	{
		...
		public IBusinessUnitFilterOverrider BusinessUnitFilterOverrider;
		...
		[Test]
		public void VerifyThatWithNonValidBusinessUnitThrowsException()
		{
			var businessUnitEmptyGuid = BusinessUnitFactory.CreateSimpleBusinessUnit("test").WithId(Guid.Empty);
			BusinessUnitScope.OnThisThreadUse(businessUnitEmptyGuid);
			WithUnitOfWork.Do(() =>
			{
				Assert.Throws<ApplicationException>(() =>
				{
					GlobalSettingDataRepository.FindValueByKey("not existing", dummyValue());
				});
			});
		}
		...
		[Test]
		public void SaveGlobalSettingForTwoBusinessUnit()
		{
