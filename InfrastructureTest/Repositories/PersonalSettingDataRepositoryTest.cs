    ...
    public class PersonalSettingDataRepositoryTest
    {
		...
		public void VerifyFindValueByKeyAndPerson()
		{
			...
			testData s = WithUnitOfWork.Get(() =>
				PersonalSettingData.FindValueByKeyAndOwnerPerson("rätt", Persons.Get(TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.PersonId), new testData()));
		...
		public void VerifyNotFindValueByKeyAndPersonThenUseDefault()
		{
			...
			testData s = WithUnitOfWork.Get(() => 
				PersonalSettingData.FindValueByKeyAndOwnerPerson("idonotexist", Persons.Get(TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.PersonId), new testData { Data = -1 }));
		...
		{
			var person = WithUnitOfWork.Get(() => Persons.Get(TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.PersonId));
