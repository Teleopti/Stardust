...
namespace Teleopti.Ccc.InfrastructureTest.Repositories
{
    ...
    public class PersonAssignmentRepositoryTest : RepositoryTest<IPersonAssignment>
    {
        ...
        [Test]
        public void CanFindAssignmentsByAbsencePersonAndPeriod()
        {

            IAbsence absenceToSearch = new Absence {Description = new Description("Absence", "Ab")};
            IList<DateTimePeriod> absencePeriods = new List<DateTimePeriod>();

            var absenceRepository = _mocker.StrictMock<IPersonAbsenceRepository>();


            var searchPeriod =
                new DateTimePeriod(new DateTime(2007, 1, 1, 0, 0, 0, DateTimeKind.Utc),
                                   new DateTime(2007, 12, 1, 0, 0, 0, DateTimeKind.Utc));

            var period1 =
                 new DateTimePeriod(new DateTime(2007, 1, 10, 0, 0, 0, DateTimeKind.Utc),
                                   new DateTime(2007, 1, 11, 0, 0, 0, DateTimeKind.Utc));

            var period2 =
                new DateTimePeriod(new DateTime(2007, 3, 15, 0, 0, 0, DateTimeKind.Utc),
                                  new DateTime(2007, 3, 16, 0, 0, 0, DateTimeKind.Utc));

            var period3 =
                new DateTimePeriod(new DateTime(2007, 7, 5, 0, 0, 0, DateTimeKind.Utc),
                                  new DateTime(2007, 7, 6, 0, 0, 0, DateTimeKind.Utc));

            var period4 =
              new DateTimePeriod(new DateTime(2007, 8, 5, 0, 0, 0, DateTimeKind.Utc),
                                new DateTime(2007, 8, 6, 0, 0, 0, DateTimeKind.Utc));

            var period5 =
              new DateTimePeriod(new DateTime(2007, 10, 1, 0, 0, 0, DateTimeKind.Utc),
                                new DateTime(2007, 10, 20, 0, 0, 0, DateTimeKind.Utc));

            absencePeriods.Add(period1);
            absencePeriods.Add(period2);
            absencePeriods.Add(period3);
            absencePeriods.Add(period5); //Add a period that does not contain any assignment
            ////////////setup////////////////////////////////////////////////////////////////

            IPersonAssignment assignment1 = PersonAssignmentFactory.CreateAssignmentWithMainShift(
               _dummyActivity,
               _dummyAgent,
               period1,
               _dummyCategory,
            ...
            IPersonAssignment assignment2 = PersonAssignmentFactory.CreateAssignmentWithMainShift(
               _dummyActivity,
               _dummyAgent,
               period2,
               _dummyCategory,
            ...
            IPersonAssignment assignment3 = PersonAssignmentFactory.CreateAssignmentWithMainShift(
               _dummyActivity,
               _dummyAgent,
               period3,
               _dummyCategory,
            ...
            IPersonAssignment assignment4 = PersonAssignmentFactory.CreateAssignmentWithMainShift(
               _dummyActivity,
               _dummyAgent,
               period4,
               _dummyCategory,
            ...
            PersistAndRemoveFromUnitOfWork(absenceToSearch);
            PersistAndRemoveFromUnitOfWork(assignment1);
            PersistAndRemoveFromUnitOfWork(assignment2);
            PersistAndRemoveFromUnitOfWork(assignment3);
            PersistAndRemoveFromUnitOfWork(assignment4);  //Assignment will not be read because there is no absenceperiod for this period

            /////////////////////////////////////////////////////////////////////////////////

            using (_mocker.Record())
            {
                Expect.Call(absenceRepository.AffectedPeriods(_dummyAgent, _dummyScenario, searchPeriod, absenceToSearch))
                    .Return(absencePeriods);
            }
            IList<IPersonAssignment> retList = new List<IPersonAssignment>(((PersonAssignmentRepository)_rep).Find(searchPeriod, _dummyScenario, _dummyAgent, absenceToSearch, absenceRepository));
            Assert.AreEqual(3, retList.Count);

            retList = new List<IPersonAssignment>(_rep.Find(searchPeriod, _dummyScenario, _dummyAgent, absenceToSearch));
            Assert.AreEqual(0, retList.Count,"the absencerepository does not return any periods");
        }
