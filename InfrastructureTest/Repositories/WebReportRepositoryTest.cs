...
namespace Teleopti.Ccc.InfrastructureTest.Repositories
{
	...
	public class WebReportRepositoryTest : DatabaseTest
	{
		...
		{
			_target.ReportControlSkillGet(ReportCommonInput.ReportId, ReportCommonInput.PersonCode, ReportCommonInput.LanguageId,
			                             ReportCommonInput.BusinessUnitCode)
				.Should().Not.Be.Empty();
		}
	}
