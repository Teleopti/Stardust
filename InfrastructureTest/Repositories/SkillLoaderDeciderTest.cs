...
namespace Teleopti.Ccc.InfrastructureTest.Repositories
{
	...
	public class SkillLoaderDeciderTest
	{
		...
		{
			Assert.Throws<InvalidOperationException>(() => target.FilterSkills(new ISkill[] { }, null, null));
		}

		[Test]
		public void CannotCallFilterPeopleBeforeExecute()
		{
			Assert.Throws<InvalidOperationException>(() => target.FilterPeople(new List<IPerson>()));
		}
