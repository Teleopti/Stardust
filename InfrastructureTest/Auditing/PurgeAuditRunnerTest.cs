...
namespace Teleopti.Ccc.InfrastructureTest.Auditing
{
	...
	public class PurgeAuditRunnerTest
	{
		...
		private void insertSomeStaffingAudits()
		{
			...
			StaffingAuditRepository.Add(new StaffingAudit(singaporeUser, StaffingAuditActionConstants.ImportBpo, "BPO", "abc.txt") { TimeStamp = new DateTime(2017, 6, 14, 14, 0, 0, DateTimeKind.Utc) });
			CurrentUnitOfWork.Current().PersistAll();
		}
