...
namespace Teleopti.Ccc.InfrastructureTest.Persisters
{
    ...
    public class ScheduleScreenDerivedScheduleDataTest
    {
        ...
        {
            _target = new ScheduleScreenRefresher(_messageQueueUpdater, new ScheduleRefresher(MockRepository.GenerateMock<IPersonAssignmentRepository>(), MockRepository.GenerateMock<IPersonRepository>(), _scheduleDataUpdater), new ScheduleDataRefresher(_scheduleRepository, MockRepository.GenerateMock<IPersonAssignmentRepository>(), MockRepository.GenerateMock<IPersonRepository>(), _scheduleDataUpdater), new MeetingRefresher(null), new PersonRequestRefresher(null));
        }
