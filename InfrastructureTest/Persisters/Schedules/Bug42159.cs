...
namespace Teleopti.Ccc.InfrastructureTest.Persisters.Schedules
{
	...
	public class Bug42159
	{
		...
		public virtual void ShouldNotDoAnyUpdateIfNoRealChangesWereMade()
		{
			...
			{
				scheduleDictionary = ScheduleStorage.FindSchedulesForPersons(new DateTimePeriod(1900,1,1,2100,1,1),scenario, new PersonProvider(new [] {agent}), new ScheduleDictionaryLoadOptions(false, false), new [] {agent});
			}
