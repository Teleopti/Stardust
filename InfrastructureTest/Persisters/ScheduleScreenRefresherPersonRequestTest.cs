...
namespace Teleopti.Ccc.InfrastructureTest.Persisters
{
    ...
    public class ScheduleScreenRefresherPersonRequestTest
    {
        ...
        {
            _target = new ScheduleScreenRefresher(_messageQueueUpdater, new ScheduleRefresher(null, null, MockRepository.GenerateMock<IUpdateScheduleDataFromMessages>()), new ScheduleDataRefresher(null, null, null, null), new MeetingRefresher(null), new PersonRequestRefresher(_personRequestUpdater));
        }
