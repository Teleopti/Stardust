...
namespace Teleopti.Ccc.InfrastructureTest.Persisters.Refresh
{
	...
	public class ScheduleRefresherTest
	{
		...
		public void ShouldNotRaiseConflictWhenSameVersionInMemoryAsFromMessage()
		{
			...
			var scheduleRange = new ScheduleRange(scheduleDictionary, new ScheduleParameters(personAssignment.Scenario, person, period), new PersistableScheduleDataPermissionChecker(new PermissionProvider(PrincipalAuthorization.Current())), PrincipalAuthorization.Current());
