...
namespace Teleopti.Ccc.ApplicationConfigTest.Common
{
    ...
    public class ProgramHelperTest
    {
        ...
        public void CanLogOn()
        {
            ...
            Assert.IsNotNull(((ITeleoptiIdentity)TeleoptiPrincipal.CurrentPrincipal.Identity).DataSource);
        }
        ...
        private void logonForTest()
        {
            ...
            DefaultDataCreator defaultDataCreator = new DefaultDataCreator("Test", _commandLineArgument.CultureInfo, _commandLineArgument.TimeZone, _commandLineArgument.NewUserName, _commandLineArgument.NewUserPassword, factory, null);
