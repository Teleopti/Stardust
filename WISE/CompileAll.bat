...
::CCC_server
XCOPY "%DEPENDENCIESSRC%\ccc7_server\DemoDatabase\v7\TeleoptiAnalytics_Demo.bak" "%WISESOURCEFILE%\DemoDatabase\" /D /Y
XCOPY "%DEPENDENCIESSRC%\ccc7_server\DemoDatabase\v7\TeleoptiCCC7_Demo.bak" "%WISESOURCEFILE%\DemoDatabase\" /D /Y
XCOPY "%DEPENDENCIESSRC%\ccc7_server\DemoDatabase\v7\TeleoptiCCC7Agg_Demo.BAK" "%WISESOURCEFILE%\DemoDatabase\" /D /Y
