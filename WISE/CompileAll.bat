...
::CCC_server
XCOPY "%DEPENDENCIESSRC%\ccc7_server\DemoDatabase\390\TeleoptiAnalytics_Demo.bak" "%WISESOURCEFILE%\DemoDatabase\" /D /Y
XCOPY "%DEPENDENCIESSRC%\ccc7_server\DemoDatabase\390\TeleoptiCCC7_Demo.bak" "%WISESOURCEFILE%\DemoDatabase\" /D /Y
XCOPY "%DEPENDENCIESSRC%\ccc7_server\DemoDatabase\390\TeleoptiCCC7Agg_Demo.BAK" "%WISESOURCEFILE%\DemoDatabase\" /D /Y
