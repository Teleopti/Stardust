...
ECHO "%WorkingFolder%\wget.exe" -e robots=off -k -P"%WorkingFolder%" -r -R "*Special*","index*","*Help*" -E "%WebURL%"
"%WorkingFolder%\wget.exe" -e robots=off -k -P"%WorkingFolder%" -r -R "*Special*","index*","*Help*" -E "%WebURL%"
