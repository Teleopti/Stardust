...
{
    [TestFixture]
    public class SkillDataPeriodConverterTest
    {
        private SkillDataPeriodConverter target;
        private IUnitOfWork uow;
        private MappedObjectPair mappedObjectPair;
        private Mapper<SkillDataPeriod, global::Domain.SkillData> mapper;
        ...
        public void Setup()
        {
            ...
            mapper = mocks.CreateMock<Mapper<SkillDataPeriod, global::Domain.SkillData>>(mappedObjectPair, TimeZoneInfo.Local);
            target = new SkillDataPeriodConverter(uow, mapper);
        }
