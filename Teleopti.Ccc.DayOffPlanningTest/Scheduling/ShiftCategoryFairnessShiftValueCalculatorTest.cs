...
namespace Teleopti.Ccc.DayOffPlanningTest.Scheduling
{
    ...
    public class ShiftCategoryFairnessShiftValueCalculatorTest
    {
        ...
        public void Setup()
        {
            ...
            _target = new ShiftCategoryFairnessShiftValueCalculator(new SchedulingOptions { Fairness = new Percent(0.5d) });
        }

        [Test]
        public void VerifyModifiedShiftValueWithPositive()
        {
            double result = _target.ModifiedShiftValue(1000d, 1.6384d, 1000d);
        ...
        {
            double result = _target.ModifiedShiftValue(0d, 2.25d, 1000d);
        ...
        {
            double result = _target.ModifiedShiftValue(-500d, 2.25d, 1000d);
        ...
        {
            _target = new ShiftCategoryFairnessShiftValueCalculator(new SchedulingOptions { Fairness = new Percent(0.25d) });
            double result = _target.ModifiedShiftValue(-500d, 2.25d, 1000d);
        ...
        {
            _target = new ShiftCategoryFairnessShiftValueCalculator(new SchedulingOptions { Fairness = new Percent(0.25d) });
            double result = _target.ModifiedShiftValue(-1000d, 2.25d, 1000d);
            Assert.AreEqual(-187.5d, result);
        }
