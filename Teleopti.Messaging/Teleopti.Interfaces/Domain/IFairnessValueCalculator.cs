...
namespace Teleopti.Interfaces.Domain
{
    ...
    public interface IFairnessValueCalculator
    {
    	...
    	/// <returns></returns>
    	double CalculateFairnessValue(double shiftValue, double shiftCategoryFairnessPoint, double maxFairnessPoint,
    	                              double totalFairness, IFairnessValueResult agentFairness, double maxShiftValue,
