...
namespace Teleopti.Interfaces.Domain
{
    ...
    /// </remarks>
    public interface ISkillDay : IForecastData, ITaskOwner, IRestrictionChecker<ISkillDay>, ITemplateDay, ICloneableEntity<ISkillDay>, ILayerCollectionOwner<ISkillStaff>
    {
        /// <summary>
        /// Gets the Scenario
        /// </summary>
