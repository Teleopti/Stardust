...
namespace Teleopti.Interfaces.Domain
{
    ...
    public interface IResourceOptimizationHelper
    {
        ...
        /// <returns></returns>
        ISkillSkillStaffPeriodExtendedDictionary CreateSkillSkillStaffDictionaryOnSkills(ISkillSkillStaffPeriodExtendedDictionary skillStaffPeriodDictionary, IList<ISkill> skills, DateTimePeriod keyPeriod);
