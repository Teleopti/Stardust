...
namespace Teleopti.Messaging.Protocols
{
    ...
    public class ClientProtocol : Protocol
    {
        ...
        public ClientProtocol(IMessageBroker messageBroker, ISocketInfo socketInformation) : base(socketInformation)
        {
        ...
        public ClientProtocol(IBrokerService brokerService, int startPort, string address, int port, int timeToLive) : base(brokerService, address, port, timeToLive)
        {
        ...
        {
            ClientManager.GetInstance(BrokerService, _startPort, ClientThrottle).QueueMessage(Address, Port, value);
        }
