...
namespace Teleopti.Logging.Core
{
    ...
    /// </summary>
    [SuppressMessage("Microsoft.Naming", "CA1710:IdentifiersShouldHaveCorrectSuffix"), Serializable]
    public class LogEntry : EventArgs, ILogEntry
    {
        ...
        protected LogEntry(SerializationInfo info, StreamingContext context)
        {
