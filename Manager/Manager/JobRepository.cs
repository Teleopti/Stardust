...
namespace Stardust.Manager
{
	...
	//						CreateInsertIntoJobHistoryDetailCommand(jobDefinition.JobId, Added, DateTime.UtcNow);
 ...
 //                       }
	...
	//	public async void CancelJobByJobId(Guid id, IHttpSender httpSender)
	//	{
	//		try
	//		{
	//			using (var sqlConnection = new SqlConnection(_connectionString))
	...
	//						CreateSelectFromJobDefinitionsWithTabLockCommand(id);
	...
	//								//--------------------------------------------
	//								var deleteFromJobDefinitionsCommand =
	//									CreateDeleteFromJobDefinitionsCommand(id);
	...
	//								var uriCancel = builderHelper.GetCancelJobUri(id);
	...
	//									//---------------------------------------------------
	//									var insertIntoJobHistoryDetailCommand =
	//										CreateInsertIntoJobHistoryDetailCommand(id, Canceling, DateTime.UtcNow);
	...
	//							                                 "] : Could not find job defintion for id : " + id);
	//						}
	//					}
	//					sqlTransaction.Commit();
	//				}
	...
	//	public void ReportProgress(Guid id,
	//	                           string detail,
	//	                           DateTime created)
	//	{
	//		try
	...
	//				var insertIntoJobHistoryDetailCommand =
	//					CreateInsertIntoJobHistoryDetailCommand(id, detail, created);
 ...
 //                                       FROM [Stardust].JobDefinitions 
	...
	//		command.Parameters.AddWithValue("@By", job.CreatedBy);
	...
	//		command.Parameters.AddWithValue("@Id", jobDefinition.JobId);
	//		command.Parameters.AddWithValue("@Name", jobDefinition.Name);
	//		command.Parameters.AddWithValue("@UserName", jobDefinition.CreatedBy);
