...
namespace ManagerTest
{
	class ManagerConfigurationTest
	{
		...
		{
			new ManagerConfiguration(null, "Route", 1, 1);
		}
		...
		{
			new ManagerConfiguration("test", null, 1, 1);
		}
		...
		{
			new ManagerConfiguration("test", "Route", 0, 1);
		}
		...
		{
			new ManagerConfiguration("test", "Route", 1, 0);
		}
	}
}
