...
namespace Teleopti.Ccc.WebTest.Areas.Start.Controllers
{
    ...
    public class UrlControllerTest
    {
        ...
        public void ShouldSignUrlCorrectly()
        {
            ...
            var context = new HttpContext(new HttpRequest("file", url, "querystring"), new HttpResponse(new StringWriter()));
            ...
            var urlController = new UrlController(new CurrentHttpContext());
            var result = urlController.Index();
            Assert.AreEqual(url, ((result as JsonResult).Data as dynamic).Url);
