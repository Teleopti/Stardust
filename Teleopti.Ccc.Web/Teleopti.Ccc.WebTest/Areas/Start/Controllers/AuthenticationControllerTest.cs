...
namespace Teleopti.Ccc.WebTest.Areas.Start.Controllers
{
	...
	public class AuthenticationControllerTest
	{
		...
		public void ShouldReturnSignInView()
		{
			...
			var target = new AuthenticationController(layoutBaseViewModelFactory, null, null, null, null, null,null, null, null);
		...
		{
			var target = new AuthenticationController(null, null, null, null,null, new CheckTenantUserExistsFake(), null, null, null);
		...
		{
			var target = new AuthenticationController(null, null, null, null, null, new CheckTenantUserExistsFake(true), null, null, null);
