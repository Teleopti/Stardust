...
using Teleopti.Ccc.WebTest.Core.TeamSchedule.Mapping;
...
namespace Teleopti.Ccc.WebTest.Areas.MyTime.Core.TeamSchedule.Mapping
{
	public class TeamScheduleTestAttribute : IoCTestAttribute
	{
		protected override void RegisterInContainer(ContainerBuilder builder, IIocConfiguration configuration)
		{
			...
			builder.RegisterType<TeamScheduleViewModelReworkedMapper>().As<ITeamScheduleViewModelReworkedMapper>().SingleInstance();
			...
			builder.RegisterInstance(new FakeTeamSchedulePersonsProvider()).As<ITeamSchedulePersonsProvider>().SingleInstance();
			builder.RegisterInstance(new FakePersonScheduleDayReadModelFinder()).As<IPersonScheduleDayReadModelFinder>().SingleInstance();
			builder.RegisterInstance(new FakePersonRepository()).As<IPersonRepository>().SingleInstance();
