...
namespace Teleopti.Ccc.WebTest.Areas.MyTime.Controllers
{
	...
	public class MessageControllerTest
	{
		...
		{
			var target = new MessageController(MockRepository.GenerateMock<IMessageViewModelFactory>(), null);
		...
		public void ShouldReturnViewModelForMessages()
		{
			...
			var target = new MessageController(viewModelFactory, null);
		...
		public void ShouldReplyToSimpleMessage()
		{
			...
			var target = new MessageController(viewModelFactory, pushMessageDialoguePersister);
