...
namespace Teleopti.Ccc.WebTest.Areas.Rta.ImplementationDetailsTests.Adherence
{
	public class TeamAdherenceTest
	{
		...
		public void ShouldMapOutOfAdherenceBasedOnPositiveStaffingEffect()
		{
			...
			broker.LastTeamNotification.DeserializeBindaryData<TeamAdherenceMessage>().OutOfAdherence.Should().Be(1);
		}
		...
		public void ShouldAggregateAdherenceFor2PersonsInATeam()
		{
			...
			broker.LastTeamNotification.DeserializeBindaryData<TeamAdherenceMessage>().OutOfAdherence.Should().Be(2);
		}
