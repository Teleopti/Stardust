...
{
	[TenantTest]
	public class PersonInfoLogonInfoFromIdentitiesTest
	{
		...
		public void ShouldFetchLogonInfos()
		{
			...
			Target.LogonInfosFromIdentities(new[] { logonInfo1.Identity, logonInfo2.Identity }).Result<IEnumerable<LogonInfo>>()
		...
		public void ShouldThrowIfNoValidTenantCredentialsWhenReadingLogonInfo()
		{
			...
			var res = Assert.Throws<HttpException>(() => Target.LogonInfosFromIdentities(Enumerable.Empty<string>()));
