...
namespace Teleopti.Ccc.WebTest.Core.Portal
{
	...
	public class PortalViewModelFactoryPreferencesTest
	{
		...
		public void ShouldRetrieveShiftCategoriesIntoPreferenceSplitButton()
		{
			...
			var target = new PortalViewModelFactory(new FakePermissionProvider(), preferenceOptionsProvider, MockRepository.GenerateMock<ILicenseActivator>(), MockRepository.GenerateStub<IPrincipalProvider>());
		...
		public void ShouldHaveSplitterInPreferenceSplitButton()
		{
			...
			var target = new PortalViewModelFactory(permissionProvider, preferenceOptionsProvider, MockRepository.GenerateMock<ILicenseActivator>(), MockRepository.GenerateStub<IPrincipalProvider>());
