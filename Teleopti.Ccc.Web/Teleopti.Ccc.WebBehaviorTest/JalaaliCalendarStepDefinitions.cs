...
namespace Teleopti.Ccc.WebBehaviorTest
{
	...
	public class JalaaliCalendarStepDefinitions
	{
		...
		public void ThenIShouldSeeAJalaaliTimePickerWith(int hours, int minutes, string meridiem)
		{

			Browser.Interactions.AssertInputValue (".bootstrap-timepicker-hour", hours.ToString());
			Browser.Interactions.AssertInputValue (".bootstrap-timepicker-minute", minutes.ToString());
