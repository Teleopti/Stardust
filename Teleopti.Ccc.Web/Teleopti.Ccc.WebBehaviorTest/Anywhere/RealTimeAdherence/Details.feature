...
Scenario:  Should caculate adherence details according to agent local timezone
	...
	And Pierre Baldi has a person period with
	 ...
	 | External Logon | Pierre Baldi |
	And 'Pierre Baldi' is located in '(UTC) Coordinated Universal Time'
	And Pierre Baldi has a shift with
	| Field                    | Value            |
	| Start time               | 2014-10-07 04:00 |
	| End time                 | 2014-10-07 06:00 |
	| Activity                 | Phone            |
	And there is an alarm with 
	| Field           | Value        |
	| Activity        | Phone        |
	...
	| Alarm Color     | Green    |
	| Staffing effect | 0        |
	When the time is '2014-10-06 18:00:00'
	And 'Pierre Baldi' sets his phone state to 'Ready' on datasource 6
	And the time is '2014-10-06 18:30:00'
	And 'Pierre Baldi' sets his phone state to 'Pause' on datasource 6
	And the time is '2014-10-06 20:00:00'
	And I view manage adherence view for agent 'Pierre Baldi'
	Then I should see daily adherence for 'Pierre Baldi' is 25%
	And I should see 'Phone' with adherence of 25%