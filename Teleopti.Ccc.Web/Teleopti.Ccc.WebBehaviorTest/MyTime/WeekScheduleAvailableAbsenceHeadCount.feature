...
Scenario: Show the user a green indication of new icon at head count staffing check when allowance exceeds used absence
	Given the time is '2023-05-25 20:00'
	And there is a budgetday
	| Field						| Value					|
	| BudgetGroup				| TheBudgetGroup		|
...
@OnlyRunIfEnabled('MyTimeWeb_NewTrafficLightIconHelpingColorBlindness_78640')
Scenario: Show the user a yellow indication of new icon at head count staffing check when one allowance is left
	Given the time is '2023-05-25 20:00'
	And there is a budgetday
	| Field						| Value					|
	| BudgetGroup				| TheBudgetGroup		|
	...
	| Absence		| holiday				|
	When I view my week schedule for date '2023-05-28'
	Then I should see an 'fair' indication of new icon for chance of absence request on '2023-05-28'

@OnlyRunIfEnabled('MyTimeWeb_NewTrafficLightIconHelpingColorBlindness_78640')
Scenario: Show the user a red indication of new icon at head count staffing check when the allowance is used up
	Given the time is '2023-05-25 20:00'
	And there is a budgetday
	| Field						| Value					|
	| BudgetGroup				| TheBudgetGroup		|
	...
	| Absence		| holiday				|
	When I view my week schedule for date '2023-05-28'
	Then I should see an 'poor' indication of new icon for chance of absence request on '2023-05-28'

@OnlyRunIfEnabled('MyTimeWeb_NewTrafficLightIconHelpingColorBlindness_78640')
Scenario: Show the user no indication of new icon at mixed staffing check when last open period is not validate with budget group
	Given the time is '2023-05-25 20:00'
	And there is a budgetday
	| Field						| Value					|
	| BudgetGroup				| TheBudgetGroup		|
