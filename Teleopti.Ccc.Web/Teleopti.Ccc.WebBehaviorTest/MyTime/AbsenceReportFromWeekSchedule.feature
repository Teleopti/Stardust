...
Scenario: Open add absence report form from day summary only for today and tomorrow on desktop week view
...
Scenario: Cancel a draft absence report on desktop week view
	Given I have the role 'Full access to mytime'
...
Scenario: Save an absence report on desktop week view
	Given I have the role 'Full access to mytime'
	And the current time is '2020-10-05'
	And I view my week schedule for date '2020-10-05'
	When I click on the day summary for date '2020-10-05'
...
Scenario: Can not add absence report if no permission on desktop week view
	Given I have the role 'No access to absence report'
	And I view my week schedule for date '2020-10-05'
	When I click on the day symbol area for date '2020-10-05'
	Then I should not see the add absence report button
@ignore	
Scenario: Open add absence report form from day summary only for today and tomorrow on mobile week view
	Given I have the role 'Full access to mytime'
	And the current time is '2020-10-05'
	...
	Then I should see the add absence report form
@ignore
Scenario: Cancel a draft absence report on mobile week view
	Given I have the role 'Full access to mytime'
	And the current time is '2020-10-05'
    When I view my mobile week schedule for date '2020-10-05'
	...
	Then I should not see the add absence report form
@ignore
Scenario: Save a draft absence report on mobile week view
	Given I have the role 'Full access to mytime'
	And the current time is '2020-10-05'
    When I view my mobile week schedule for date '2020-10-05'
	And I click on add absence report button for '2020-10-05'
	...
	Then I should not see the add absence report form
@ignore
Scenario: Can not add absence report if no permission on mobile week view
	Given I have the role 'No access to absence report'
    When I view my mobile week schedule for date '2020-10-05'
	Then I should not see the add absence report button
@ignore
Scenario: Switch between today and tomorrow on mobile week view
	Given I have the role 'Full access to mytime'
	And the current time is '2020-10-05'
    When I view my mobile week schedule for date '2020-10-05'
	And I click on add absence report button for '2020-10-05'
