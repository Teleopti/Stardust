...
namespace Teleopti.Ccc.WebBehaviorTest.MyTime
{
    ...
    public class MonthlyScheduleStepDefinitions
    {
        ...
        {
            Browser.Interactions.Click(".submenu .glyphicon-chevron-right");
        }

        [When(@"I choose to go to previous month")]
        public void WhenIChooseToGoToPreviousMonth()
        {
            Browser.Interactions.Click(".submenu .glyphicon-chevron-left");
        }
        ...
        {
            Browser.Interactions.Click(".submenu .glyphicon-calendar");
		...
		{
			Browser.Interactions.Click(".submenu #month-schedule-week");
		}
