...
namespace Teleopti.Ccc.WebBehaviorTest.MyTime
{
	...
	public class WeekScheduleOnMobileStepDefinitions
	{
		...
		[Then(@"I should see my mobile day schedule for date '(.*)'")]
		public void ThenIShouldSeeMyMobileDayScheduleForDate(DateTime date)
		{
			Browser.Interactions.AssertUrlContains(date.ToString("yyyy/MM/dd"));
		}
		...
		{
			Browser.Interactions.AssertNoContains(".weekview-mobile", string.Format("div[data-mytime-date='{0}'] .shift", date.ToString("yyyy-MM-dd")), "09:00 - 18:00");
		}
