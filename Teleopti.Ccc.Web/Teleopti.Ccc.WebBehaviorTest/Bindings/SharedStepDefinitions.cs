...
namespace Teleopti.Ccc.WebBehaviorTest.Bindings
{
	...
	public class SharedStepDefinitions
	{
		...
		{
			Browser.Interactions.ClickUsingJQuery(".navbar-form button.done:has(i.icon-chevron-right)");
		}
		...
		{
			Browser.Interactions.ClickUsingJQuery(".navbar-form button.done:has(i.icon-chevron-left)");
		}
