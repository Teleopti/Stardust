...
namespace Teleopti.Ccc.WebBehaviorTest.Bindings.DoNotUse
{
	...
	public class UserStepDefinitions
	{
		...
		[Given(@"I am chinese")]
		public void GivenIAmChinese()
		{
			DataMaker.Data().Apply(new ChineseCulture());
		}

		[Given(@"I am Bulgarian")]
		public void GivenIAmBulgarian()
		{
			DataMaker.Data().Apply(new BulgarianCulture());
		}
		...
		public void GivenIHaveCreatedShiftTradeRequests(int count, Table table)
		{
			...
			{
				GivenIHaveCreatedAShiftTradeRequest(table);
			}
		}
