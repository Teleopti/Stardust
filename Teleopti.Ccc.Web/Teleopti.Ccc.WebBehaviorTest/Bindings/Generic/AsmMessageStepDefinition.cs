...
namespace Teleopti.Ccc.WebBehaviorTest.Bindings.Generic
{
	...
	public class AsmMessageStepDefinition
	{
		...
		public void WhenIEnterTheTextReply(string reply)
		{
			...
			Pages.Pages.CurrentMessageReplyPage.Reply.KeyDown('!');
		}
