...
namespace Teleopti.Ccc.Web.Areas.People.Core.Providers
{
	...
	{
		private IPersonFinderReadOnlyRepository _searchRepository;
		private IPersonRepository _personRepository;
		private IPermissionProvider _permissionProvider;
		private IOptionalColumnRepository _optionalColumnRepository;
		private ILoggedOnUser _loggonUser;
		public PeopleSearchProvider(IPersonFinderReadOnlyRepository searchRepository, IPersonRepository personRepository, IPermissionProvider permissionProvider, IOptionalColumnRepository optionalColumnRepository, ILoggedOnUser loggonUser)
		{
		...
		public PeopleSummaryModel SearchPeople(string keyword, int pageSize, int currentPageIndex, DateOnly currentDate)
		{
			...
			return new PeopleSummaryModel() { People = peopleList, TotalPages = search.TotalPages, OptionalColumns = optionalColumnCollection };
		}
	}
}