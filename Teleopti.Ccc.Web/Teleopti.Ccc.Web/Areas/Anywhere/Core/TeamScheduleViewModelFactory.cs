...
namespace Teleopti.Ccc.Web.Areas.Anywhere.Core
{
	public class TeamScheduleViewModelFactory : ITeamScheduleViewModelFactory
	{
		...
		public TeamScheduleViewModelFactory(ITeamScheduleViewModelMapper mapper,  IPersonScheduleDayReadModelFinder personScheduleDayReadModelRepository, IPermissionProvider permissionProvider, ISchedulePersonProvider schedulePersonProvider)
		{
			_mapper = mapper;
		...
		public IEnumerable<Shift> CreateViewModel(Guid teamId, DateTime date)
		{
