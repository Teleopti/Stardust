	...
	return function () {
		...
		buster.testCase("real time adherence agents viewmodel", {
			...
			"should fill agent state data": function() {
				...
				assert.equals(vm.agentStates()[0].EnteredCurrentAlarm(), moment.utc(state1.StateStart, resources.DateTimeFormatForMoment).add(-600, 'minutes').format(resources.DateTimeFormatForMoment));
				...
				assert.equals(vm.agentStates()[1].EnteredCurrentAlarm(), moment.utc(state1.StateStart, resources.DateTimeFormatForMoment).add(-600, 'minutes').format(resources.DateTimeFormatForMoment));
