...
namespace Teleopti.Ccc.Web.Areas.Start.Controllers
{
	public class TestController : Controller
	{
			...
			bool usePasswordPolicy = false)
		{
			...
			LogManager.GetLogger(typeof(TestController)).ErrorFormat("Troubleshooting: Path = {0}, PasswordValidForDayCount = {1}, File = {2}", _loadPasswordPolicyService.Path, _loadPasswordPolicyService.LoadPasswordValidForDayCount());
