...
namespace Teleopti.Ccc.Web.Areas.Global
{
	public class GroupPageController : ApiController
	{
		...
		{
			return Ok(_groupPageViewModelFactory.CreateViewModel(new DateOnly(date).ToDateOnlyPeriod()));
		}
		...
		{
			return Ok(_groupPageViewModelFactory.CreateViewModelWithPermissionCheck(new DateOnlyPeriod(new DateOnly(startDate), new DateOnly(endDate)), DefinedRaptorApplicationFunctionPaths.MyTeamSchedules));
		}
		...
		{
			return Ok(_groupPageViewModelFactory.CreateViewModelWithPermissionCheck(new DateOnlyPeriod(new DateOnly(startDate), new DateOnly(endDate)), DefinedRaptorApplicationFunctionPaths.WebRequests));
		}
	}
}