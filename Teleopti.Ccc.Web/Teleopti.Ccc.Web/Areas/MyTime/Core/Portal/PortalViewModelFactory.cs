...
namespace Teleopti.Ccc.Web.Areas.MyTime.Core.Portal
{
	public class PortalViewModelFactory : IPortalViewModelFactory
	{
		...
		public PortalViewModelFactory(IPermissionProvider permissionProvider, IPreferenceOptionsProvider preferenceOptionsProvider, ILicenseActivator licenseActivator)
		{
