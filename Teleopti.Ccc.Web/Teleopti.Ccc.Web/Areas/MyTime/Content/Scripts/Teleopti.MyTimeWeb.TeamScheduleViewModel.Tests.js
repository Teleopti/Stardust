$(document).ready(function() {
	...
	var timeLineTemplate = [
		{ HourText: '', LengthInMinutesToDisplay: 15, StartTime: 1433634300000, EndTime: 1433635200000 },
	...
	var dayOffScheduleLayersTemplate = [
		{
			Start: 1433606400000,
			End: 1433692800000,
			LengthInMinutes: 1440,
			Color: null,
			TitleHeader: 'Day off',
			IsAbsenceConfidential: false,
			TitleTime: '00:00 - 00:00'
		}
	];
	...
	test('should create view model when load schedules has completed', function() {
		...
		equal(
			viewModel.toDrawSchedules()[0].agentName,
			'Andy Stephen',
			"view model was created and the agentName is 'Andy Stephen' "
		);
	});
