$(document).ready(function() {
	...
	function setUpHtml() {
		agentSchedulesHtml = [
			...
			'					<div class="start-time-interval-line"></div>',
			'					<div class="start-time-start-slider cursorpointer">',
			'						<span data-bind="text: startTimeStart"></span>',
			'					</div>',
			'					<div class="start-time-end-slider cursorpointer">',
			'						<span data-bind="text: startTimeEnd"></span>',
			'					</div>',
			'				</div>',
			'			</div>',
			'			<div class="new-teamschedule-time-slider-container">',
			...
			'				<div class="new-teamschedule-time-slider-line relative">',
			'					<div class="end-time-interval-line"></div>',
			'					<div class="end-time-start-slider cursorpointer">',
			'					</div>',
			'					<div class="end-time-end-slider cursorpointer"></div>',
			'				</div>',
			'			</div>',
			'			<!-- ko if: isHostAMobile-->',
