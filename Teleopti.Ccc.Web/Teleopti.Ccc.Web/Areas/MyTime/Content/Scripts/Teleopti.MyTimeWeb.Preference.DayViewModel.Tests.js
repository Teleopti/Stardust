$(document).ready(function() {
	...
	test('should format possible contract time', function() {
		...
		expect(2);
		equal(viewModelDay.PossibleContractTimeLower(), '06:30');
		equal(viewModelDay.PossibleContractTimeUpper(), '08:05');
	});
	...
	test('should load feedback', function() {
		...
		equal(viewModelDay.PossibleContractTimes(), '07:00-12:00');
	});
