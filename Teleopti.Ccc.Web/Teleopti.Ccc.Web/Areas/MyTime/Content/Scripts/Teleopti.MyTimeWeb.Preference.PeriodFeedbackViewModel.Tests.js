$(document).ready(function() {
	...
	test('should summarize possible contract time', function() {
		...
		var viewModel = new Teleopti.MyTimeWeb.Preference.PeriodFeedbackViewModel(
			null,
			[viewModelDay1, viewModelDay2],
			null,
			[]
		);
	...
	test('should make possible night rest violation array', function() {
		...
		equal(
			viewModel.PossibleNightRestViolations()()[0].sencondDay,
			Teleopti.MyTimeWeb.Common.FormatDate(plusOneDay1)
		); // 2016-02-03
		...
		equal(
			viewModel.PossibleNightRestViolations()()[1].firstDay,
			Teleopti.MyTimeWeb.Common.FormatDate(minusOneDay2)
		); //2016-01-25
		equal(
			viewModel.PossibleNightRestViolations()()[1].sencondDay,
			Teleopti.MyTimeWeb.Common.FormatDate(currentDay2)
		); //2016-01-26
		...
		equal(
			viewModel.PossibleNightRestViolations()()[2].sencondDay,
			Teleopti.MyTimeWeb.Common.FormatDate(plusOneDay2)
		); //2016-01-27
