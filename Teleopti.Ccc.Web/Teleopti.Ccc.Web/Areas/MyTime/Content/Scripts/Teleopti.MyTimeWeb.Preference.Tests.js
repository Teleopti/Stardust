$(document).ready(function() {
	...
	test('should load day feedback and bind', function() {
		...
		equal($('li[data-mytime-date="2012-06-11"]').text(), '07:30');
		equal($('li[data-mytime-date="2012-06-12"]').text(), '07:30');
	});
	...
	test('should clear day view models on init', function() {
		...
		equal($('#Preference-period-feedback-view').text(), '07:30', 'day sum after reinit same instance');
	});
	...
	test('should load feedback data correctly', function() {
		...
		equal($('li[data-mytime-date="' + startDate + '"]').text(), '07:00');
		equal($('li[data-mytime-date="' + today + '"]').text(), '07:30');
		equal($('li[data-mytime-date="' + endDate + '"]').text(), '08:00');
	});
	...
	test('should calculate possible result weekly contract time (lower and higher) correctly', function() {
		...
		equal($('li[data-mytime-date="' + today + '"]').text(), '07:30');
		equal($('li[data-mytime-date="' + endDate + '"]').text(), '07:30');
