(function (window, angular, undefined) {
	...
	mfb.run(['$templateCache', function ($templateCache) {
		...
		'    <a href="" ng-click="clicked()" ng-mouseenter="hovered()" ng-mouseleave="hovered()"' +
		'       ng-attr-data-mfb-label="{{label}}" class="mfb-component__button--main">' +
		'     <i class="mfb-component__main-icon--resting mdi {{resting}}"></i>' +
		'     <i class="mfb-component__main-icon--active mdi {{active}}"></i>' +
		'    </a>' +
		...
		'    <i class="mfb-component__child-icon mdi {{icon}}">' +
		'    </i>' +
		'	<md-tooltip md-direction="left">{{label}}</md-tooltip>' +
		'  </a>' +
		'</li>'
		);
