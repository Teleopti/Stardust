...
(function () {
	...
	var directive = function () {
		...
		return {
			...
			require: ['seatPlanInit'],
			scope: {
				onSeatPlanStart: '&',
				onSeatPlanComplete: '&',
				showReport: '='
			},
			templateUrl: "app/seatManagement/html/seatplaninitmanualperiod.html",

		};
	};

	angular.module('wfm.seatPlan').directive('seatPlanInitManualPeriod', directive);
