(function () {
	...
	angular.module('wfm.rta')
		.controller('RtaSiteAndTeamOnSkillOverviewCtrlRefact', RtaSiteAndTeamOnSkillOverviewCtrl)

		RtaSiteAndTeamOnSkillOverviewCtrl.$inject =
		[
			'$scope',
			'$stateParams',
			'$interval',
			...
			function RtaSiteAndTeamOnSkillOverviewCtrl (
				$scope,
				$stateParams,
				$interval,
				$filter,
