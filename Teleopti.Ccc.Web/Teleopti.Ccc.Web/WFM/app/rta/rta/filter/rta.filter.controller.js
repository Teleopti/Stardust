(function() {
    ...
    angular.module('wfm.rta').controller('RtaFilterController', RtaFilterController);
    ...
    function RtaFilterController(
        ...
        var skillIds = angular.isArray($stateParams.skillIds)
            ? $stateParams.skillIds[0] || null
            : $stateParams.skillIds;
        ...
        (function initialize() {
            rtaService
                ...
                .then(function() {
                    rtaService
                        ...
                        .then(function() {
                            getOrganizationCall().then(function(organization) {
                                ...
                                vm.sites.forEach(function(site) {
                                    ...
                                    site.toggle = function() {
                                        ...
                                        vm.siteMarkedOrChecked =
                                            vm.sites.filter(function(site) {
            ...
            function getOrganizationCall() {
                ...
                return skillIdsForOrganization != null
                    ? rtaService.getOrganizationForSkills({skillIds: skillIdsForOrganization})
            ...
            function getSkillIdsFromSkillArea(skillAreaId) {
                ...
                if (theSkillArea.Skills != null) {
                    return theSkillArea.Skills.map(function(skill) {
                        return skill.Id;
                    });
                }
                return null;
        ...
        function goToAgents() {
            ...
            if ($stateParams.skillIds) selection['skillIds'] = $stateParams.skillIds;
            else if ($stateParams.skillAreaId) selection['skillAreaId'] = $stateParams.skillAreaId;
            if (
                angular.toJson(selection.siteIds) === angular.toJson(siteIds) &&
                angular.toJson(selection.teamIds) === angular.toJson(teamIds)
            ) {
                vm.openPicker = false;
                return;
            }
