(function () {
	...
	angular
		...
		.component('rtaCardPanel', {
			templateUrl: 'app/rta/rta/historical/_rta.card.panel.html',
			controller: 'RtaCardPanelController',
			controllerAs: 'vm',
			transclude: {
		...
		.directive('rtaCardAnimate', cardAnimate)
		.controller('RtaCardPanelController', RtaCardPanelController);

	RtaCardPanelController.$inject = ['$element'];

	function RtaCardPanelController($element) {
		var vm = this;
