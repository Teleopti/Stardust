			...
			templateUrl: [
				...
				function(CurrentUserInfo) {
					if (CurrentUserInfo.CurrentUserInfo().DateFormatLocale === 'fa-IR')
						return 'app/styleguide/wfm-date-range-picker/wfm-date-range-picker.jalaali.tpl.html';
					return 'app/styleguide/wfm-date-range-picker/wfm-date-range-picker.gregorian.tpl.html';
				}
			],
			require: {
				ngModel: 'ngModel'
