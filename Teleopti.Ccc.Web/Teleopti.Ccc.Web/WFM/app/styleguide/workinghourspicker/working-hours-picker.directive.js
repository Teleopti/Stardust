(function() {
	...
	angular.module('wfm.workingHoursPicker').service('workingHoursService', function() {
	...
	angular
		.module('wfm.workingHoursPicker')
		.directive('workingHoursPicker', [
			'$q',
			'$translate',
			'$filter',
			'$locale',
			'workingHoursService',
			workingHoursPickerDirective
		]);

	function workingHoursPickerDirective($q, $translate, $filter, $locale, workingHoursPickerService) {
		return {
			restrict: 'E',
			scope: {
				workingHours: '=',
