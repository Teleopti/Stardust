(function() {
	...
	app.provider('ngModalDefaults', function() {
		return {
			options: {
				closeButtonHtml:
					'<div class="head-actions panel-menu"><div tabindex=0 class="context-menu card-context"><i class="mdi mdi-close"></i></div></div>'
			},
			$get: function() {
				return this.options;
			},
	...
	app.directive('modalDialog', [
		...
		function(ngModalDefaults, $sce) {
			return {
				...
				template:
					"<div class='click-modal modal-box use-old-globals' ng-show='show'>" +
