...
(function () {
	...
	var requestsShiftDetailDirective = function (teamScheduleSvc, groupScheduleFactory, currentUserInfo, serviceDateFormatHelper) {
		return {
			restrict: "A",
			scope: {
				personIds: "=",
		...
		function updateShiftStatusForSelectedPerson(personIds, scheduleDate, targetTimezone, position, showShiftDetail) {
			...
			teamScheduleSvc.getSchedules(scheduleDate, personIds)
	...
	angular.module("wfm.requests").directive("requestsShiftDetail",
		["TeamSchedule", "GroupScheduleFactory", "CurrentUserInfo", 'serviceDateFormatHelper', requestsShiftDetailDirective]);
})();