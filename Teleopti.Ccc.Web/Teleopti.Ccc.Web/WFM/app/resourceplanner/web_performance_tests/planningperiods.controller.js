...
(function () {
	...
	angular.module('wfm.resourceplanner')
		.controller('PlanningPeriodsCtrl', [
			'$scope', '$state', '$stateParams', '$interval', 'planningPeriodService', 'Toggle', '$translate',
			function ($scope, $state, $stateParams, $interval, planningPeriodService, toggleService, $translate) {
