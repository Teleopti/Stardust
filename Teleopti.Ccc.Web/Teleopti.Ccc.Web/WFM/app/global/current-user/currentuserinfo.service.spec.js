describe('currentUserInfoService', function () {
	var $httpBackend, $interval;

	beforeEach(function () {
		module('currentUserInfoService');
	});

	beforeEach(inject(function (_$httpBackend_, _$rootScope_,_$interval_) {
	...
	it('should update NowInUtc automatically', inject(function (CurrentUserInfo) {
		var data = {
			UserName: 'Ashley',
			DefaultTimeZone: '',
			Language: '',
			...
			NowInUtc: '2018-12-06 14:00:00'
		};

		CurrentUserInfo.SetCurrentUserInfo(data);
		$interval(function () {
			var result = CurrentUserInfo.CurrentUserInfo();
			expect(result.NowInUtc()).toEqual('2018-12-06 14:00:01');
		}, 1000);
		$interval.flush();
	}));
});
