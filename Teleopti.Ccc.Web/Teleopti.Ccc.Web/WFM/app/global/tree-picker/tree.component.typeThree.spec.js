describe('TreeDataThreeController', function () {
    ...
    it('should select the clicked node and its parents when node is single child', function () {
        var nodes = picker[0].getElementsByClassName('tree-handle-wrapper');
        nodes[4].click();
        var componentSelectedNode = picker.find('div').scope().vm.node;
    ...
    it('should select parents when all children are selected', function () {
        var nodes = picker[0].getElementsByClassName('tree-handle-wrapper');
        nodes[13].click();
        nodes[14].click();
        nodes[15].click();
    ...
    it('should unselect all children when all children are unselected', function () {
        var nodes = picker[0].getElementsByClassName('tree-handle-wrapper');
        nodes[13].click();
        nodes[14].click();
        nodes[15].click();
