...
(function () {
					...
					"Projection": [
						{
							...
							"Description": "Email",
							"Start": '2015-10-30T07:00:00',
							"StartInUtc": '2015-10-30T07:00:00',
	...
	describe('in locale en-gb', function () {
		beforeEach(function () {
			module("wfm.teamSchedule");
			module(function ($provide) {
				$provide.service('CurrentUserInfo', function () {
					return {
						CurrentUserInfo: function () {
							return { DefaultTimeZone: "Europe/Berlin" };
						}
					}
				});
			});
		...
		xit('Should get correct shift length and start position in DST', function () {
			var queryDate = "2018-10-28";
			var timeLineStart = 0;
			var timeLineEnd = 1000;
			...
			var scheduleToday = {
				...
				"Projection": [
					{
						"ShiftLayerIds": ["ab83cb5e-8827-450d-99e8-a96a00056cd3"],
						"Color": "#7FFFD4",
						"Description": "Email",
						"Start": queryDate + " 01:30",
						"StartInUtc": queryDate + " 00:30",
						"End": queryDate + " 01:00",
						"Minutes": 30
					},
					{
						"ShiftLayerIds": ["0698c4cf-c668-49c6-984e-a93400a1f3b2"],
						"Color": "#80FF80",
						"Description": "Email",
						"Start": queryDate + " 01:00",
						"StartInUtc": queryDate + " 01:00",
						"End": queryDate + " 03:00",
						"Minutes": 120
					}],
				"DayOff": null,
				"UnderlyingScheduleSummary": null
			};
			var personSchedule = target.Create(scheduleToday, timeLine);
			var projections = personSchedule.Shifts[0].Projections;
			expect(projections[0].StartPosition).toEqual(9);
			expect(projections[1].StartPosition).toEqual(12);
		});
	});
