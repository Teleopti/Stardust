...
(function () {
	describe("teamschedule week controller tests", function () {
		...
		beforeEach(
			inject(function (_$q_, _$rootScope_, _$controller_, _PersonScheduleWeekViewCreator_, _ViewStateKeeper_) {
				$q = _$q_;
		...
		it("should init all settings", function () {
			...
			expect(controller.scheduleDate).toEqual('2018-02-02');
