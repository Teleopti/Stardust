...
(function () {
	var myteam = angular.module('wfm.teamSchedule', [
			'currentUserInfoService', 'wfm.pagination', 'toggleService', 'ngResource', 'wfmDate', 'wfm.notice', 'ngMaterial', 'ui.bootstrap', 'wfm.signalR', 'ui.router', 'wfm.multiplesearchinput'
		])
		.config([
