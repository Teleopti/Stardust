...
describe('RtaAgentsCtrl', function() {
	...
	it('should display time out of adherence', function() {
	...
	it('should display times out of adherence', function() {
		stateParams.teamId = "34590a63-6331-4921-bc9f-9b5e015ab495";
		$fakeBackend
			.withAgent({
				Name: "Ashley Andeen",
	...
	it('should cut on going out of adherence time', function() {
		stateParams.teamId = "34590a63-6331-4921-bc9f-9b5e015ab495";
		$fakeBackend
			.withAgent({
				Name: "Ashley Andeen",
