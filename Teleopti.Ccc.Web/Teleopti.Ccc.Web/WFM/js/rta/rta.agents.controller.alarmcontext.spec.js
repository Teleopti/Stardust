...
describe('RtaAgentsCtrl', function() {
	...
	it('should not start activities outside of the display window', function () {
	    stateParams.teamId = "34590a63-6331-4921-bc9f-9b5e015ab495";
	    $fakeBackend
			.withTime("2016-05-30T11:00:00")
			.withAgent({
	...
	it('should handle long activity', function () {
	    stateParams.teamId = "34590a63-6331-4921-bc9f-9b5e015ab495";
	    $fakeBackend
	    ...
	    expect(scope.agents[0].Shift[0].Width).toEqual('75%');
	});
