'use strict';
xdescribe('tmp-time-range-picker directive', function () {
	...
	beforeEach(inject(function (_$compile_, _$rootScope_, _$templateCache_) {
		...
		elementCompileFn = function () {
			return $compile('<tmp-time-range-picker ng-model="timeRange"></tmp-time-range-picker>');
		};
	}));
	...
	describe('custom template', function () {
		it('should allow custom templates', function () {
			...
			element = $compile('<tmp-time-range-picker ng-model="timeRange" template-url="foo/bar.html"></tmp-time-range-picker>')(scope);
			scope.$apply();
