	...
	angular.module('wfm.requests')
		.factory('ShiftTradeGridConfiguration', ['$filter', function ($filter) {
			...
			function columnDefinitions(shiftTradeRequestDateSummary) {
				...
				var columns = [
				{ displayName: 'StartTime', field: 'FormatedPeriodStartTime()', headerCellFilter: 'translate', cellClass: 'request-period-start-time', headerCellClass: 'request-period-start-time-header', visible: false, pinnedRight: true },
				{ displayName: 'EndTime', field: 'FormatedPeriodEndTime()', headerCellFilter: 'translate', cellClass: 'request-period-end-time', headerCellClass: 'request-period-end-time-header', visible: false, pinnedRight: true },
				{ displayName: 'Duration', field: 'GetDuration()', headerCellFilter: 'translate', cellClass: 'request-period-duration', enableSorting: false, visible: false, headerCellClass: 'request-period-duration-header', pinnedRight: true },
				{
					displayName: 'AgentName',
					field: 'AgentName',
					headerCellFilter: 'translate',
					//cellClass: 'request-agent-name',
					cellTemplate: '<p>{{row.entity[col.field]}}</p><p>{{row.entity["PersonTo"]}}</p>',
				...
				},
				{
					...
					cellTemplate: '<p>{{row.entity[col.field]}}</p><p>{{row.entity["PersonToTimeZone"]}}</p>',
					enableSorting: false,
					pinnedLeft: true
				},
				{
					...
					cellTemplate: '<p>{{row.entity[col.field]}}</p><p>{{row.entity["PersonToTeam"]}}</p>',
					enableSorting: false,
					visible: false,
					pinnedRight: true
				},
				{ displayName: 'Seniority', field: 'Seniority', headerCellFilter: 'translate', cellClass: 'request-seniority', headerCellClass: 'request-seniority-header', visible: false, pinnedRight: true },
				{
					displayName: 'Subject',
					field: 'Subject',
					headerCellFilter: 'translate',
				...
				{ displayName: 'DenyReason', field: 'DenyReason', headerCellFilter: 'translate', cellClass: 'request-deny-reason', headerCellClass: 'request-deny-reason-header', visible: false, pinnedRight: true },
				{
					displayName: 'Status',
					field: 'StatusText',
					headerCellFilter: 'translate',
				...
				{ displayName: 'CreatedOn', field: 'FormatedCreatedTime()', headerCellFilter: 'translate', cellClass: 'request-created-time', headerCellClass: 'request-created-time-header', pinnedRight: true },
				{ displayName: 'Id', field: 'Id', headerCellFilter: 'translate', cellClass: 'request-id', visible: false, headerCellClass: 'request-id-header', pinnedRight: true },
				{ displayName: 'UpdatedOn', field: 'FormatedUpdatedTime()', headerCellFilter: 'translate', cellClass: 'request-updated-time', visible: false, headerCellClass: 'request-updated-time-header', pinnedRight: true }
				];
