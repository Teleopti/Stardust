(function () {
    ...
    requestsController.$inject = ["$scope", "Toggle", "requestsDefinitions", "requestsNotificationService", "SignalR", "CurrentUserInfo"];

    function requestsController($scope, toggleService, requestsDefinitions, requestsNotificationService, signalRSvc, CurrentUserInfo) {
        var vm = this;
