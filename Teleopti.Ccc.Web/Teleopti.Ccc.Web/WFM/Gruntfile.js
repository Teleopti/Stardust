module.exports = function(grunt) {
    ...
    // for desktop client
    grunt.registerTask('buildForDesktop', ['ngtemplates', 'sass', 'concat:distModules', 'concat:distCss', 'concat:distDarkCss', 'uglify:dist', 'copy:sourceMaps', 'processhtml:distForDesktop','clean:dist', 'cacheBust:dist']);
