...
describe('ResourceplannerReportCtrl', function () {
	...
	result.withNoIssues = function(){
		return {result:{BusinessRulesValidationResults:[]},interResult:{_skillResultList:[{SkillName:'test',SkillDetails:[{Date:{Date:'2015-11-14'}}]}]}};
	};
	result.withIssues = function(){
		return {result:{BusinessRulesValidationResults:[[]]},interResult:{_skillResultList:[{SkillName:'test',SkillDetails:[{Date:{Date:'2015-11-14'}}]}]}};
	};
	result.withNoWeekends = function(){
		return {result:{BusinessRulesValidationResults:[[]]},interResult:{_skillResultList:[{SkillName:'test',SkillDetails:[{Date:{Date:'2015-11-12'}}]}]}};
	};
	result.withPeriodId = function(){
		return {planningperiod:{id:0},result:{BusinessRulesValidationResults:[[]]},interResult:{_skillResultList:[{SkillName:'test',SkillDetails:[{Date:{Date:'2015-11-12'}}]}]}}
	};
