namespace CheckPreRequisites
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			// btnCheck2008
			// 
			this.btnCheck2008.Location = new System.Drawing.Point(376, 93);
			this.btnCheck2008.Name = "btnCheck2008";
			this.btnCheck2008.Size = new System.Drawing.Size(57, 27);
			this.btnCheck2008.TabIndex = 0;
			this.btnCheck2008.Text = "Check";
			this.btnCheck2008.UseVisualStyleBackColor = true;
			...
			// buttonDBconnect
			// 
			this.buttonDBconnect.Location = new System.Drawing.Point(258, 93);
			this.buttonDBconnect.Name = "buttonDBconnect";
			this.buttonDBconnect.Size = new System.Drawing.Size(55, 28);
			...
			this.groupBoxDBConnectivity.Location = new System.Drawing.Point(523, 20);
			this.groupBoxDBConnectivity.Name = "groupBoxDBConnectivity";
			this.groupBoxDBConnectivity.Size = new System.Drawing.Size(324, 133);
			...
			this.SQLPwd.Location = new System.Drawing.Point(69, 37);
			this.SQLPwd.Name = "SQLPwd";
			this.SQLPwd.PasswordChar = '*';
			this.SQLPwd.Size = new System.Drawing.Size(99, 20);
			...
			this.SQLLogin.Location = new System.Drawing.Point(69, 11);
			this.SQLLogin.Name = "SQLLogin";
			this.SQLLogin.Size = new System.Drawing.Size(99, 20);
			...
			this.radioButtonSQLLogin.Location = new System.Drawing.Point(176, 45);
			this.radioButtonSQLLogin.Name = "radioButtonSQLLogin";
			this.radioButtonSQLLogin.Size = new System.Drawing.Size(75, 17);
			...
			this.radioButtonWinAuth.Location = new System.Drawing.Point(96, 45);
			this.radioButtonWinAuth.Name = "radioButtonWinAuth";
			this.radioButtonWinAuth.Size = new System.Drawing.Size(66, 17);
			...
			// 
			this.textBoxSQLServerName.Location = new System.Drawing.Point(94, 19);
			...
			this.textBoxSQLServerName.Size = new System.Drawing.Size(138, 20);
			...
			this.groupBoxNumberOfAgents.Location = new System.Drawing.Point(4, 25);
			this.groupBoxNumberOfAgents.Name = "groupBoxNumberOfAgents";
			this.groupBoxNumberOfAgents.Size = new System.Drawing.Size(152, 52);
			...
			this.numericUpDownAgents.Location = new System.Drawing.Point(12, 20);
			...
			this.numericUpDownAgents.Size = new System.Drawing.Size(126, 20);
			...
			this.groupBox3.Location = new System.Drawing.Point(164, 26);
			this.groupBox3.Name = "groupBox3";
			this.groupBox3.Size = new System.Drawing.Size(135, 51);
            ...
            "Web+DB",
            "Version6"});
			this.comboBoxServerSetup.Location = new System.Drawing.Point(6, 19);
			this.comboBoxServerSetup.Name = "comboBoxServerSetup";
			this.comboBoxServerSetup.Size = new System.Drawing.Size(121, 21);
			...
			this.groupBoxSQLInstance.Location = new System.Drawing.Point(6, 80);
			this.groupBoxSQLInstance.Name = "groupBoxSQLInstance";
			this.groupBoxSQLInstance.Size = new System.Drawing.Size(292, 43);
			...
			this.comboBoxSQLInstance.Location = new System.Drawing.Point(10, 15);
			this.comboBoxSQLInstance.Name = "comboBoxSQLInstance";
			this.comboBoxSQLInstance.Size = new System.Drawing.Size(275, 21);
			...
			this.groupBoxDatabase.Location = new System.Drawing.Point(4, 78);
			this.groupBoxDatabase.Name = "groupBoxDatabase";
			this.groupBoxDatabase.Size = new System.Drawing.Size(295, 43);
			...
			// textBoxDBName
			// 
			this.textBoxDBName.Location = new System.Drawing.Point(15, 17);
			this.textBoxDBName.Name = "textBoxDBName";
			this.textBoxDBName.Size = new System.Drawing.Size(271, 20);
			...
			this.groupBox5.Size = new System.Drawing.Size(452, 133);
			...
			this.tabControl1.Size = new System.Drawing.Size(1004, 475);
			...
			this.tabPage1.Size = new System.Drawing.Size(996, 449);
			...
			this.listView1.Size = new System.Drawing.Size(990, 443);
			...
			this.tabPage2.Size = new System.Drawing.Size(996, 449);
			...
			this.listView2.Size = new System.Drawing.Size(990, 443);
			...
			// columnHeader1
			// 
			this.columnHeader1.Text = "abs_id";
			this.columnHeader1.Width = 124;
			// 
			// columnHeader2
			// 
			this.columnHeader2.Text = "abs_desc";
			this.columnHeader2.Width = 158;
			// 
			// columnHeader3
			// 
			this.columnHeader3.Text = "abs_desc_nonuni";
			this.columnHeader3.Width = 303;
			// 
			// columnHeader5
			// 
			this.columnHeader5.Text = "abs_short_desc";
			this.columnHeader5.Width = 116;
			// 
			// columnHeader11
			// 
			this.columnHeader11.Text = "abs_short_desc_nonuni";
			// 
			// columnHeader12
			// 
			this.columnHeader12.Text = "extended_abs";
			// 
			// columnHeader13
			// 
			this.columnHeader13.Text = "color_code";
			// 
			// columnHeader14
			// 
			this.columnHeader14.Text = "apply_time_rules";
			// 
			// columnHeader15
			// 
			this.columnHeader15.Text = "apply_count_rules";
			// 
			// columnHeader16
			// 
			this.columnHeader16.Text = "activity_id";
			// 
			// columnHeader17
			// 
			this.columnHeader17.Text = "deleted";
			// 
			// columnHeader18
			// 
			this.columnHeader18.Text = "time_tracking";
			// 
			// columnHeader19
			// 
			this.columnHeader19.Text = "in_worktime";
			// 
			// columnHeader20
			// 
			this.columnHeader20.Text = "paid_time";
			// 
			// columnHeader21
			// 
			this.columnHeader21.Text = "block_delimiter";
			// 
			// columnHeader26
			// 
			this.columnHeader26.Text = "planned_absence";
			// 
			// columnHeader27
			// 
			this.columnHeader27.Text = "unplanned_absence";
			// 
			// columnHeader28
			// 
			this.columnHeader28.Text = "vacation";
			// 
			// columnHeader24
			// 
			this.columnHeader24.Text = "private_desc";
			// 
			// columnHeader25
			// 
			this.columnHeader25.Text = "private_color";
			// 
			// columnHeader22
			// 
			this.columnHeader22.Text = "changed_by";
			// 
			// columnHeader23
			// 
			this.columnHeader23.Text = "changed_date";
			// 
			// tabPage3
			// 
			this.tabPage3.Controls.Add(this.listView3);
			this.tabPage3.Controls.Add(this.listViewActivities);
			this.tabPage3.Location = new System.Drawing.Point(4, 22);
			this.tabPage3.Name = "tabPage3";
			this.tabPage3.Size = new System.Drawing.Size(996, 449);
			...
			this.listView3.Size = new System.Drawing.Size(996, 449);
			...
			// columnHeader6
			// 
			this.columnHeader6.Text = "activity_id";
			this.columnHeader6.Width = 65;
			// 
			// columnHeader7
			// 
			this.columnHeader7.Text = "activity_name";
			this.columnHeader7.Width = 84;
			// 
			// columnHeader9
			// 
			this.columnHeader9.Text = "activity_name_nonuni";
			this.columnHeader9.Width = 130;
			// 
			// columnHeader10
			// 
			this.columnHeader10.Text = "in_worktime";
			this.columnHeader10.Width = 116;
			// 
			// columnHeader29
			// 
			this.columnHeader29.Text = "color_code";
			// 
			// columnHeader30
			// 
			this.columnHeader30.Text = "occupies_workplace";
			// 
			// columnHeader31
			// 
			this.columnHeader31.Text = "show_in_schedule";
			// 
			// columnHeader32
			// 
			this.columnHeader32.Text = "extended_activity";
			// 
			// columnHeader33
			// 
			this.columnHeader33.Text = "in_shiftname";
			// 
			// columnHeader34
			// 
			this.columnHeader34.Text = "ep_lunch_break";
			// 
			// columnHeader35
			// 
			this.columnHeader35.Text = "ep_short_break";
			// 
			// columnHeader36
			// 
			this.columnHeader36.Text = "is_logged";
			// 
			// columnHeader37
			// 
			this.columnHeader37.Text = "req_skill";
			// 
			// columnHeader38
			// 
			this.columnHeader38.Text = "is_parent";
			// 
			// columnHeader39
			// 
			this.columnHeader39.Text = "parent_id";
			// 
			// columnHeader40
			// 
			this.columnHeader40.Text = "deleted";
			// 
			// columnHeader41
			// 
			this.columnHeader41.Text = "overwrite";
			// 
			// columnHeader42
			// 
			this.columnHeader42.Text = "paid_time";
			// 
			// columnHeader47
			// 
			this.columnHeader47.Text = "planned_absence";
			// 
			// columnHeader48
			// 
			this.columnHeader48.Text = "unplanned_absence";
			// 
			// columnHeader49
			// 
			this.columnHeader49.Text = "vacation";
			// 
			// columnHeader45
			// 
			this.columnHeader45.Text = "private_desc";
			// 
			// columnHeader46
			// 
			this.columnHeader46.Text = "private_color";
			// 
			// columnHeader43
			// 
			this.columnHeader43.Text = "changed_by";
			// 
			// columnHeader44
			// 
			this.columnHeader44.Text = "changed_date";
			// 
			// listViewActivities
			// 
			...
			this.listViewActivities.Size = new System.Drawing.Size(996, 449);
