...
namespace Teleopti.Ccc.DayOffPlanning
{
    public class FreeWeekendSolver : IDayOffBackToLegalStateSolver
    {
        ...
        public FreeWeekendSolver(ILockableBitArray bitArray, IDayOffBackToLegalStateFunctions functions, DayOffPlannerSessionRuleSet sessionRuleSet, int maxIterations)
        {
