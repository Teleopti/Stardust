...
namespace Teleopti.Ccc.DayOffPlanning
{
    public class DaysOffPerWeekSolver : IDayOffBackToLegalStateSolver
    {
        ...
        public DaysOffPerWeekSolver(ILockableBitArray bitArray, IDayOffBackToLegalStateFunctions functions, IDayOffPlannerSessionRuleSet sessionRuleSet, int maxIterations)
        {
