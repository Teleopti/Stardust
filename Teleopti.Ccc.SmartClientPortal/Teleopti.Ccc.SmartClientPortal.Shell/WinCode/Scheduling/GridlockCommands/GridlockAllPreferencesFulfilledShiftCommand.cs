...
{
    public class GridlockAllPreferencesFulfilledShiftCommand : IExecutableCommand
    {
        ...
        public GridlockAllPreferencesFulfilledShiftCommand(IGridSchedulesExtractor schedulesExtractor, ICheckerRestriction restrictionChecker, IScheduleDayPreferenceRestrictionExtractor scheduleDayPreferenceRestrictionExtractor, IGridlockManager lockManager)
        {
        ...
        public void Execute()
        {
            ...
            {
               var restrictedDay = _scheduleDayPreferenceRestrictionExtractor.RestrictionFulfilledShift(_restrictionChecker, scheduleDay);
