...
namespace Teleopti.Ccc.SmartClientPortal.Shell.WinCode.Scheduling
{
    public class AddOvertimeCommand : AddLayerCommand
    {
        ...
        public static DateTimePeriod GetDefaultPeriodFromPart(IScheduleDay scheduleDay)
        {
            ...
            if (scheduleDay != null)
            {
	            var startDateTimeLocal = scheduleDay.Period.StartDateTimeLocal(TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone);
	            defaultPeriod = TimeZoneHelper.NewUtcDateTimePeriodFromLocalDateTime(
                        ...
                        startDateTimeLocal.Add(TimeSpan.FromHours(DefaultSchedulePeriodProvider.DefaultEndHour)), TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone);
            }
