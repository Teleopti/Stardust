...
namespace Teleopti.Ccc.SmartClientPortal.Shell.WinCode.Scheduling
{
	...
	public class PublishScheduleDatePresenter
	{
		...
		public void Initialize()
		{
			...
			_workflowControlSets.Sort((contrlSet1, contrlSet2) => String.Compare(contrlSet1.Name, contrlSet2.Name, TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.Regional.Culture, CompareOptions.None));
