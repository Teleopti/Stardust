        ...
        public void SynchronizeAndLoadMatrixReports(IUnitOfWorkFactory unitOfWorkFactory)
		{
			using (PerformanceOutput.ForOperation("Synchronize matrix reports"))
			{
				...
				catch (Exception ex)
				{
                    ...
                    ((ITeleoptiIdentity)TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.Identity).DataSource.RemoveAnalytics(); //Makes the factory return empty repository
				}
			}
		}
	}
