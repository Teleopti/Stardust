...
{
	partial class SmsSettingsControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this.labelHeader.Size = new System.Drawing.Size(220, 25);
			this.labelHeader.TabIndex = 0;
			this.labelHeader.Text = "xxManageSmsSettings";
			// 
			// SmsSettingsControl
			// 
