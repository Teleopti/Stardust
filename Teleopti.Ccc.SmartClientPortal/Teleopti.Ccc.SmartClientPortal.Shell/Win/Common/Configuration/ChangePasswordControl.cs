...
namespace Teleopti.Ccc.SmartClientPortal.Shell.Win.Common.Configuration
{
	public partial class ChangePasswordControl : BaseUserControl, ISettingPage, IChangePasswordView, ICheckBeforeClosing
	{
		...
		{
			var loggedOnPerson = ((ITeleoptiPrincipalWithUnsafePerson) TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal).UnsafePerson();
			_presenter = new ChangePasswordPresenter(this, _container.Resolve<IChangePasswordTenantClient>(), loggedOnPerson);
