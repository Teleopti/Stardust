namespace Teleopti.Ccc.SmartClientPortal.Shell.Win.Common.Configuration
{
    partial class StateGroupControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.gradientPanelRtaConfigurationValidation = new Syncfusion.Windows.Forms.Tools.GradientPanelExt();
			this.autoLabelRtaConfigurationValidation = new Syncfusion.Windows.Forms.Tools.AutoLabel();
			...
			((System.ComponentModel.ISupportInitialize)(this.gradientPanelRtaConfigurationValidation)).BeginInit();
			this.gradientPanelRtaConfigurationValidation.SuspendLayout();
			this.SuspendLayout();
			// 
			// gradientPanelHeader
			// 
			...
			this.gradientPanelHeader.Size = new System.Drawing.Size(642, 62);
			...
			this.tableLayoutPanelHeader.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 618F));
			...
			this.tableLayoutPanelHeader.Size = new System.Drawing.Size(618, 38);
			...
			this.labelHeader.Size = new System.Drawing.Size(313, 25);
			...
			this.treeViewAdv1.ItemDrag += new System.Windows.Forms.ItemDragEventHandler(this.treeViewAdv1ItemDrag);
			this.treeViewAdv1.NodeEditorValidateString += new Syncfusion.Windows.Forms.Tools.TreeNodeAdvCancelableEditEventHandler(this.treeViewAdv1NodeEditorValidateString);
			this.treeViewAdv1.NodeEditorValidating += new Syncfusion.Windows.Forms.Tools.TreeNodeAdvCancelableEditEventHandler(this.treeViewAdv1NodeEditorValidating);
			this.treeViewAdv1.NodeEditorValidated += new Syncfusion.Windows.Forms.Tools.TreeNodeAdvEditEventHandler(this.treeViewAdv1NodeEditorValidated);
			this.treeViewAdv1.EditCancelled += new Syncfusion.Windows.Forms.Tools.TreeNodeAdvEditEventHandler(this.treeViewAdv1EditCancelled);
			this.treeViewAdv1.BeforeEdit += new Syncfusion.Windows.Forms.Tools.TreeViewAdvBeforeEditEventHandler(this.treeViewAdv1BeforeEdit);
			...
			this.treeViewAdv1.AfterCheck += new Syncfusion.Windows.Forms.Tools.TreeNodeAdvEventHandler(this.treeViewAdv1AfterCheck);
			...
			this.treeViewAdv1.QueryContinueDrag += new System.Windows.Forms.QueryContinueDragEventHandler(this.treeViewAdv1QueryContinueDrag);
			...
			this.tableLayoutPanelSubHeader1.Size = new System.Drawing.Size(636, 34);
			...
			this.buttonDelete.Location = new System.Drawing.Point(601, 3);
			...
			this.buttonNew.Location = new System.Drawing.Point(566, 3);
			...
			this.labelSubHeader1.Size = new System.Drawing.Size(97, 17);
			...
			this.tableLayoutPanelBody.Controls.Add(this.treeViewAdv1, 0, 2);
			this.tableLayoutPanelBody.Controls.Add(this.gradientPanelRtaConfigurationValidation, 0, 1);
			...
			// 
			// gradientPanelRtaConfigurationValidation
			// 
			this.gradientPanelRtaConfigurationValidation.BackColor = System.Drawing.Color.White;
			this.gradientPanelRtaConfigurationValidation.BackgroundColor = new Syncfusion.Drawing.BrushInfo(System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(224)))), ((int)(((byte)(192))))));
			this.gradientPanelRtaConfigurationValidation.Border = new System.Windows.Forms.Padding(2);
			this.gradientPanelRtaConfigurationValidation.BorderColor = System.Drawing.Color.Transparent;
			this.gradientPanelRtaConfigurationValidation.BorderGap = 2;
			this.gradientPanelRtaConfigurationValidation.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.gradientPanelRtaConfigurationValidation.Controls.Add(this.autoLabelRtaConfigurationValidation);
			this.gradientPanelRtaConfigurationValidation.CornerRadius = 3;
			this.gradientPanelRtaConfigurationValidation.Dock = System.Windows.Forms.DockStyle.Fill;
		...
		private Syncfusion.Windows.Forms.Tools.GradientPanelExt gradientPanelRtaConfigurationValidation;
		private Syncfusion.Windows.Forms.Tools.AutoLabel autoLabelRtaConfigurationValidation;
	}
}
