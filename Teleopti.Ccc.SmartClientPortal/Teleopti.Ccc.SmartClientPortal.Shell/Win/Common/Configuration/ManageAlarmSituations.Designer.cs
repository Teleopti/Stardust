namespace Teleopti.Ccc.Win.Common.Configuration
{
    partial class ManageAlarmSituations
    {
        ...
        private void InitializeComponent()
        {
			...
			this.gridControlAlarms = new Syncfusion.Windows.Forms.Grid.GridControl();
			...
			this.tableLayoutPanelBody.Controls.Add(this.gridControlAlarms, 0, 1);
			...
			// gridControlAlarms
			// 
			this.gridControlAlarms.ActivateCurrentCellBehavior = Syncfusion.Windows.Forms.Grid.GridCellActivateAction.DblClickOnCell;
			this.gridControlAlarms.AlphaBlendSelectionColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(94)))), ((int)(((byte)(171)))), ((int)(((byte)(222)))));
			this.gridControlAlarms.BackColor = System.Drawing.Color.White;
			...
			this.gridControlAlarms.BaseStylesMap.AddRange(new Syncfusion.Windows.Forms.Grid.GridBaseStyle[] {
            gridBaseStyle1,
            gridBaseStyle2,
            gridBaseStyle3,
            gridBaseStyle4});
			this.gridControlAlarms.DefaultGridBorderStyle = Syncfusion.Windows.Forms.Grid.GridBorderStyle.Solid;
			this.gridControlAlarms.DefaultRowHeight = 20;
			this.gridControlAlarms.Dock = System.Windows.Forms.DockStyle.Fill;
			this.gridControlAlarms.ExcelLikeCurrentCell = true;
			this.gridControlAlarms.ExcelLikeSelectionFrame = true;
			this.gridControlAlarms.Font = new System.Drawing.Font("Segoe UI", 9F);
			this.gridControlAlarms.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Metro;
			this.gridControlAlarms.HorizontalThumbTrack = true;
			this.gridControlAlarms.Location = new System.Drawing.Point(3, 43);
			this.gridControlAlarms.Name = "gridControlAlarms";
			this.gridControlAlarms.Properties.BackgroundColor = System.Drawing.Color.White;
			this.gridControlAlarms.Properties.ForceImmediateRepaint = false;
			this.gridControlAlarms.Properties.GridLineColor = System.Drawing.Color.FromArgb(((int)(((byte)(212)))), ((int)(((byte)(212)))), ((int)(((byte)(212)))));
			this.gridControlAlarms.Properties.MarkColHeader = false;
			this.gridControlAlarms.Properties.MarkRowHeader = false;
			...
			this.gridControlAlarms.RangeStyles.AddRange(new Syncfusion.Windows.Forms.Grid.GridRangeStyle[] {
            gridRangeStyle1});
			this.gridControlAlarms.ResizeRowsBehavior = Syncfusion.Windows.Forms.Grid.GridResizeCellsBehavior.None;
			this.gridControlAlarms.RowHeightEntries.AddRange(new Syncfusion.Windows.Forms.Grid.GridRowHeight[] {
            new Syncfusion.Windows.Forms.Grid.GridRowHeight(0, 29)});
			this.gridControlAlarms.SelectCellsMouseButtonsMask = System.Windows.Forms.MouseButtons.Left;
			this.gridControlAlarms.SerializeCellsBehavior = Syncfusion.Windows.Forms.Grid.GridSerializeCellsBehavior.SerializeAsRangeStylesIntoCode;
			this.gridControlAlarms.Size = new System.Drawing.Size(736, 560);
			this.gridControlAlarms.SmartSizeBox = false;
			this.gridControlAlarms.TabIndex = 0;
			this.gridControlAlarms.Text = "alarms";
			this.gridControlAlarms.ThemesEnabled = true;
			this.gridControlAlarms.UseRightToLeftCompatibleTextBox = true;
			this.gridControlAlarms.VerticalThumbTrack = true;
			// 
        ...
        private Syncfusion.Windows.Forms.Grid.GridControl gridControlAlarms;
    }
}
