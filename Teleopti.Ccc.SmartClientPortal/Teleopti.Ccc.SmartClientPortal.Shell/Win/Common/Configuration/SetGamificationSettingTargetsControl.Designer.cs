...
{
	partial class SetGamificationSettingTargetsControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.gridControlSelectSettingForTeams = new Syncfusion.Windows.Forms.Grid.GridControl();
			...
			((System.ComponentModel.ISupportInitialize)(this.gridControlSelectSettingForTeams)).BeginInit();
			...
			this.gradientPanelHeader.Size = new System.Drawing.Size(544, 62);
			...
			this.tableLayoutPanelHeader.Size = new System.Drawing.Size(520, 38);
			...
			this.labelHeader.Size = new System.Drawing.Size(196, 25);
			this.labelHeader.TabIndex = 0;
			this.labelHeader.Text = "xxSetSettingTargets";
			// 
			...
			this.tableLayoutPanelBody.Controls.Add(this.gridControlSelectSettingForTeams, 0, 3);
			...
			this.tableLayoutPanelBody.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
			this.tableLayoutPanelBody.Size = new System.Drawing.Size(544, 519);
			this.tableLayoutPanelBody.TabIndex = 4;
			// 
			...
			this.tableLayoutPanelSubHeader2.Size = new System.Drawing.Size(538, 34);
			...
			this.labelSubHeader2.Size = new System.Drawing.Size(161, 17);
			this.labelSubHeader2.TabIndex = 16;
			this.labelSubHeader2.Text = "xxSelectSettingForTeams";
			// 
			...
			this.tableLayoutPanelSubHeader1.Size = new System.Drawing.Size(538, 34);
			...
			// 
			// gridControlSelectSettingForTeams
			// 
			this.gridControlSelectSettingForTeams.AlphaBlendSelectionColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(94)))), ((int)(((byte)(171)))), ((int)(((byte)(222)))));
			...
			this.gridControlSelectSettingForTeams.BaseStylesMap.AddRange(new Syncfusion.Windows.Forms.Grid.GridBaseStyle[] {
            gridBaseStyle1,
            gridBaseStyle2,
            gridBaseStyle3,
            gridBaseStyle4});
			this.gridControlSelectSettingForTeams.ColCount = 3;
			this.tableLayoutPanelBody.SetColumnSpan(this.gridControlSelectSettingForTeams, 2);
			this.gridControlSelectSettingForTeams.ColWidthEntries.AddRange(new Syncfusion.Windows.Forms.Grid.GridColWidth[] {
            new Syncfusion.Windows.Forms.Grid.GridColWidth(0, 35)});
			this.gridControlSelectSettingForTeams.DefaultGridBorderStyle = Syncfusion.Windows.Forms.Grid.GridBorderStyle.Solid;
			this.gridControlSelectSettingForTeams.DefaultRowHeight = 20;
			this.gridControlSelectSettingForTeams.Dock = System.Windows.Forms.DockStyle.Fill;
			this.gridControlSelectSettingForTeams.ForeColor = System.Drawing.SystemColors.ControlText;
			this.gridControlSelectSettingForTeams.GridOfficeScrollBars = Syncfusion.Windows.Forms.OfficeScrollBars.Metro;
			this.gridControlSelectSettingForTeams.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Metro;
			this.gridControlSelectSettingForTeams.Location = new System.Drawing.Point(0, 115);
			this.gridControlSelectSettingForTeams.Margin = new System.Windows.Forms.Padding(0);
			this.gridControlSelectSettingForTeams.MetroScrollBars = true;
			this.gridControlSelectSettingForTeams.Name = "gridControlSelectSettingForTeams";
			this.gridControlSelectSettingForTeams.NumberedRowHeaders = false;
			this.gridControlSelectSettingForTeams.Padding = new System.Windows.Forms.Padding(12, 0, 0, 0);
			this.gridControlSelectSettingForTeams.Properties.BackgroundColor = System.Drawing.SystemColors.Window;
			this.gridControlSelectSettingForTeams.Properties.ForceImmediateRepaint = false;
			this.gridControlSelectSettingForTeams.Properties.GridLineColor = System.Drawing.Color.FromArgb(((int)(((byte)(212)))), ((int)(((byte)(212)))), ((int)(((byte)(212)))));
			this.gridControlSelectSettingForTeams.Properties.MarkColHeader = false;
			this.gridControlSelectSettingForTeams.Properties.MarkRowHeader = false;
			this.gridControlSelectSettingForTeams.RowHeightEntries.AddRange(new Syncfusion.Windows.Forms.Grid.GridRowHeight[] {
            new Syncfusion.Windows.Forms.Grid.GridRowHeight(0, 29)});
			this.gridControlSelectSettingForTeams.SerializeCellsBehavior = Syncfusion.Windows.Forms.Grid.GridSerializeCellsBehavior.SerializeAsRangeStylesIntoCode;
			this.gridControlSelectSettingForTeams.Size = new System.Drawing.Size(544, 404);
			this.gridControlSelectSettingForTeams.SmartSizeBox = false;
			this.gridControlSelectSettingForTeams.TabIndex = 17;
			this.gridControlSelectSettingForTeams.ThemesEnabled = true;
			this.gridControlSelectSettingForTeams.UseRightToLeftCompatibleTextBox = true;
			this.gridControlSelectSettingForTeams.KeyUp += new System.Windows.Forms.KeyEventHandler(this.gridControlSelectSettingForTeamsKeyUp);
			// 
			// comboBoxSite
			// 
			this.comboBoxSite.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.comboBoxSite.BackColor = System.Drawing.Color.White;
			this.comboBoxSite.BeforeTouchSize = new System.Drawing.Size(252, 21);
			...
			this.comboBoxSite.Size = new System.Drawing.Size(252, 21);
			...
			this.comboBoxSite.KeyUp += new System.Windows.Forms.KeyEventHandler(this.gridControlSelectSettingForTeamsKeyUp);
			// 
			// labelChooseSite
			// 
			...
			// 
			// SetGamificationSettingTargetsControl
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.tableLayoutPanelBody);
			this.Controls.Add(this.gradientPanelHeader);
			this.Name = "SetGamificationSettingTargetsControl";
			this.Size = new System.Drawing.Size(544, 581);
			...
			((System.ComponentModel.ISupportInitialize)(this.gridControlSelectSettingForTeams)).EndInit();
		...
		private Syncfusion.Windows.Forms.Grid.GridControl gridControlSelectSettingForTeams;
