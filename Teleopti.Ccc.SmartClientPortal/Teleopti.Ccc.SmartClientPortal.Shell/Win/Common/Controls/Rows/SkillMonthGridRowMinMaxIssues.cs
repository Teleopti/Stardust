...
{
    public class SkillMonthGridRowMinMaxIssues: SkillMonthGridRow
    {
        ...
        public SkillMonthGridRowMinMaxIssues(RowManagerScheduler<SkillMonthGridRow, IDictionary<DateOnlyPeriod, IList<ISkillStaffPeriod>>> rowManager, string cellType, string displayMember, string rowHeaderText)
