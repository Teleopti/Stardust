...
{
    public class SkillMonthGridRowStaffingIssues:SkillMonthGridRow
    {
        ...
        public SkillMonthGridRowStaffingIssues(RowManagerScheduler<SkillMonthGridRow, IDictionary<DateOnlyPeriod, IList<ISkillStaffPeriod>>> rowManager, string cellType, string displayMember, string rowHeaderText, ISkill skill)
