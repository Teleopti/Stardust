...
{
    public class SkillDayGridRowStaffingIssues:SkillDayGridRow
    {
        ...
        public SkillDayGridRowStaffingIssues(RowManagerScheduler<SkillDayGridRow, IDictionary<DateTime, IList<ISkillStaffPeriod>>> rowManager, string cellType, string displayMember, string rowHeaderText, ISkill skill)
