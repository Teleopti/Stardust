...
{
    public class SkillWeekGridRowMinMaxIssues: SkillWeekGridRow
    {
        ...
        public SkillWeekGridRowMinMaxIssues(RowManagerScheduler<SkillWeekGridRow, IDictionary<DateOnlyPeriod, IList<ISkillStaffPeriod>>> rowManager, string cellType, string displayMember, string rowHeaderText)
