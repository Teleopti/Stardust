		    ...
		    : base(rowManager, cellType, displayMember, rowHeaderText)
	    {
		    ...
		    _calculator =
			    new DailyBoostedSkillForecastAndScheduledValueCalculator(
				    () => _rowManager.SchedulerStateHolder.SchedulingResultState, skillPriorityProvider, new SpecificTimeZone(TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.Regional.TimeZone));
	    }
