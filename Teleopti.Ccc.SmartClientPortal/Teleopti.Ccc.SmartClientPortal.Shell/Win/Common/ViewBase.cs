...
namespace Teleopti.Ccc.SmartClientPortal.Shell.Win.Common
{
    ...
    public static class ViewBase
    {
	    ...
	    {
		    return (((ITeleoptiPrincipalWithUnsafePerson)TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal).UnsafePerson().PermissionInformation.RightToLeftDisplay)
