namespace Teleopti.Ccc.SmartClientPortal.Shell.Win.Payroll.Overtime
{
    partial class MultiplicatorControlView
    {
        ...
        private void InitializeComponent()
        {
			...
			((System.ComponentModel.ISupportInitialize)(this.gridMultiplicator)).BeginInit();
			...
			this.buttonAdvDelete.Image = global::Teleopti.Ccc.SmartClientPortal.Shell.Properties.Resources.test_delete_32x32;
			...
			this.buttonAdvDeleteMultiplicator.Image = global::Teleopti.Ccc.SmartClientPortal.Shell.Properties.Resources.ccc_temp_DeleteGroup7;
			...
			this.buttonAdvAddMultiplicator.Image = global::Teleopti.Ccc.SmartClientPortal.Shell.Properties.Resources.test_add2;
			...
			// gridMultiplicator
			// 
			this.gridMultiplicator.AlphaBlendSelectionColor = System.Drawing.Color.FromArgb(((int)(((byte)(64)))), ((int)(((byte)(94)))), ((int)(((byte)(171)))), ((int)(((byte)(222)))));
            ...
            gridBaseStyle3,
            gridBaseStyle4});
			this.gridMultiplicator.ColWidthEntries.AddRange(new Syncfusion.Windows.Forms.Grid.GridColWidth[] {
            new Syncfusion.Windows.Forms.Grid.GridColWidth(0, 35)});
			this.gridMultiplicator.DefaultGridBorderStyle = Syncfusion.Windows.Forms.Grid.GridBorderStyle.Solid;
			this.gridMultiplicator.DefaultRowHeight = 20;
			...
			this.gridMultiplicator.GridOfficeScrollBars = Syncfusion.Windows.Forms.OfficeScrollBars.Metro;
			this.gridMultiplicator.GridVisualStyles = Syncfusion.Windows.Forms.GridVisualStyles.Metro;
			...
			this.gridMultiplicator.MetroScrollBars = true;
			...
			this.gridMultiplicator.Properties.GridLineColor = System.Drawing.Color.FromArgb(((int)(((byte)(212)))), ((int)(((byte)(212)))), ((int)(((byte)(212)))));
			...
			this.gridMultiplicator.ThemesEnabled = true;
			...
			((System.ComponentModel.ISupportInitialize)(this.gridMultiplicator)).EndInit();
        ...
        private Syncfusion.Windows.Forms.Grid.GridControl gridMultiplicator;
        private Syncfusion.Windows.Forms.ButtonAdv buttonAdvAddMultiplicator;
        private Syncfusion.Windows.Forms.ButtonAdv buttonAdvDeleteMultiplicator;
