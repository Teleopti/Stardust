...
namespace Teleopti.Ccc.SmartClientPortal.Shell.Win.Scheduling.LockMenuBuilders
{
	...
	{
		public void Build(IEnumerable<IDayOffTemplate> dayOffList,
			ToolStripMenuItem toolStripMenuItemLockDayOff,
			ToolStripMenuItem toolStripMenuItemLockFreeDaysRm, UserLockHelper userShiftCategoryLockHelper)
		{
			...
			if (displayList.Count > 0)
			{
				...
				toolStripMenuItemDayOffLockRibbon.Click += userShiftCategoryLockHelper.ToolStripMenuItemLockFreeDaysClick;
				toolStripMenuItemDayOffLockRm.MouseUp += userShiftCategoryLockHelper.ToolStripMenuItemDayOffLockRmMouseUp;
			...
			foreach (IDayOffTemplate dayOff in displayList)
			{
				...
				toolStripMenuItemDayOffLockRibbon.Click += userShiftCategoryLockHelper.ToolStripMenuItemLockSpecificDayOffClick;
				toolStripMenuItemDayOffLockRm.Click += userShiftCategoryLockHelper.ToolStripMenuItemLockSpecificDayOffClick;
				toolStripMenuItemLockDayOff.DropDownItems.Add(toolStripMenuItemDayOffLockRibbon);
				toolStripMenuItemLockFreeDaysRm.DropDownItems.Add(toolStripMenuItemDayOffLockRm);
