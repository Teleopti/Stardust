...
{
	partial class AgentSkillAnalyzer
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.listViewIslandsSkillsOnGroup = new System.Windows.Forms.ListView();
			...
			this.listViewIslands = new System.Windows.Forms.ListView();
			this.columnHeader19 = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.columnHeader29 = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.columnHeader20 = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.columnHeader21 = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
			this.listViewGroupsInIsland = new System.Windows.Forms.ListView();
			...
			// 
			this.columnHeaderVirtualGroup.Text = "Virtual groups";
			this.columnHeaderVirtualGroup.Width = 119;
			// 
			// columnHeaderNumberOfSkills
			// 
			this.columnHeaderNumberOfSkills.Text = "# Skills (not loaded)";
			this.columnHeaderNumberOfSkills.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeaderNumberOfSkills.Width = 132;
			// 
			// columnHeaderNumberOfAgents
			// 
			this.columnHeaderNumberOfAgents.Text = "# Agents in group";
			...
			// columnHeaderSkills
			// 
			this.columnHeaderSkills.Text = "Loaded skills";
			this.columnHeaderSkills.Width = 133;
			// 
			// columnHeader2
			// 
			this.columnHeader2.Text = "# Agents on skill";
			this.columnHeader2.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeader2.Width = 90;
			// 
			// columnHeader5
			// 
			this.columnHeader5.Text = "% of agents";
			this.columnHeader5.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// columnHeader6
			// 
			this.columnHeader6.Text = "Forecasted time";
			this.columnHeader6.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// columnHeader7
			// 
			this.columnHeader7.Text = "% of tot forecasted";
			this.columnHeader7.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// columnHeader3
			// 
			this.columnHeader3.Text = "Skill type";
			...
			// columnHeader1
			// 
			this.columnHeader1.Text = "Agents";
			...
			// 
			this.listViewSkillViewSkills.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
            this.columnHeader8,
            this.columnHeader9,
            this.columnHeader10,
            this.columnHeader11,
            ...
            this.columnHeader13,
            this.columnHeader14});
			this.listViewSkillViewSkills.Dock = System.Windows.Forms.DockStyle.Fill;
			this.listViewSkillViewSkills.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this.listViewSkillViewSkills.FullRowSelect = true;
			this.listViewSkillViewSkills.HideSelection = false;
			...
			// columnHeader9
			// 
			this.columnHeader9.Text = "# Agents on skill";
			this.columnHeader9.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeader9.Width = 90;
			// 
			// columnHeader10
			// 
			this.columnHeader10.Text = "% of agents";
			this.columnHeader10.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeader10.Width = 73;
			// 
			// columnHeader11
			// 
			this.columnHeader11.Text = "Forecasted time";
			this.columnHeader11.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeader11.Width = 93;
			// 
			// columnHeader12
			// 
			this.columnHeader12.Text = "% of tot forecasted";
			this.columnHeader12.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeader12.Width = 84;
			// 
			// columnHeader13
			// 
			this.columnHeader13.Text = "Skill type";
			...
			this.tableLayoutPanel3.Controls.Add(this.listViewIslandsSkillsOnGroup, 1, 0);
			this.tableLayoutPanel3.Controls.Add(this.listViewIslands, 0, 0);
			this.tableLayoutPanel3.Controls.Add(this.listViewGroupsInIsland, 1, 0);
			...
			// 
			this.listViewIslandsSkillsOnGroup.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
            this.columnHeader22,
            this.columnHeader23,
            this.columnHeader24,
            this.columnHeader25,
			...
			// columnHeader22
			// 
			this.columnHeader22.Text = "Loaded skills";
			this.columnHeader22.Width = 133;
			// 
			// columnHeader23
			// 
			this.columnHeader23.Text = "# Agents on skill";
			this.columnHeader23.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this.columnHeader23.Width = 90;
			// 
			// columnHeader24
			// 
			this.columnHeader24.Text = "% of agents";
			this.columnHeader24.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// columnHeader25
			// 
			this.columnHeader25.Text = "Forecasted time";
			this.columnHeader25.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// columnHeader26
			// 
			this.columnHeader26.Text = "% of tot forecasted";
			this.columnHeader26.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// columnHeader27
			// 
			this.columnHeader27.Text = "Skill type";
			this.columnHeader27.Width = 104;
			// 
			// columnHeader28
			// 
			this.columnHeader28.Text = "Activity";
			// 
			// listViewIslands
			// 
			this.listViewIslands.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
            this.columnHeader19,
            this.columnHeader29,
            this.columnHeader20,
            this.columnHeader21});
			this.listViewIslands.Dock = System.Windows.Forms.DockStyle.Fill;
			this.listViewIslands.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.listViewIslands.FullRowSelect = true;
			this.listViewIslands.HideSelection = false;
		...
		private System.Windows.Forms.ListView listViewIslandsSkillsOnGroup;
		...
		private System.Windows.Forms.ListView listViewIslands;
		private System.Windows.Forms.ColumnHeader columnHeader19;
		private System.Windows.Forms.ColumnHeader columnHeader20;
		private System.Windows.Forms.ColumnHeader columnHeader21;
		private System.Windows.Forms.ListView listViewGroupsInIsland;
