...
namespace Teleopti.Ccc.SmartClientPortal.Shell.Win.Scheduling
{
	public partial class FilterMultiplePersons : BaseDialogForm
	{
		...
		{
			IEnumerable<IPerson> found = _advancedAgentsFilter.Filter(TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.Culture, textBox1.Text, _searchablePersons, _logonInfos, false);
		...
		private void parse()
		{
			...
			foreach (var expected in inputTextArray)
			{
				...
				var personQuery = _advancedAgentsFilter.Filter(TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.Culture, lowerSearchText, _searchablePersons, _logonInfos, true);
