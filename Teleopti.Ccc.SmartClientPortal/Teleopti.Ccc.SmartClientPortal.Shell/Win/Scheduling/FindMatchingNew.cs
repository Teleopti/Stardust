...
namespace Teleopti.Ccc.SmartClientPortal.Shell.Win.Scheduling
{
	public partial class FindMatchingNew : BaseRibbonForm
	{
		...
		{
			Text = "xxFind replacement candidates for " + _sourcePerson.Name + " at " + _dateOnly.ToShortDateString(TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.Regional.Culture);
