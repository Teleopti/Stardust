        ...
        private static void SetupWpfWindow(Window window, bool useVisualStyle, TimeZoneInfo timeZoneInfo)
        {
            ...
            if (StateHolderReader.IsInitialized)
            {
                ...
                window.FlowDirection =
                    (((ITeleoptiPrincipalWithUnsafePerson)TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal).UnsafePerson().PermissionInformation.RightToLeftDisplay) ? FlowDirection.RightToLeft : FlowDirection.LeftToRight;
