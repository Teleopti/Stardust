...
{
    /// <summary>
    /// Reperesents the test class of the PersonAccountTypeComparer.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [TestFixture]
    public class PersonAccountTypeComparerTest
    {
        ...
        private PersonAccountTypeComparer comparer = new PersonAccountTypeComparer();
