...
{
    /// <summary>
    /// Test class for the <see cref="SchedulePeriodBalanceOutComparer"/> class 
    /// </summary>
    [TestFixture]
    public class SchedulePeriodBalanceOutComparerTest
    {
        #region Variables

        private SchedulePeriodModel _adapter1, _adapter2;
        private SchedulePeriodBalanceOutComparer _target;
        ...
        {
            _schedulePeriod1.BalanceOut = new TimeSpan(1, 1, 1);
            _schedulePeriod2.BalanceOut = TimeSpan.Zero;

            // Calls the compares method
            _target = new SchedulePeriodBalanceOutComparer();
        ...
        {
            _schedulePeriod1.BalanceOut = TimeSpan.Zero;
            _schedulePeriod2.BalanceOut = new TimeSpan(-1, 1, 1);
        ...
        {
            _schedulePeriod1.BalanceOut = new TimeSpan(-1, 1, 1);
            _schedulePeriod2.BalanceOut = new TimeSpan(2, 1, 1);
        ...
        {
            _schedulePeriod1.BalanceOut = new TimeSpan(2, 1, 1);
            _schedulePeriod2.BalanceOut = new TimeSpan(1, 1, 1);
