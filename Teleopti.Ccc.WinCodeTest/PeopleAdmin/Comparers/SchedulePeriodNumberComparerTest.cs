...
{
    /// <summary>
    /// Test class for the SchedulePeriodNumberComparer class of the wincode.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [TestFixture]
    public class SchedulePeriodNumberComparerTest
    {
        #region Variables

        private SchedulePeriodModel _target, _schedulePeriodModel;
        private SchedulePeriodNumberComparer schedulePeriodNumberComparer;
        private int result;
        ...
        public void VerifyCompareMethodWithAllNull()
        {
            ...
            schedulePeriodNumberComparer = new SchedulePeriodNumberComparer();
            result = schedulePeriodNumberComparer.Compare(_target, _schedulePeriodModel);
