...
namespace Teleopti.Ccc.WinCodeTest.PeopleAdmin.Comparers
{
    ...
    public class OptionalColumnComparerTest
    {
		...
		public void TestInit()
		{
            ...
            _target = new PersonGeneralModel(_person, new UserDetail(_person), _principalAuthorization, new PersonAccountUpdater());
			...
			// Ses the contained entity
            _personGeneralModel = new PersonGeneralModel(_person1, new UserDetail(_person1), _principalAuthorization , new PersonAccountUpdater());
		}
