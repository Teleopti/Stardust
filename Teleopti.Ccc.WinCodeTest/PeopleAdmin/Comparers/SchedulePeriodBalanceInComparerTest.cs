...
{
    /// <summary>
    /// Test class for the <see cref="SchedulePeriodBalanceInComparer"/> class 
    /// </summary>
    [TestFixture]
    public class SchedulePeriodBalanceInComparerTest
    {
        #region Variables

        private SchedulePeriodModel _adapter1, _adapter2;
        private SchedulePeriodBalanceInComparer _target;
        ...
        {
            _schedulePeriod1.BalanceIn = new TimeSpan(1, 1, 1);
            _schedulePeriod2.BalanceIn = TimeSpan.Zero;

            // Calls the compares method
            _target = new SchedulePeriodBalanceInComparer();
        ...
        {
            _schedulePeriod1.BalanceIn = TimeSpan.Zero;
            _schedulePeriod2.BalanceIn = new TimeSpan(-1, 1, 1);
        ...
        {
            _schedulePeriod1.BalanceIn = new TimeSpan(-1, 1, 1);
            _schedulePeriod2.BalanceIn = new TimeSpan(2, 1, 1);
        ...
        {
            _schedulePeriod1.BalanceIn = new TimeSpan(2, 1, 1);
            _schedulePeriod2.BalanceIn = new TimeSpan(1, 1, 1);
