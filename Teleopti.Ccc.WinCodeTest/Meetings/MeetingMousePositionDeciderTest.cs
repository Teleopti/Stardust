...
namespace Teleopti.Ccc.WinCodeTest.Meetings
{
    ...
    public class MeetingMousePositionDeciderTest
    {
        ...
        public void Setup()
        {
            ...
            _period = TimeZoneHelper.NewUtcDateTimePeriodFromLocalDateTime(_start, _end, TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone);
        ...
        public void ShouldSetMeetingMousePositionStartAndSetCursor()
        {
            ...
            var timePeriod = TimeZoneHelper.NewUtcDateTimePeriodFromLocalDateTime(start, end, TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone);
