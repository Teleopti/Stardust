...
namespace Teleopti.Ccc.WinCodeTest.Grouping
{
	...
	public class PersonSelectorPresenterTest
	{
		...
		public void ShouldSetTabsInView()
		{
            ...
            Expect.Call(_commandProvider.GetLoadBuiltInTabsCommand(PersonSelectorField.PartTimePercentage, _view, Resources.PartTimePercentageLower, _myApplicationFunction, true)).Return(new LoadBuiltInTabsCommand(PersonSelectorField.PartTimePercentage, _unitOfWorkFactory, _repositoryFactory, _view, Resources.PartTimePercentage, _commonNameSetting, _myApplicationFunction, true));
