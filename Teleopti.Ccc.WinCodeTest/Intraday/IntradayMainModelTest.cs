...
namespace Teleopti.Ccc.WinCodeTest.Intraday
{
	...
	public class IntradayMainModelTest
	{
		...
		public void ShouldReturnPeriodAsDateTimePeriod()
		{
			...
			Assert.AreEqual(_target.PeriodAsDateTimePeriod(), dateOnlyPeriod.ToDateTimePeriod(TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.Regional.TimeZone));
		}
	}
}
