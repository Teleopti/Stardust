...
namespace Teleopti.Ccc.WinCodeTest.Intraday
{
	...
	public class OnEventForecastMessageCommandTest
	{
		...
		public void Setup()
		{
			...
			_schedulerStateHolder = new SchedulerStateHolder(_scenario, new DateOnlyPeriodAsDateTimePeriod(_period, TeleoptiPrincipalLocator_DONTUSE_REALLYDONTUSE.CurrentPrincipal.Regional.TimeZone), _persons, mocks.DynamicMock<IDisableDeletedFilter>(), new SchedulingResultStateHolder(), new TimeZoneGuard());
