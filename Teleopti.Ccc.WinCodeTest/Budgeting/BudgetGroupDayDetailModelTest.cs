...
namespace Teleopti.Ccc.WinCodeTest.Budgeting
{
    ...
    public class BudgetGroupDayDetailModelTest
    {
        ...
        public void Setup()
        {
            ...
            _budgetDay.TotalAllowance = 10d;
            _budgetDay.Allowance = 8d;
        ...
        public void ShouldSetValues()
        {
            ...
            target.TotalAllowance.Should().Be.EqualTo(_budgetDay.TotalAllowance);
            target.Allowance.Should().Be.EqualTo(_budgetDay.Allowance);
        }
