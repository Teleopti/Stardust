...
{
    /// <summary>
    /// Tests for SiteListBoxPresenter Class
    /// </summary>
    [TestFixture]
    public class SiteListBoxPresenterTest
    {
        private Site _entity;
        private SiteListBoxPresenter _target;
        ...
        public void Setup()
        {
            _entity = SiteFactory.CreateSimpleSite("mySite");
            _target = new SiteListBoxPresenter(_entity);
        }
