...
{
    /// <summary>
    /// Tests for BusinessUnitListBoxPresenter Class
    /// </summary>
    [TestFixture]
    public class BusinessUnitListBoxPresenterTest
    {
        private BusinessUnit _entity;
        private BusinessUnitListBoxPresenter _target;
        ...
        public void Setup()
        {
            _entity = BusinessUnitFactory.CreateSimpleBusinessUnit("myName");
            _target = new BusinessUnitListBoxPresenter(_entity);
        }
