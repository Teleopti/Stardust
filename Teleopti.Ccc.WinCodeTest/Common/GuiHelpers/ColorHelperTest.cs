...
namespace Teleopti.Ccc.WinCodeTest.Common.GuiHelpers
{
    ...
    public class ColorHelperTest
    {
        ...
        public static void VerifySetThemes()
        {
            ...
            Assert.AreNotEqual(new System.Drawing.Font("Tahoma", 8.25F), splitContainer.Font);
            ColorHelper.SetSplitContainerTheme(splitContainer);
            Assert.AreEqual(new System.Drawing.Font("Tahoma", 8.25F), splitContainer.Font);
            Assert.AreNotEqual(new System.Drawing.Font("Tahoma", 8.25F), tabControl.ActiveTabFont);
            ColorHelper.SetTabControlTheme(tabControl);
            Assert.AreEqual(new System.Drawing.Font("Tahoma", 8.25F), tabControl.ActiveTabFont);
