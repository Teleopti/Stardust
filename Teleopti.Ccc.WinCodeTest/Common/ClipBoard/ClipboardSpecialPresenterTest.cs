    ...
    public class ClipboardSpecialPresenterTest
    {
        ...
        public void VerifyInitialize()
        {
            ...
            using (_mocks.Record())
            {
                ...
                Expect.Call(authorization.IsPermitted(DefinedRaptorApplicationFunctionPaths.ModifyPersonDayOff)).Return(true).Repeat.Once();
                Expect.Call(authorization.IsPermitted(DefinedRaptorApplicationFunctionPaths.ModifyPersonAssignment)).Return(true).Repeat.Times(3);
