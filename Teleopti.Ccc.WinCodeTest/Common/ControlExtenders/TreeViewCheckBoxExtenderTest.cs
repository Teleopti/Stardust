...
{
    [TestFixture]
    public class TreeViewCheckBoxTest : IDisposable
    {

        #region Variables

        // Variable to hold object to be tested for reuse by init functions
        private TreeViewCheckBoxExtender _target;
        ...
        public void TestInit()
        {
            ...
            _target = new TreeViewCheckBoxExtender(_treeView, _treeRoot, true, AutoParentSelectionOption.SelectParentIfAllChildSelected);
        }
