...
namespace Teleopti.Ccc.WinCodeTest.Scheduler
{
	...
	public class PersistConflictTest : IMessageQueueRemoval
    {
        ...
        public void VerifyUndoClientChangesWhenModified()
        {
            ...
            ScheduleRange range = mocks.PartialMock<ScheduleRange>(schedDic, pDayOff, new PersistableScheduleDataPermissionChecker(new PrincipalAuthorizationWithFullPermission()));
        ...
        public void VerifyOverwriteServerChangesWhenModified()
        {
            ...
            ScheduleRange range = mocks.PartialMock<ScheduleRange>(schedDic, dataOrg, new PersistableScheduleDataPermissionChecker(new PrincipalAuthorizationWithFullPermission()));
