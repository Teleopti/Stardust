...
namespace Teleopti.Ccc.WinCodeTest.Scheduler.Requests
{
    ...
    public class RequestAllowancePresenterTest
    {
        ...
        public void ShouldReloadWhenAllowanceSelectionChanged()
        {
            ...
            _model.Stub(x => x.AllowanceSelected).Return(false);
        ...
        public void ShouldNotReloadWhenAllowanceSelectionChange()
        {
            var visibleWeek = new DateOnlyPeriod();
            _model.Stub(x => x.VisibleWeek).Return(visibleWeek);
            _model.Stub(x => x.AllowanceSelected).Return(true);
        ...
        public void ShouldReloadWhenTotalAllowanceSelectionChanged()
        {
            var visibleWeek = new DateOnlyPeriod();
            _model.Stub(x => x.VisibleWeek).Return(visibleWeek);
            _model.Stub(x => x.TotalAllowanceSelected).Return(false);
        ...
        public void ShouldNotReloadWhenTotalAllowanceSelectionChange()
        {
            var visibleWeek = new DateOnlyPeriod();
            _model.Stub(x => x.VisibleWeek).Return(visibleWeek);
            _model.Stub(x => x.TotalAllowanceSelected).Return(true);
