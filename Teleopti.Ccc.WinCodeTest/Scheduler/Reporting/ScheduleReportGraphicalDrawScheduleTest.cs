...
namespace Teleopti.Ccc.WinCodeTest.Scheduler.Reporting
{
	...
	public class ScheduleReportGraphicalDrawScheduleTest
	{
		...
		public void ShouldDrawScheduleAndReturnTop()
		{
			...
			var dateOnlyAsPeriod = new DateOnlyAsDateTimePeriod(dateOnly, TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone);
        ...
        public void ShouldNotDrawScheduleButReturnTopIfNoPersonPeriod()
        {
            ...
            using (_mockRepository.Record())
            {
                ...
                Expect.Call(_scheduleDay.DateOnlyAsPeriod).Return(new DateOnlyAsDateTimePeriod(new DateOnly(2011, 1, 1), TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone));
