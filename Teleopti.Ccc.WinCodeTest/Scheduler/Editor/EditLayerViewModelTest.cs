...
namespace Teleopti.Ccc.WinCodeTest.Scheduler.Editor
{
    ...
    public class EditLayerViewModelTest
    {
        ...
        private IMainShiftActivityLayerNew _layer;
        ...
        public void Setup()
        {
            ...
            _layer = new MainShiftActivityLayerNew(_activity, _period);
        ...
        {
            public ModelForTest(IMainShiftActivityLayerNew layer) : base(null, layer, null,new EventAggregator(), new MoveLayerVertical())
            {
                MovePermitted = true;
            }
