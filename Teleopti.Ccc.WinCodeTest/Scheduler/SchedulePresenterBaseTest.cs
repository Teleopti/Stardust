...
namespace Teleopti.Ccc.WinCodeTest.Scheduler
{
    ...
    public class SchedulePresenterBaseTest
    {
        ...
        public void Setup()
        {
            ...
            _personNameComparer = new PersonNameComparer(TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.Culture);
        }
        ...
        public void VerifyProperties()
        {
            ...
            var period = new DateOnlyPeriodAsDateTimePeriod(new DateOnlyPeriod(_date,_date), TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone);
        ...
        public void VerifyQueryCellInfoScheduleCell()
        {
            ...
            _target.SelectedPeriod = new DateOnlyPeriodAsDateTimePeriod(new DateOnlyPeriod(_date,_date), TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone);
		...
		{
			var comparer = new ContractTimeComparer(TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.Culture);
