...
namespace Teleopti.Ccc.WinCodeTest.Scheduler.AgentRestrictions
{
	...
	public class AgentRestrictionsDetailEffectiveRestrictionExtractorTest
	{
		...
		public void ShouldExtractFullDayAbsence()
		{
			...
			Assert.AreEqual(TimeHelper.GetLongHourMinuteTimeString(projection.ContractTime(), TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.Culture), _preferenceCellData.ShiftLengthScheduledShift);
		...
		public void ShouldExtractDayOff()
		{
			...
			Assert.AreEqual(TimeHelper.GetLongHourMinuteTimeString(dayOff.TargetLength, TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.Culture), _preferenceCellData.ShiftLengthScheduledShift);
		}
