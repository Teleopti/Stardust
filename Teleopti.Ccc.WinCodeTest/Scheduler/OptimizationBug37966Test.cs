...
namespace Teleopti.Ccc.WinCodeTest.Scheduler
{
	...
	public class OptimizationBug37966Test
	{
		...
		public void ShouldNotCrashWhenDoingRollbackWithTwoPeople()
		{
			...
			var person2 = PersonFactory.CreatePersonWithValidVirtualSchedulePeriod(PersonFactory.CreatePerson().WithId(),
				new DateOnly(2014, 3, 1));
			person2.AddSkill(skill, new DateOnly(2014, 3, 1));
			var personPeriod2 = person2.Period(new DateOnly(2014, 3, 1));
			personPeriod2.RuleSetBag = bag;
			personPeriod2.Team = personPeriod.Team;
			personPeriod2.PersonContract.Contract = personPeriod.PersonContract.Contract;
			...
			StateHolder.AllPermittedPersons.Add(person2);
