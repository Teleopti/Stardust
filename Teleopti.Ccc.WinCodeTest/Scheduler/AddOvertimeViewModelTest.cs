...
namespace Teleopti.Ccc.WinCodeTest.Scheduler
{
    ...
    public class AddOvertimeViewModelTest
    {
        ...
        public void Setup()
        {
	        ...
	        var startDateTimeLocal = _period.StartDateTimeLocal(TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone);
	        _defaultTimePeriod = TimeZoneHelper.NewUtcDateTimePeriodFromLocalDateTime(startDateTimeLocal.Add(TimeSpan.FromHours(9)), startDateTimeLocal.Add(TimeSpan.FromHours(13)), TeleoptiPrincipalForLegacy.CurrentPrincipal.Regional.TimeZone);
