    ...
    public class GridlockAllPreferencesFulfilledShiftCommandTest
    {
        ...
        public void ShouldLockFulfilledShiftPreferences()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayPreferenceRestrictionExtractor.RestrictionFulfilledShift(_restrictionChecker)).Return(_day1);
                Expect.Call(_scheduleDayPreferenceRestrictionExtractor.RestrictionFulfilledShift(_restrictionChecker)).Return(null);
