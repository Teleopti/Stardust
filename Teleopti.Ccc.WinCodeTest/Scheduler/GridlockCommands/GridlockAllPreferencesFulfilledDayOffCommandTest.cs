    ...
    public class GridlockAllPreferencesFulfilledDayOffCommandTest
    {
        ...
        public void ShouldLockFulfilledDayOffPreferences()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayPreferenceRestrictionExtractor.RestrictionFulfilledDayOff(_restrictionChecker)).Return(_day1);
                Expect.Call(_scheduleDayPreferenceRestrictionExtractor.RestrictionFulfilledDayOff(_restrictionChecker)).Return(null);
