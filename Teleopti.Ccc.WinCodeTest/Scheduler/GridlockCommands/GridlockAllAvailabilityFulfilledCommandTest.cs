    ...
    public class GridlockAllAvailabilityFulfilledCommandTest
    {
        ...
        public void ShouldLockFulfilledStudentAvailabilities()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayAvailabilityRestrictionExtractor.RestrictionFulfilled(_restrictionChecker)).Return(_day1);
                Expect.Call(_scheduleDayAvailabilityRestrictionExtractor.RestrictionFulfilled(_restrictionChecker)).Return(null);
