...
{
    [TestFixture]
    public class GridlockAllPreferencesFulfilledCommandTest
    {
        private GridlockAllPreferencesFulfilledCommand _target;
        ...
        public void Setup()
        {
            ...
            _target = new GridlockAllPreferencesFulfilledCommand(_gridScheduleExtractor, _restrictionChecker, _scheduleDayPreferenceRestrictionExtractor, _gridlockManager);
        }
