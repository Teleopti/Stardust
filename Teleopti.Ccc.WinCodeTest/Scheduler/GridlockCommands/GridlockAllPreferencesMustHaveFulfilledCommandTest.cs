    ...
    public class GridlockAllPreferencesMustHaveFulfilledCommandTest
    {
        ...
        public void ShouldLockFulfilledPreferences()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayPreferenceRestrictionExtractor.RestrictionFulfilledMustHave(_restrictionChecker)).Return(_day1);
                Expect.Call(_scheduleDayPreferenceRestrictionExtractor.RestrictionFulfilledMustHave(_restrictionChecker)).Return(null);
