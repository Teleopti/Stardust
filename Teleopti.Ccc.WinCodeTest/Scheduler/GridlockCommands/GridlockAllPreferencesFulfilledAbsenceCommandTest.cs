    ...
    public class GridlockAllPreferencesFulfilledAbsenceCommandTest
    {
        ...
        public void ShouldLockFulfilledAbsencePreferences()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayPreferenceRestrictionExtractor.RestrictionFulfilledAbsence(_restrictionChecker)).Return(_day1);
                Expect.Call(_scheduleDayPreferenceRestrictionExtractor.RestrictionFulfilledAbsence(_restrictionChecker)).Return(null);
