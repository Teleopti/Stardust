    ...
    public class GridlockAllRotationsFulfilledDayOffCommandTest
    {
        ...
        public void ShouldLockFulfilledRotationsDayOff()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayRotationRestrictionExtractor.RestrictionFulfilledDayOff(_restrictionChecker)).Return(_day1);
                Expect.Call(_scheduleDayRotationRestrictionExtractor.RestrictionFulfilledDayOff(_restrictionChecker)).Return(null);
