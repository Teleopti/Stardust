...
{
    [TestFixture]
    public class GridlockAllRotationsFulfilledShiftCommandTest
    {
        private GridlockAllRotationsFulfilledShiftCommand _target;
        ...
        public void Setup()
        {
            ...
            _target = new GridlockAllRotationsFulfilledShiftCommand(_gridScheduleExtractor, _restrictionChecker, _scheduleDayRotationRestrictionExtractor, _gridlockManager);
        }
        ...
        public void ShouldLockFulfilledRotations()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayRotationRestrictionExtractor.RestrictionFulfilledShift(_restrictionChecker, _day1)).Return(_day1);
                Expect.Call(_scheduleDayRotationRestrictionExtractor.RestrictionFulfilledShift(_restrictionChecker, _day2)).Return(null);
