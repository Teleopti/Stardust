    ...
    public class GridlockAllRotationsFulfilledShiftCommandTest
    {
        ...
        public void ShouldLockFulfilledRotations()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayRotationRestrictionExtractor.RestrictionFulfilledShift(_restrictionChecker)).Return(_day1);
                Expect.Call(_scheduleDayRotationRestrictionExtractor.RestrictionFulfilledShift(_restrictionChecker)).Return(null);
