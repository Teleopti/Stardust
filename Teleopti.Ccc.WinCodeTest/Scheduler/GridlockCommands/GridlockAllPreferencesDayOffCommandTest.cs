...
{
    [TestFixture]
    public class GridlockAllPreferencesDayOffCommandTest
    {
        private GridlockAllPreferencesDayOffCommand _target;
        ...
        public void Setup()
        {
            ...
            _target = new GridlockAllPreferencesDayOffCommand(_gridScheduleExtractor, _scheduleDayPreferenceRestrictionExtractor, _gridlockManager);
        }
        ...
        public void ShouldLockDayOffPreferences()
        {
            using(_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayPreferenceRestrictionExtractor.AllRestrictedDayOffs(_scheduleDays)).Return(_scheduleDays);
