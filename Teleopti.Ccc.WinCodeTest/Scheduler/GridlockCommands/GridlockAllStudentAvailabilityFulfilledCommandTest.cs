    ...
    public class GridlockAllStudentAvailabilityFulfilledCommandTest
    {
        ...
        public void ShouldLockFulfilledStudentAvailabilities()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayStudentAvailabilityRestrictionExtractor.RestrictionFulfilled(_restrictionChecker)).Return(_day1);
                Expect.Call(_scheduleDayStudentAvailabilityRestrictionExtractor.RestrictionFulfilled(_restrictionChecker)).Return(null);
