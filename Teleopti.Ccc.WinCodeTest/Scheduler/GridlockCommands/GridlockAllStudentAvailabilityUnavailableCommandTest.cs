...
{
    [TestFixture]
    public class GridlockAllStudentAvailabilityUnavailableCommandTest
    {
        private GridlockAllStudentAvailabilityUnavailableCommand _target;
        ...
        public void Setup()
        {
            ...
            _target = new GridlockAllStudentAvailabilityUnavailableCommand(_gridScheduleExtractor, _scheduleDayStudentAvailabilityRestrictionExtractor, _gridlockManager);
        }
        ...
        public void ShouldLockAllRotations()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayStudentAvailabilityRestrictionExtractor.AllUnavailable(_scheduleDays)).Return(_scheduleDays);
