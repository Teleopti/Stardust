    ...
    public class GridlockAllRotationsFulfilledCommandTest
    {
        ...
        public void ShouldLockFulfilledRotations()
        {
            using (_mock.Record())
            {
                ...
                Expect.Call(_scheduleDayRotationRestrictionExtractor.RestrictionFulfilled(_restrictionChecker)).Return(_day1);
                Expect.Call(_scheduleDayRotationRestrictionExtractor.RestrictionFulfilled(_restrictionChecker)).Return(null);
