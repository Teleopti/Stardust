...
namespace Teleopti.Ccc.WinCodeTest.Scheduler
{
	...
	public class ExportToScenarioAbsenceFinderTest
	{
		...
		public void ShouldFindAbsences()
		{
			...
			var personAbsence1 = PersonAbsenceFactory.CreatePersonAbsence(person, scenario, dateTimePeriod, absence1);
			var personAbsence2 = PersonAbsenceFactory.CreatePersonAbsence(person, scenario, dateTimePeriod, absence2);
			...
			var range = new ScheduleRange(scheduleDictionary, parameters, new PersistableScheduleDataPermissionChecker(new PermissionProvider(PrincipalAuthorization.Current())), PrincipalAuthorization.Current());
			...
			var result = _target.Find(scenario, scheduleDictionary, persons, scheduleDaysToExport, new List<DateOnly> {dateOnly});
