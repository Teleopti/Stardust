SET PROCESSNAME=CopyPayrollDll
::current dir
SET DIRECTORY=%~dp0
...
::execute
ECHO Running %PROCESSNAME%.ps1 >> "%DIRECTORY%\CopyPayrollDll.txt" 2>&1
...
IF %ERRORLEVEL% EQU 0 (
  ...
  ECHO This line will create a file to indicate that %PROCESSNAME%.ps1 Scheduled task run correctly. > "%DIRECTORY%\%PROCESSNAME%_Success.txt"
