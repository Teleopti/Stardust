...
task default -depends init, PreReq, CreateAzureMultiplePkg, PostReq
...
task CreateAzureMultiplePkg -depends Init, PreReq -description "Create Azure Multiple Package" {
    
	Write-Output "##teamcity[blockOpened name='<CreateAzureMultiplePkg>']"
...
task PostReq -depends Init, PreReq, CreateAzureMultiplePkg -description "PostReq steps" {
