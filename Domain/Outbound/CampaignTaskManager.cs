...
namespace Teleopti.Ccc.Domain.Outbound
{
	public class CampaignTaskManager : IOutboundCampaignTaskManager
	{
		...
		public CampaignTaskManager(OutboundProductionPlanFactory outboundProductionPlanFactory,
			IOutboundScheduledResourcesProvider outboundScheduledResourcesProvider)
		{
		...
		{
			var incomingTask = _outboundProductionPlanFactory.CreateAndMakeInitialPlan(campaign.SpanningPeriod,
				campaign.CampaignTasks(), campaign.AverageTaskHandlingTime(), campaign.WorkingHours);
