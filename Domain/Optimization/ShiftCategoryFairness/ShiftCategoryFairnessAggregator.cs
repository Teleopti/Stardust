...
namespace Teleopti.Ccc.Domain.Optimization.ShiftCategoryFairness
{
	...
	{
		IShiftCategoryFairnessHolder GetShiftCategoryFairnessForPersons(IScheduleDictionary scheduleDictionary, IList<IPerson> persons);
	}
	...
	public class ShiftCategoryFairnessAggregator : IShiftCategoryFairnessAggregator
	{
		...
		public IShiftCategoryFairnessHolder GetShiftCategoryFairnessForPersons(IScheduleDictionary scheduleDictionary, IList<IPerson> persons)
		{
