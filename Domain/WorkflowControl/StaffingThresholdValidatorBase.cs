...
{
	public abstract class StaffingThresholdValidatorBase 
	{
		...
		protected abstract Specification<ISkillStaffPeriod> GetIntervalsForUnderstaffing(ISkill skill);
		protected abstract Specification<ISkillStaffPeriod> GetIntervalsForSeriousUnderstaffing(ISkill skill);
