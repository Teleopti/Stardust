...
{
	public class SkillDayChangedEventHandler : ISkillDayChangedEventHandler
	{
		...
		public SkillDayChangedEventHandler(ISkillDayRepository skillDayRepository, IAnalyticsWorkloadRepository analyticsWorkloadRepository, IAnalyticsScenarioRepository analyticsScenarioRepository, IAnalyticsForecastWorkloadRepository analyticsForecastWorkloadRepository, IAnalyticsIntervalRepository analyticsIntervalRepository, AnalyticsDateMapper analyticsDateMapper)
		{
		...
		public void Handle(SkillDayChangedEvent @event)
		{
