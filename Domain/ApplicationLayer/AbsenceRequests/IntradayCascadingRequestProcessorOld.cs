...
{
	public class IntradayCascadingRequestProcessorOld : IIntradayRequestProcessor
	{
		...
		public IntradayCascadingRequestProcessorOld(ICommandDispatcher commandDispatcher,
