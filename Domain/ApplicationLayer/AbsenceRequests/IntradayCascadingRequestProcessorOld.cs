...
{
	public class IntradayCascadingRequestProcessorOldReadModel : IIntradayRequestProcessor
	{
		...
		public IntradayCascadingRequestProcessorOldReadModel(ICommandDispatcher commandDispatcher,
