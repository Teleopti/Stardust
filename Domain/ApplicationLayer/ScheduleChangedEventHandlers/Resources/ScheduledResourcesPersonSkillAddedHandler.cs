...
namespace Teleopti.Ccc.Domain.ApplicationLayer.ScheduleChangedEventHandlers.Resources
{
	public class ScheduledResourcesPersonSkillAddedHandler : IHandleEvent<PersonSkillAddedEvent>
	{
		...
		public ScheduledResourcesPersonSkillAddedHandler(IScheduledResourcesReadModelStorage scheduledResourcesReadModelStorage, IScheduleProjectionReadOnlyRepository readModelFinder, IPersonRepository personRepository, ISkillRepository skillRepository, IScenarioRepository scenarioRepository)
		{
