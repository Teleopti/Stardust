...
{
	public class ScheduledResourcesPersonPeriodStartDateChangedHandler : IHandleEvent<PersonPeriodStartDateChangedEvent>
	{
		...
		public ScheduledResourcesPersonPeriodStartDateChangedHandler(IScheduledResourcesReadModelPersister scheduledResourcesReadModelStorage, IScheduleProjectionReadOnlyRepository readModelFinder, ISkillRepository skillRepository, IScenarioRepository scenarioRepository)
		{
		...
		public void Handle(PersonPeriodStartDateChangedEvent @event)
		{
