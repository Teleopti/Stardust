...
{
	public class ScheduledResourcesPersonReactivatedHandler : IHandleEvent<PersonReactivatedEvent>
	{
		...
		public ScheduledResourcesPersonReactivatedHandler(IScheduledResourcesReadModelPersister scheduledResourcesReadModelStorage, IScheduleProjectionReadOnlyRepository readModelFinder, ISkillRepository skillRepository, IScenarioRepository scenarioRepository)
		{
		...
		public void Handle(PersonReactivatedEvent @event)
		{
