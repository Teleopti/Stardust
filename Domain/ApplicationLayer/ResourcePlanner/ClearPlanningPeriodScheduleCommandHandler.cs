...
namespace Teleopti.Ccc.Domain.ApplicationLayer.ResourcePlanner
{
	public class ClearPlanningPeriodScheduleCommandHandler
	{
		...
		public ClearPlanningPeriodScheduleCommandHandler(IPlanningPeriodRepository planningPeriodRepository, IScenarioRepository scenarioRepository, IPersonRepository personRepository, IPersonAssignmentRepository personAssignmentRepository, ICurrentUnitOfWork currentUnitOfWork)
		{
