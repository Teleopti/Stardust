...
{
    public class PayrollResultDetail : AggregateEntity, IPayrollResultDetail
    {
        ...
        public PayrollResultDetail(DetailLevel detailLevel, string message, DateTime timestamp, Exception exception) : this()
        {
