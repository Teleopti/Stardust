...
{
	public class ExportStaffingErrorMessageProvider
	{
		...
		public ExportStaffingErrorMessageProvider(IStaffingSettingsReader staffingSettingsReader, INow now, IUserCulture userCulture,
		...
		public ExportStaffingValidationObject ValidateExportBpoPeriod(DateOnly periodStartDate, DateOnly periodEndDate)
		{
			...
			if (periodStartDate > periodEndDate)
			{
				...
				validationObject.ErrorMessage = Resources.BpoExportPeriodStartDateBeforeEndDate;
