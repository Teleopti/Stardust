...
namespace Teleopti.Ccc.Domain.ResourceCalculation
{
	...
	public class ShiftProjectionCacheManagerLessResources : IShiftProjectionCacheManager, IDisposable
	{
		...
		public ShiftProjectionCacheManagerLessResources(IRuleSetDeletedActivityChecker ruleSetDeletedActivityChecker,
		...
		public ShiftProjectionCache ShiftProjectionCacheFromShift(IEditableShift shift, IDateOnlyAsDateTimePeriod dateOnlyAsDateTimePeriod)
		{
			...
			ret.SetDateLessResources(dateOnlyAsDateTimePeriod);
