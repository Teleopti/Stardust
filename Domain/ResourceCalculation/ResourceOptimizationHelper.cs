	...
	public class ResourceOptimizationHelper
	{
		...
		public void ResourceCalculate(DateOnly localDate, ResourceCalculationData resourceCalculationData)
		{
			...
			using (PerformanceOutput.ForOperation("ResourceCalculate " + localDate.ToShortDateString()))
			{
				...
				{
					context = _resourceCalculationContextFactory.Create(resourceCalculationData.Schedules, resourceCalculationData.Skills, resourceCalculationData.Bpos, false, localDate.ToDateOnlyPeriod());
				}
