...
namespace Teleopti.Ccc.Domain.ResourceCalculation
{
	...
	public interface ISwapAndModifyServiceNew
	{
        ...
        /// <returns></returns>
        IEnumerable<IBusinessRuleResponse> Swap(IPerson person1, IPerson person2, IList<DateOnly> dates, IList<DateOnly> lockedDates, IScheduleDictionary scheduleDictionary, INewBusinessRuleCollection newBusinessRuleCollection, IScheduleTagSetter scheduleTagSetter);
	}
}
