...
namespace Teleopti.Ccc.Domain.Scheduling.DayOffScheduling
{
	public interface IDaysOffSchedulingService
	{
		...
		void Execute(IList<IScheduleMatrixPro> matrixList, ISchedulePartModifyAndRollbackService rollbackService, ISchedulingOptions schedulingOptions, IScheduleTagSetter scheduleTagSetter);
	}
	...
	public class DaysOffSchedulingService : IDaysOffSchedulingService
	{
		...
		public void Execute(IList<IScheduleMatrixPro> matrixList, ISchedulePartModifyAndRollbackService rollbackService, ISchedulingOptions schedulingOptions, IScheduleTagSetter scheduleTagSetter)
		{
			var cancelMe = false;
