...
{
	public class StudentAvailabilityDay : AggregateRoot_Events_ChangeInfo_Versioned_BusinessUnit, IRestrictionOwner, IStudentAvailabilityDay, IAggregateRoot_Events
	{
