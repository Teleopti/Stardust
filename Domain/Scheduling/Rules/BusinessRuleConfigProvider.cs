...
namespace Teleopti.Ccc.Domain.Scheduling.Rules
{
	...
	public class BusinessRuleConfigProvider25635ToggleOff : IBusinessRuleConfigProvider
	{
		private readonly IBusinessRuleProvider _businessRuleProvider;
		private readonly ISchedulingResultStateHolder _schedulingResultStateHolder;

		public BusinessRuleConfigProvider25635ToggleOff(IBusinessRuleProvider businessRuleProvider, ISchedulingResultStateHolder schedulingResultStateHolder)
		{
			_businessRuleProvider = businessRuleProvider;
			_schedulingResultStateHolder = schedulingResultStateHolder;
			_schedulingResultStateHolder.UseMinWeekWorkTime = false;
		}
