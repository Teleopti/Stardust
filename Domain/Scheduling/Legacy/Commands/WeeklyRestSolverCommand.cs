...
namespace Teleopti.Ccc.Domain.Scheduling.Legacy.Commands
{
	...
	public class WeeklyRestSolverCommandOld : IWeeklyRestSolverCommand
	{
		private readonly ITeamBlockInfoFactory _teamBlockInfoFactory;
		private readonly Func<WeeklyRestSolverService> _weeklyRestSolverService;
		private readonly Func<ISchedulerStateHolder> _schedulerStateHolder;
		...
		public WeeklyRestSolverCommandOld(ITeamBlockInfoFactory teamBlockInfoFactory,
			Func<WeeklyRestSolverService> weeklyRestSolverService,
			Func<ISchedulerStateHolder> schedulerStateHolder,
						...
						IDayOffOptimizationPreferenceProvider dayOffOptimizationPreferenceProvider)
		{
			...
			{
				contextDisposal = _resourceCalculationContextFactory.Create(schedulerStateHolder.SchedulingResultState, false, selectedPeriod.Inflate(1));
			}
