...
namespace Teleopti.Ccc.Domain.Scheduling.WorkShiftCalculation
{
	...
	public class DynamicBlockFinder : IDynamicBlockFinder
	{
		...
		{
			return (from dateOnly in dateOnlyListForFullPeriod
					let scheduleDayList = SchedulingResultStateHolder.Schedules.SchedulesForDay(dateOnly)
					where scheduleDayList.Any(schedule => schedule.SignificantPart() == SchedulePartView.DayOff)
