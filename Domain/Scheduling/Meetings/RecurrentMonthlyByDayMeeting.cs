...
namespace Teleopti.Ccc.Domain.Scheduling.Meetings
{
    public class RecurrentMonthlyByDayMeeting : RecurrentMeetingOption, IRecurrentMonthlyByDayMeeting
    {
        ...
        public virtual int DayInMonth
        {
            ...
            set
            {
                InParameter.ValueMustBeLargerThanZero("value", value);
                if (value > 31) throw new ArgumentOutOfRangeException("value", "The supplied value is bigger than number of days available in a month."); 
                _dayInMonth = value;
            }
        }
    }
