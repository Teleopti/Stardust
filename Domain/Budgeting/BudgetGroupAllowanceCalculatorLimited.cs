...
{
	public class BudgetGroupAllowanceCalculatorLimited : IBudgetGroupAllowanceCalculator
	{
		...
		private static readonly ILog Logger = LogManager.GetLogger(typeof(BudgetGroupAllowanceCalculatorLimited));

		public BudgetGroupAllowanceCalculatorLimited(ICurrentScenario scenarioRepository, IBudgetDayRepository budgetDayRepository, IScheduleProjectionReadOnlyPersister scheduleProjectionReadOnlyPersister)
		{
