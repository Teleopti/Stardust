...
namespace Teleopti.Analytics.Etl.Transformer.Job
{
    public class JobStepResult : IJobStepResult
    {
        ...
        private IList<UserDto> _pmUsersForCurrentBusinessUnit;
        ...
        public IList<UserDto> PmUsersForCurrentBusinessUnit
        {
            get { return _pmUsersForCurrentBusinessUnit; }
        }
        ...
        public void SetPmUsersForCurrentBusinessUnit(IList<UserDto> userDtoCollection)
        {
            _pmUsersForCurrentBusinessUnit = userDtoCollection;
        }
        ...
        public object Clone()
        {
            ...
            if (JobStepException != null)
                clone = new JobStepResult(Name, duration, JobStepException, CurrentBusinessUnit, _jobResultCollection);
            else
                clone = new JobStepResult(Name, rowsAffected, duration, CurrentBusinessUnit, _jobResultCollection);

            if (PmUsersForCurrentBusinessUnit != null)
                clone.SetPmUsersForCurrentBusinessUnit(new List<UserDto>(PmUsersForCurrentBusinessUnit));
