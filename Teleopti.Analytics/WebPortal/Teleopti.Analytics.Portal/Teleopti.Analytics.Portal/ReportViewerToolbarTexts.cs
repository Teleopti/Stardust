...
namespace Teleopti.Analytics.Portal
{
	class ReportViewerToolbarTexts :IReportViewerMessages
	{
		...
		public string TodayIs { get;  set; }
		public string ExportFormatsToolTip { get; set; }
		public string ExportButtonText { get { return Resources.RepViewerExport; } }
		public string SelectFormat { get;  set; }
		public string DocumentMap { get;  set; }
		public string InvalidPageNumber { get { return Resources.RepViewerInvalidPageNumber; } }
		public string ChangeCredentialsToolTip { get; set; }
