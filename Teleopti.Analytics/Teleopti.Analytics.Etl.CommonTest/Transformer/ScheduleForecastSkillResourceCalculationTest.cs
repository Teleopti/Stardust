...
namespace Teleopti.Analytics.Etl.CommonTest.Transformer
{
	...
	public class ScheduleForecastSkillResourceCalculationTest
	{
		...
		public void Setup()
		{
			...
			_target = new ScheduleForecastSkillResourceCalculation(new ShovelResources(new ReducePrimarySkillResources(), new SkillGroupPerActivityProvider(), new PrimarySkillOverstaff(new AddResourceToSubSkillsProvider()), new TimeZoneGuard()),
