...
namespace Teleopti.Analytics.Etl.CommonTest.Transformer
{
    ...
    public class AbsenceTransformerTest
    {
        ...
        {
            //BusinessUnit
            Assert.AreEqual(_absenceList[0].BusinessUnit.Id, _dataTable.Rows[0]["business_unit_code"]);
            Assert.AreEqual(_absenceList[1].BusinessUnit.Description.Name, _dataTable.Rows[1]["business_unit_name"]);
            //UpdatedOn
