...
namespace Teleopti.Analytics.Etl.TransformerTest
{
    ...
    public class WorkloadTransformerTest
    {
        ...
        {
            IDeleteTag workloadNotDeleted = _workloadList[0] as IDeleteTag;
            IDeleteTag skillNotDeleted = _workloadList[0].Skill as IDeleteTag;
            IDeleteTag workloadDeleted = _workloadList[1] as IDeleteTag;
            IDeleteTag skillDeleted = _workloadList[1].Skill as IDeleteTag;
