...
namespace Teleopti.Analytics.Etl.TransformerTest.FakeData
{
	public static class OvertimeFactory
	{
		public static IList<IMultiplicatorDefinitionSet> CreateMultiplicatorDefinitionSetList()
		{
			...
			RaptorTransformerHelper.SetCreatedOn(multiplicatorDefinitionSet1,DateTime.Now);
			...
			RaptorTransformerHelper.SetCreatedOn(multiplicatorDefinitionSet2, DateTime.Now);
			...
			RaptorTransformerHelper.SetCreatedOn(multiplicatorDefinitionSet3, DateTime.Now);
