...
namespace Teleopti.Analytics.Etl.TransformerTest.FakeData
{
    public static class SchedulePartFactory
    {
        public static IList<IScheduleDay> CreateSchedulePartCollection()
        {
            ...
            var date1 = new DateTime(1800, 1, 1);
            var date2 = new DateTime(1800, 1, 2);
            ...
            ScheduleDictionary dic = new ScheduleDictionary(scenario, new ScheduleDateTimePeriod(new DateTimePeriod(1800,1,1,1801,1,1)));
