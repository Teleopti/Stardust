...
namespace Teleopti.Analytics.Etl.TransformerTest
{
    ...
    public class ShiftCategoryTransformerTest
    {
        ...
        public void Setup()
        {
            ...
            ShiftCategoryTransformer shiftCategoryTransformer = new ShiftCategoryTransformer(_insertDateTime);
        ...
        {
            //Businessunit
            Assert.AreEqual(_shiftCategoryCollection[2].BusinessUnit.Id, _dataRow2["business_unit_code"]);
            Assert.AreEqual(_shiftCategoryCollection[1].BusinessUnit.Description.Name,
