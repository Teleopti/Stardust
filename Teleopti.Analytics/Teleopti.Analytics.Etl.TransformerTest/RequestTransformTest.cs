...
using AbsenceFactory = Teleopti.Analytics.Etl.TransformerTest.FakeData.AbsenceFactory;
    ...
    public class RequestTransformTest
    {
       ...
       [Test]
        public void ShouldInitializeAbsenceRequest()
        {
            ...
            RaptorTransformerHelper.SetCreatedOn(personRequest2, DateTime.Now);
        ...
        public void ShouldInitializeTextRequest()
        {
            ...
            RaptorTransformerHelper.SetCreatedOn(personRequest1, DateTime.Now);
        ...
        public void ShouldInitializeApprovedAbsenceRequest()
        {
            ...
            RaptorTransformerHelper.SetCreatedOn(personRequest3, DateTime.Now);
        ...
        public void ShouldInitializeShiftTradeRequest()
        {
            ...
            RaptorTransformerHelper.SetCreatedOn(personRequest4, DateTime.Now);
