...
namespace Teleopti.Analytics.Etl.Common.Infrastructure
{
	public class RaptorRepository : IRaptorRepository
	{
		...
		public IList<IContract> LoadContract()
		{
			...
			{
				IContractRepository repository = ContractRepository.DONT_USE_CTOR(uow);
		...
		public IList<IContractSchedule> LoadContractSchedule()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				IContractScheduleRepository repository = ContractScheduleRepository.DONT_USE_CTOR(uow);
				return repository.LoadAll().ToList();
			}
		}
		...
		public IList<IPartTimePercentage> LoadPartTimePercentage()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				IPartTimePercentageRepository repository = PartTimePercentageRepository.DONT_USE_CTOR(uow);
				return repository.LoadAll().ToList();
			}
		}
		...
		public IList<IGroupPage> LoadUserDefinedGroupings()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				...
				IGroupPageRepository repository = GroupPageRepository.DONT_USE_CTOR(uow);
		...
		public IList<IMultiplicatorDefinitionSet> LoadMultiplicatorDefinitionSet()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				IMultiplicatorDefinitionSetRepository repository = MultiplicatorDefinitionSetRepository.DONT_USE_CTOR(uow);
		...
		public IList<IBusinessUnit> LoadBusinessUnit()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				BusinessUnitRepository repository = BusinessUnitRepository.DONT_USE_CTOR(uow);
				return repository.LoadAll().ToList();
			}
		}
		...
		public IList<IActivity> LoadActivity()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				using (uow.DisableFilter(QueryFilter.Deleted))
				{
					...
					ActivityRepository repository = ActivityRepository.DONT_USE_CTOR(uow);
		...
		public IList<IApplicationFunction> LoadApplicationFunction()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				...
				ApplicationFunctionRepository repository = ApplicationFunctionRepository.DONT_USE_CTOR(uow);
		...
		public IList<IAvailableData> LoadAvailableData()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				...
				AvailableDataRepository repository = AvailableDataRepository.DONT_USE_CTOR(uow);
		...
		public IList<IApplicationRole> LoadApplicationRole(ICommonStateHolder stateHolder)
		{
			...
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				...
				ApplicationRoleRepository repository = ApplicationRoleRepository.DONT_USE_CTOR(uow);
				return repository.LoadAll().ToList();
			}
		}
		...
		public IList<IAbsence> LoadAbsence()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				using (uow.DisableFilter(QueryFilter.Deleted))
				{
					...
					AbsenceRepository repository = AbsenceRepository.DONT_USE_CTOR(uow);
					return repository.LoadAll().ToList();
				}
			}
		}
		...
		public IList<IScenario> LoadScenario()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				using (uow.DisableFilter(QueryFilter.Deleted))
				{
					...
					ScenarioRepository repository = ScenarioRepository.DONT_USE_CTOR(uow);
		...
		private static void avoidLazyLoadForLoadSchedule(IUnitOfWork uow, IEnumerable<IPerson> persons)
		{
			...
			var scenarioRep = ScenarioRepository.DONT_USE_CTOR(uow);
		...
		public IList<IDayOffTemplate> LoadDayOff()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				...
				var repository = DayOffTemplateRepository.DONT_USE_CTOR(uow);
		...
		public IEnumerable<TimeZoneInfo> LoadTimeZonesInUse()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				BusinessUnitRepository bur = BusinessUnitRepository.DONT_USE_CTOR(uow);
		...
		public IDictionary<ISkill, IEnumerable<ISkillDay>> LoadSkillDays(DateTimePeriod period, IList<ISkill> skills, IScenario scenario)
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				using (uow.DisableFilter(QueryFilter.Deleted))
				{
					...
					SkillTypeRepository skillTypeRepository = SkillTypeRepository.DONT_USE_CTOR(uow);
		...
		public IList<IOptionalColumn> LoadOptionalColumnAvailableAsGroupPage()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				var optionalColumnRepo = OptionalColumnRepository.DONT_USE_CTOR(uow);
		...
		public IList<IKeyPerformanceIndicator> LoadKpi()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				...
				KpiRepository repository = KpiRepository.DONT_USE_CTOR(uow);
				return repository.LoadAll().ToList();
			}
		}
		...
		public IList<IKpiTarget> LoadKpiTargetTeam()
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				...
				KpiTargetRepository repository = KpiTargetRepository.DONT_USE_CTOR(uow);
				var ret = repository.LoadAll().ToList();
		...
		public IList<ISkill> LoadSkill(IList<IActivity> activities)
		{
			using (IUnitOfWork uow = UnitOfWorkFactory.Current.CreateAndOpenUnitOfWork())
			{
				...
				var repository = SkillRepository.DONT_USE_CTOR(uow);
				IList<ISkill> ret;
				using (uow.DisableFilter(QueryFilter.Deleted))
				{
					SkillTypeRepository.DONT_USE_CTOR(uow).LoadAll();
