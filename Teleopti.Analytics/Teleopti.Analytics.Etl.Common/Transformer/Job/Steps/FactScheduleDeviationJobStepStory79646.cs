...
{
	public class FactScheduleDeviationJobStepStory79646 : JobStepBase
	{
		private readonly bool _isIntraday;

		public FactScheduleDeviationJobStepStory79646(IJobParameters jobParameters, bool isIntraday = false)
			: base(jobParameters)
		{
		...
		protected override int RunStep(IList<IJobResult> jobResultCollection, bool isLastBusinessUnit)
		{
			...
			if (_isIntraday)
			{
				...
				affectedRows =
					 _jobParameters.Helper.Repository.FillScheduleDeviationDataMart_Story79646(new DateTimePeriod(fromDate, toDate),
			...
			else
			{
					 ...
					 startDateTime = startDateTime.AddDays(chunkTimeSpan))
				{
					...
					affectedRows += _jobParameters.Helper.Repository.FillScheduleDeviationDataMart_Story79646(period,
						 RaptorTransformerHelper.CurrentBusinessUnit,
						 _jobParameters.DefaultTimeZone,
						 0,
						 _jobParameters.NowForTestPurpose);
