...
{
	public class FactAgentQueueJobStep : JobStepBase
	{
		public FactAgentQueueJobStep(IJobParameters jobParameters)
			: base(jobParameters)
		{
		...
		protected override int RunStep(IList<IJobResult> jobResultCollection, bool isLastBusinessUnit)
		{
					  ...
					  startDateTime = startDateTime.AddDays(chunkTimeSpan))
			{
				...
				affectedRows += _jobParameters.Helper.Repository.FillFactAgentQueueDataMart(period, _jobParameters.DataSource, _jobParameters.DefaultTimeZone, RaptorTransformerHelper.CurrentBusinessUnit);
