	...
	public class Bug27672
	{
		...
		public void ShouldWorkForStockholm()
		{
			...
			var jobParameters = new JobParameters(
				...
				{
					Helper =
						new JobHelperForTest(new RaptorRepository(InfraTestConfigReader.AnalyticsConnectionString, "", null), null)
				};
				...
				new FakeContainerHolder(), false
				)
						{
							Helper = new JobHelperForTest(
								new RaptorRepository(InfraTestConfigReader.AnalyticsConnectionString, "", null), null
								)
						};
