...
{
    public class dim_activityMap : EntityTypeConfiguration<dim_activity>
    {
        public dim_activityMap()
        {
            // Primary Key
            ...
            this.Property(t => t.in_ready_time_name)
                .HasMaxLength(50);
            ...
            this.ToTable("dim_activity", "mart");
            ...
            this.Property(t => t.in_ready_time).HasColumnName("in_ready_time");
            this.Property(t => t.in_ready_time_name).HasColumnName("in_ready_time_name");
