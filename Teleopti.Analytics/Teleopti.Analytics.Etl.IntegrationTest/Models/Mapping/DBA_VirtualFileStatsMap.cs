...
{
    public class DBA_VirtualFileStatsMap : EntityTypeConfiguration<DBA_VirtualFileStats>
    {
        public DBA_VirtualFileStatsMap()
        {
            // Primary Key
            this.HasKey(t => new { t.database_id, t.file_id, t.ServerName, t.DatabaseName, t.PhysicalName });
            ...
            this.ToTable("DBA_VirtualFileStats");
