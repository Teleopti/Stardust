...
{
    public class custom_report_control_collectionMap : EntityTypeConfiguration<custom_report_control_collection>
    {
        public custom_report_control_collectionMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("custom_report_control_collection", "mart");
            ...
            // Relationships
            this.HasRequired(t => t.custom_report_control)
                .WithMany(t => t.custom_report_control_collection)
