...
{
    public class v_permission_reportMap : EntityTypeConfiguration<v_permission_report>
    {
        public v_permission_reportMap()
        {
            // Primary Key
            this.HasKey(t => new { t.person_code, t.team_id, t.my_own, t.business_unit_id, t.datasource_id, t.ReportId });
            ...
            this.ToTable("v_permission_report", "mart");
