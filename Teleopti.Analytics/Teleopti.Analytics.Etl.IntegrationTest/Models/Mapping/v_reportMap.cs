...
{
    public class v_reportMap : EntityTypeConfiguration<v_report>
    {
        public v_reportMap()
        {
            // Primary Key
            this.HasKey(t => new { t.report_name_resource_key, t.visible, t.rpt_file_name, t.proc_name, t.sub1_name, t.sub1_proc_name, t.sub2_name, t.sub2_proc_name, t.Id, t.ControlCollectionId });
